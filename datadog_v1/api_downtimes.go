...
*/
func (a *DowntimesApiService) CancelDowntime(ctx context.Context, downtimeId int64) (*http.Response, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"downtime_id"+"}", fmt.Sprintf("%v", downtimeId), -1)
...
*/
func (a *DowntimesApiService) CancelDowntimesByScope(ctx context.Context, cancelDowntimesByScopeRequest CancelDowntimesByScopeRequest) (CanceledDowntimesIds, *http.Response, error) {
	var (
...
@return Downtime
*/
func (a *DowntimesApiService) CreateDowntime(ctx context.Context, downtime Downtime) (Downtime, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (a *DowntimesApiService) GetAllDowntimes(ctx context.Context, localVarOptionals *GetAllDowntimesOpts) ([]Downtime, *http.Response, error) {
	var (
...
@return Downtime
*/
func (a *DowntimesApiService) GetDowntime(ctx context.Context, downtimeId int64) (Downtime, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return Downtime
*/
func (a *DowntimesApiService) UpdateDowntime(ctx context.Context, downtimeId int64, downtime Downtime) (Downtime, *http.Response, error) {
	var (
