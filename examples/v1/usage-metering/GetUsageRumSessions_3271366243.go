...
func main() {
	...
	resp, r, err := apiClient.UsageMeteringApi.GetUsageRumSessions(ctx, time.Now().AddDate(0, 0, -5), *datadog.NewGetUsageRumSessionsOptionalParameters().WithEndHr(time.Now().AddDate(0, 0, -3)).WithType("mobile"))
