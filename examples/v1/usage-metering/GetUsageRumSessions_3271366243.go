...
func main() {
	...
	resp, r, err := api.GetUsageRumSessions(ctx, time.Now().AddDate(0, 0, -5), *datadogV1.NewGetUsageRumSessionsOptionalParameters().WithEndHr(time.Now().AddDate(0, 0, -3)).WithType("mobile"))
