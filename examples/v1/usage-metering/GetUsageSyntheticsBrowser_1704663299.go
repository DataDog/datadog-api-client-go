...
func main() {
	...
	resp, r, err := api.GetUsageSyntheticsBrowser(ctx, time.Now().AddDate(0, 0, -5), *datadogV1.NewGetUsageSyntheticsBrowserOptionalParameters().WithEndHr(time.Now().AddDate(0, 0, -3)))
