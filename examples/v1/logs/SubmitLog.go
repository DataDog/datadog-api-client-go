...
func main() {
	body := []datadog.HTTPLogItem{
		{
			Message: datadog.PtrString("Test-Example-Send_logs_returns_Response_from_server_always_200_empty_JSON_response"),
			Ddtags:  datadog.PtrString("host:TestExampleSendlogsreturnsResponsefromserveralways200emptyJSONresponse"),
		},
	}
