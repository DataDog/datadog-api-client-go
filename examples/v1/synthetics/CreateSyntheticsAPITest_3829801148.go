	...
	body := datadog.SyntheticsAPITest{
		Config: datadog.SyntheticsAPITestConfig{
			...
			Request: &datadog.SyntheticsTestRequest{
				Host:    common.PtrString("https://datadoghq.com"),
		...
		Options: datadog.SyntheticsTestOptions{
			...
			MonitorName:        common.PtrString("Example-Create_an_API_test_with_UDP_subtype_returns_OK_Returns_the_created_test_details_response"),
