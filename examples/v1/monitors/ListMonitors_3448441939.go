...
func main() {
	...
	resp, r, err := apiClient.MonitorsApi.ListMonitors(ctx, *datadog.NewListMonitorsOptionalParameters().WithTags("test:examplegetallmonitordetailswithtags").WithPageSize(1), )
