				...
				datadogV1.MonitorFormulaAndFunctionQueryDefinition{
					MonitorFormulaAndFunctionDataQualityQueryDefinition: &datadogV1.MonitorFormulaAndFunctionDataQualityQueryDefinition{
						...
						MonitorOptions: &datadogV1.MonitorFormulaAndFunctionDataQualityMonitorOptions{
							SourceToTargetConfig: &datadogV1.MonitorFormulaAndFunctionDataQualitySourceToTargetConfig{
								Source: datadogV1.MonitorFormulaAndFunctionDataQualityEntityMetricConfig{
									EntityId:   "source-entity-id",
									EntityType: "table",
								},
								Target: datadogV1.MonitorFormulaAndFunctionDataQualityEntityMetricConfig{
									EntityId:   "target-entity-id",
									EntityType: "table",
								},
								DiffType:   datadogV1.MONITORFORMULAANDFUNCTIONDATAQUALITYDIFFTYPE_ABSOLUTE,
								EntityType: "table",
							},
						},
					}},
