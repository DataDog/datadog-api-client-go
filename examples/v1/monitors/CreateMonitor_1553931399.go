			...
			Variables: []datadogV1.MonitorFormulaAndFunctionQueryDefinition{
				datadogV1.MonitorFormulaAndFunctionQueryDefinition{
					MonitorFormulaAndFunctionDataQualityQueryDefinition: &datadogV1.MonitorFormulaAndFunctionDataQualityQueryDefinition{
						...
						MonitorOptions: &datadogV1.MonitorFormulaAndFunctionDataQualityMonitorOptions{
							ModelConfiguration: &datadogV1.MonitorFormulaAndFunctionDataQualityModelConfiguration{
								AutoResolveDays:         datadog.PtrInt32(7),
								EnableFlatlineDetection: datadog.PtrBool(true),
								Function:                datadogV1.MONITORFORMULAANDFUNCTIONDATAQUALITYDIFFFUNCTION_DIFF.Ptr(),
								MinLowerBoundSize:       datadog.PtrFloat64(10.0),
								MinUpperBoundSize:       datadog.PtrFloat64(10.0),
								ModelBoundsOverride:     datadogV1.MONITORFORMULAANDFUNCTIONDATAQUALITYMODELBOUNDSOVERRIDE_UPPER_ONLY.Ptr(),
							},
						},
					}},
			},
