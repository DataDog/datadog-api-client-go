...
func main() {
	body := datadogV1.Monitor{
		Assets: []datadogV1.MonitorAsset{
			{
				Category:     datadogV1.MONITORASSETCATEGORY_RUNBOOK,
				Name:         "Monitor Runbook",
				ResourceKey:  datadog.PtrString("12345"),
				ResourceType: datadogV1.MONITORASSETRESOURCETYPE_NOTEBOOK.Ptr(),
				Url:          "/notebooks/12345",
			},
		},
