		...
		Widgets: []datadogV1.Widget{
			{
				...
				Definition: datadogV1.WidgetDefinition{
					BarChartWidgetDefinition: &datadogV1.BarChartWidgetDefinition{
						Title:      datadog.PtrString(""),
						TitleSize:  datadog.PtrString("16"),
						TitleAlign: datadogV1.WIDGETTEXTALIGN_LEFT.Ptr(),
						Time: &datadogV1.WidgetTime{
							WidgetLegacyLiveSpan: &datadogV1.WidgetLegacyLiveSpan{}},
						Style: &datadogV1.BarChartWidgetStyle{
							Display: &datadogV1.BarChartWidgetDisplay{
								BarChartWidgetStacked: &datadogV1.BarChartWidgetStacked{
									Type:   datadogV1.BARCHARTWIDGETSTACKEDTYPE_STACKED,
									Legend: datadogV1.BARCHARTWIDGETLEGEND_INLINE.Ptr(),
								}},
							Scaling: datadogV1.BARCHARTWIDGETSCALING_RELATIVE.Ptr(),
							Palette: datadog.PtrString("dog_classic"),
						},
						Type: datadogV1.BARCHARTWIDGETDEFINITIONTYPE_BAR_CHART,
						Requests: []datadogV1.BarChartWidgetRequest{
							{
