	...
	body := datadogV2.SnowflakeIntegrationAccountUpdateRequest{
		Data: datadogV2.SnowflakeIntegrationAccountUpdateData{
			Attributes: datadogV2.SnowflakeIntegrationAccountUpdateAttributes{
				Authentication: &datadogV2.SnowflakeIntegrationAccountAuthenticationUpdate{
					SnowflakeIntegrationAccountPrivateKeyAuthUpdate: &datadogV2.SnowflakeIntegrationAccountPrivateKeyAuthUpdate{
						AuthType: datadogV2.SNOWFLAKEINTEGRATIONACCOUNTPRIVATEKEYAUTHTYPE_SNOWFLAKE_PRIVATE_KEY,
						PrivateKey: datadog.PtrString(`-----BEGIN PRIVATE KEY-----
MIIE...
-----END PRIVATE KEY-----`),
						PrivateKeyName:       datadog.PtrString("my-rsa-key"),
						PrivateKeyPassphrase: *datadog.NewNullableString(datadog.PtrString("your-private-key-passphrase")),
					}},
