...
func main() {
	body := datadogV2.EventEmailAddressCreateRequest{
		Data: datadogV2.EventEmailAddressCreateData{
			Attributes: datadogV2.EventEmailAddressCreateAttributes{
				AlertType:   datadogV2.EVENTEMAILADDRESSALERTTYPE_INFO.Ptr(),
				Description: datadog.PtrString("Email address for production alerts."),
