...
func main() {
	body := datadogV2.ProductAnalyticsServerSideEventItem{
		Account: &datadogV2.ProductAnalyticsAccount{
			Id: "account-67890",
		},
		Application: datadogV2.ProductAnalyticsApplication{
			Id: "123abcde-123a-123b-1234-123456789abc",
		},
		Event: datadogV2.ProductAnalyticsEvent{
			Name: "payment.processed",
		},
		Session: &datadogV2.ProductAnalyticsSession{
			Id: "session-abcdef",
		},
		Type: datadogV2.PRODUCTANALYTICSEVENTTYPE_SERVER,
		Usr: &datadogV2.ProductAnalyticsUser{
			Id: "user-12345",
		},
	}
