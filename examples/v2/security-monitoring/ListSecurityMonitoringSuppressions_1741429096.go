...
func main() {
	...
	resp, r, err := api.ListSecurityMonitoringSuppressions(ctx, *datadogV2.NewListSecurityMonitoringSuppressionsOptionalParameters().WithSort(datadogV2.SECURITYMONITORINGSUPPRESSIONSORT_NAME_DESCENDING).WithQuery("id:3dd-0uc-h1s OR id:886e6c3e-e543-049c-ee1b-56a1110295c0"))
