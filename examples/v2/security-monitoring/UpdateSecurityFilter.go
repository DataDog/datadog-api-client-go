	...
	body := datadog.SecurityFilterUpdateRequest{
		Data: datadog.SecurityFilterUpdateData{
			Attributes: datadog.SecurityFilterUpdateAttributes{
				...
				Name:             datadog.PtrString("Test-Example-Update_a_security_filter_returns_OK_response"),
				Query:            datadog.PtrString("service:TestExampleUpdateasecurityfilterreturnsOKresponse"),
