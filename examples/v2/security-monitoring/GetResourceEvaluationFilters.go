...
func main() {
	...
	resp, r, err := api.GetResourceEvaluationFilters(ctx, *datadogV2.NewGetResourceEvaluationFiltersOptionalParameters().WithCloudProvider(datadogV2.RESOURCEFILTERPROVIDERENUM_AWS).WithAccountId("123456789"))
