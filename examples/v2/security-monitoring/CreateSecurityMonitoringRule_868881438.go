...
func main() {
	body := datadogV2.SecurityMonitoringRuleCreatePayload{
		SecurityMonitoringStandardRuleCreatePayload: &datadogV2.SecurityMonitoringStandardRuleCreatePayload{
			...
			SchedulingOptions: *datadogV2.NewNullableSecurityMonitoringSchedulingOptions(&datadogV2.SecurityMonitoringSchedulingOptions{
				Rrule:    datadog.PtrString("FREQ=HOURLY;INTERVAL=2;"),
				Start:    datadog.PtrString("2025-06-18T12:00:00"),
