...
func main() {
			...
			Attributes: datadogV2.DatabricksIntegrationAccountUpdateAttributes{
				Authentication: &datadogV2.DatabricksIntegrationAccountAuthenticationUpdate{
					DatabricksIntegrationAccountOAuthAuthUpdate: &datadogV2.DatabricksIntegrationAccountOAuthAuthUpdate{
						...
						AzureTenantId: *datadog.NewNullableString(datadog.PtrString("4d3bac44-0230-4732-9e70-cc00736f0a97")),
						ClientId:      datadog.PtrString("5c10654a-b3a3-4840-b37f-f477590c70a0"),
				...
				Dataflows: &datadogV2.DatabricksIntegrationDataflowsRequest{
					...
					DatabricksDataObservabilityJobsMonitoring: &datadogV2.DatabricksDataObservabilityJobsMonitoringIntegrationDataflowRequest{
						Enabled: datadog.PtrBool(true),
						Settings: &datadogV2.DatabricksDataObservabilityJobsMonitoringIntegrationDataflowSettingsRequest{
							...
							ServerlessJobsEnabled:      datadog.PtrBool(true),
						},
					},
					DatabricksDataObservabilityQualityMonitoring: &datadogV2.DatabricksDataObservabilityQualityMonitoringIntegrationDataflowRequest{
						Enabled: datadog.PtrBool(true),
						Settings: &datadogV2.DatabricksDataObservabilityQualityMonitoringIntegrationDataflowSettingsRequest{
	...
	api := datadogV2.NewDatabricksIntegrationApi(apiClient)
	resp, r, err := api.UpdateDatabricksIntegrationAccount(ctx, "account_id", body)

	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `DatabricksIntegrationApi.UpdateDatabricksIntegrationAccount`: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}

	responseContent, _ := json.MarshalIndent(resp, "", "  ")
	fmt.Fprintf(os.Stdout, "Response from `DatabricksIntegrationApi.UpdateDatabricksIntegrationAccount`:\n%s\n", responseContent)
}
