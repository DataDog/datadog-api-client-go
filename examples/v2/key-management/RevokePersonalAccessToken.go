...
func main() {
	...
	configuration.SetUnstableOperationEnabled("v2.RevokePersonalAccessToken", true)
	apiClient := datadog.NewAPIClient(configuration)
	api := datadogV2.NewKeyManagementApi(apiClient)
	r, err := api.RevokePersonalAccessToken(ctx, uuid.MustParse("9b1deb4d-3b7d-4bad-9bdd-2b0d7b3dcb6d"))
