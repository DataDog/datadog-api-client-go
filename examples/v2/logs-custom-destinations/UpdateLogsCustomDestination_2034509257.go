...
func main() {
	...
	CustomDestinationSplunkWithNullSourcetypeDataID := os.Getenv("CUSTOM_DESTINATION_SPLUNK_WITH_NULL_SOURCETYPE_DATA_ID")
	...
	body := datadogV2.CustomDestinationUpdateRequest{
		Data: &datadogV2.CustomDestinationUpdateRequestDefinition{
			...
			Id:   CustomDestinationSplunkWithNullSourcetypeDataID,
		},
	}
	...
	resp, r, err := api.UpdateLogsCustomDestination(ctx, CustomDestinationSplunkWithNullSourcetypeDataID, body)
