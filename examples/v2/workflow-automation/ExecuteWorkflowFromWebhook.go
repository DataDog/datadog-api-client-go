...
func main() {
	...
	resp, r, err := api.ExecuteWorkflowFromWebhook(ctx, "workflow_id", uuid.MustParse("9b1deb4d-3b7d-4bad-9bdd-2b0d7b3dcb6d"), "sha256=abcdef123456...", "GitHub-Hookshot/abc123", body)
