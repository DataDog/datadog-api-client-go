...
func main() {
	...
	resp, r, err := api.ListDashboardsUsage(ctx, *datadogV2.NewListDashboardsUsageOptionalParameters().WithFilterEditedBefore("2025-04-26T00:00:00Z").WithFilterViewedBefore("2025-04-26T00:00:00Z"))
