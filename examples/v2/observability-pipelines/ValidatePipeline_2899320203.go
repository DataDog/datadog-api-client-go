				...
				Config: datadogV2.ObservabilityPipelineConfig{
					...
					Sources: []datadogV2.ObservabilityPipelineConfigSourceItem{
						datadogV2.ObservabilityPipelineConfigSourceItem{
							ObservabilityPipelineHttpClientSource: &datadogV2.ObservabilityPipelineHttpClientSource{
								Id:                 "http-client-source",
								Type:               datadogV2.OBSERVABILITYPIPELINEHTTPCLIENTSOURCETYPE_HTTP_CLIENT,
								Decoding:           datadogV2.OBSERVABILITYPIPELINEDECODING_DECODE_BYTES,
								ScrapeIntervalSecs: datadog.PtrInt64(15),
								ScrapeTimeoutSecs:  datadog.PtrInt64(5),
								AuthStrategy:       datadogV2.OBSERVABILITYPIPELINEHTTPCLIENTSOURCEAUTHSTRATEGY_BEARER.Ptr(),
								TokenKey:           datadog.PtrString("HTTP_CLIENT_TOKEN"),
							}},
					},
				},
