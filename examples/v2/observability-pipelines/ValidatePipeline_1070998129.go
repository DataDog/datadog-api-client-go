				...
				Config: datadogV2.ObservabilityPipelineConfig{
					Destinations: []datadogV2.ObservabilityPipelineConfigDestinationItem{
						datadogV2.ObservabilityPipelineConfigDestinationItem{
							ObservabilityPipelineCloudPremDestination: &datadogV2.ObservabilityPipelineCloudPremDestination{
								Id: "cloud-prem-destination",
								Inputs: []string{
									"my-processor-group",
								},
								Type:           datadogV2.OBSERVABILITYPIPELINECLOUDPREMDESTINATIONTYPE_CLOUD_PREM,
								EndpointUrlKey: datadog.PtrString("CLOUDPREM_ENDPOINT_URL"),
								Buffer: &datadogV2.ObservabilityPipelineBufferOptions{
									ObservabilityPipelineDiskBufferOptions: &datadogV2.ObservabilityPipelineDiskBufferOptions{
										Type:     datadogV2.OBSERVABILITYPIPELINEBUFFEROPTIONSDISKTYPE_DISK.Ptr(),
										MaxSize:  1073741824,
