	...
	body := datadogV2.CreateFeatureFlagRequest{
		Data: datadogV2.CreateFeatureFlagData{
			...
			Attributes: datadogV2.CreateFeatureFlagAttributes{
				...
				NotificationRuleQuery: *datadog.NewNullableString(datadog.PtrString("notification_type:rollout_started")),
				RuleTargets: []datadogV2.NotificationRuleTarget{
					{
						Type:    datadogV2.NOTIFICATIONRULETARGETTYPE_SLACK_CHANNEL,
						Version: 1,
						Configuration: datadogV2.NotificationRuleTargetConfiguration{
							Channel:   datadog.PtrString("#feature-flags-test"),
							Workspace: datadog.PtrString("datadoghq"),
						},
					},
				},
			},
