		...
		Data: &datadogV2.ScheduleUpdateRequestData{
			...
			Attributes: &datadogV2.ScheduleUpdateRequestDataAttributes{
				Layers: []datadogV2.ScheduleUpdateRequestDataAttributesLayersItems{
					{
						EffectiveDate: datadog.PtrTime(time.Date(2025, 2, 3, 5, 0, 0, 0, time.UTC)),
						...
						RotationStart: datadog.PtrTime(time.Date(2025, 2, 1, 0, 0, 0, 0, time.UTC)),
					},
				},
			...
			Type: datadogV2.SCHEDULEUPDATEREQUESTDATATYPE_SCHEDULES.Ptr(),
		},
	}
