...
func main() {
	...
	resp, r, err := api.ListOrgAuthorizedClients(ctx, *datadogV2.NewListOrgAuthorizedClientsOptionalParameters())
	...
	fmt.Fprintf(os.Stdout, "Response from `OrgAuthorizedClientsApi.ListOrgAuthorizedClients`:\n%s\n", responseContent)
}
