...
func main() {
	...
	resp, r, err := api.ListTeamsOwnershipRules(ctx, *datadogV2.NewListTeamsOwnershipRulesOptionalParameters().WithFilterViewName(TeamsOwnershipMappingDataAttributesViewName))
