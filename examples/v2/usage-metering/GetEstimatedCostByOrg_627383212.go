...
func main() {
	...
	resp, r, err := apiClient.UsageMeteringApi.GetEstimatedCostByOrg(ctx, *datadog.NewGetEstimatedCostByOrgOptionalParameters().WithStartDate(time.Now().AddDate(0, 0, -5)).WithEndDate(time.Now().AddDate(0, 0, -3)))
