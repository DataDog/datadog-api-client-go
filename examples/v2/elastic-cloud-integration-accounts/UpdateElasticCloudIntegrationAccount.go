...
func main() {
	body := datadogV2.ElasticCloudIntegrationAccountUpdateRequest{
		Data: datadogV2.ElasticCloudIntegrationAccountUpdateData{
			Attributes: datadogV2.ElasticCloudIntegrationAccountUpdateAttributes{
				Interface: &datadogV2.ElasticCloudInterfaceUpdate{
					ElasticCloudMonitoringInterfaceUpdate: &datadogV2.ElasticCloudMonitoringInterfaceUpdate{
	...
	resp, r, err := api.UpdateElasticCloudIntegrationAccount(ctx, datadogV2.ELASTICCLOUDINTERFACEID_ELASTIC_CLOUD, "account_id", body)
