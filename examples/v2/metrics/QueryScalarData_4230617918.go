			...
			Attributes: datadogV2.ScalarFormulaRequestAttributes{
				...
				Queries: []datadogV2.ScalarQuery{
					datadogV2.ScalarQuery{
						ProcessScalarQuery: &datadogV2.ProcessScalarQuery{
							DataSource:      datadogV2.PROCESSDATASOURCE_PROCESS,
							Name:            "a",
							Metric:          "process.stat.cpu.total_pct",
							Aggregator:      datadogV2.METRICSAGGREGATOR_AVG.Ptr(),
							TextFilter:      datadog.PtrString(""),
							TagFilters:      []string{},
							Limit:           datadog.PtrInt64(10),
							Sort:            datadogV2.QUERYSORTORDER_DESC.Ptr(),
							IsNormalizedCpu: datadog.PtrBool(false),
						}},
				},
				To: 1636629071000,
			},
