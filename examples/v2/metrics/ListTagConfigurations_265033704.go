...
func main() {
	...
	resp, r, err := api.ListTagConfigurations(ctx, *datadogV2.NewListTagConfigurationsOptionalParameters().WithFilterTags("ExampleGetalistofmetricswithatagfilterreturnsSuccessresponse"))
