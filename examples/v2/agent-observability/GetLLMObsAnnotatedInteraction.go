...
func main() {
	...
	resp, r, err := api.GetLLMObsAnnotatedInteraction(ctx, "queue_id", "interaction_id", *datadogV2.NewGetLLMObsAnnotatedInteractionOptionalParameters())
	...
	fmt.Fprintf(os.Stdout, "Response from `AgentObservabilityApi.GetLLMObsAnnotatedInteraction`:\n%s\n", responseContent)
}
