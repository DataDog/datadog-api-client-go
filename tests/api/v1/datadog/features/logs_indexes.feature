...
Feature: Logs Indexes
  ...
  Scenario: Create an index returns "Invalid Parameter Error" response
    ...
    And body {"daily_limit": 300000000, "exclusion_filters": [{"filter": {"query": "*", "sample_rate": 1}, "is_enabled": null, "name": "payment"}], "filter": {"query": "source:python"}, "name": "main", "num_retention_days": 15}
