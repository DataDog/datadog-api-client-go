...
Feature: Synthetics
  ...
  Scenario: Create a browser test returns "- JSON format is wrong" response
    ...
    And body {"config": {"assertions": [], "request": {"basicAuth": {"password": "", "username": ""}, "body": null, "certificate": {"cert": {"content": null, "filename": null, "updatedAt": null}, "key": {"content": null, "filename": null, "updatedAt": null}}, "dnsServer": null, "headers": null, "host": null, "method": null, "noSavingResponseBody": null, "port": null, "query": null, "timeout": null, "url": null}, "variables": [{"example": null, "id": null, "name": "VARIABLE_NAME", "pattern": null, "type": null}]}, "locations": [], "message": "", "monitor_id": null, "name": null, "options": {"accept_self_signed": null, "allow_insecure": null, "device_ids": [], "disableCors": null, "follow_redirects": null, "min_failure_duration": null, "min_location_failed": null, "monitor_options": {"renotify_interval": null}, "noScreenshot": null, "retry": {"count": null, "interval": null}, "tick_every": null}, "public_id": null, "status": null, "steps": [{"allowFailure": null, "name": null, "params": null, "timeout": null, "type": null}], "tags": [], "type": "browser"}
  ...
  Scenario: Create a global variable returns "Invalid request" response
    ...
    And body {"description": "Example description", "id": null, "name": "MY_VARIABLE", "parse_test_options": {"field": "content-type", "parser": {"type": "regex", "value": ".*"}, "type": null}, "parse_test_public_id": "abc-def-123", "tags": ["team:front", "test:workflow-1"], "value": {"secure": true, "value": "value"}}
    When the request is sent
  ...
  Scenario: Create a private location returns "OK" response
    ...
    And body {"description": "Description of private location", "id": null, "name": "New private location", "secrets": {}, "tags": ["team:front"]}
    When the request is sent
    Then the response status is 200 OK
  ...
  Scenario: Create a test returns "- JSON format is wrong" response
    ...
    And body {"config": {"assertions": [], "configVariables": [{"example": null, "name": "VARIABLE_NAME", "pattern": null, "type": null}], "request": {"basicAuth": {"password": "", "username": ""}, "body": null, "certificate": {"cert": {"content": null, "filename": null, "updatedAt": null}, "key": {"content": null, "filename": null, "updatedAt": null}}, "dnsServer": null, "headers": null, "host": null, "method": null, "noSavingResponseBody": null, "port": null, "query": null, "timeout": null, "url": null}, "variables": [{"example": null, "id": null, "name": "VARIABLE_NAME", "pattern": null, "type": null}]}, "locations": [], "message": null, "monitor_id": null, "name": null, "options": {"accept_self_signed": null, "allow_insecure": null, "device_ids": [], "disableCors": null, "follow_redirects": null, "min_failure_duration": null, "min_location_failed": null, "monitor_options": {"renotify_interval": null}, "noScreenshot": null, "retry": {"count": null, "interval": null}, "tick_every": null}, "public_id": null, "status": null, "steps": [{"allowFailure": null, "name": null, "params": null, "timeout": null, "type": null}], "subtype": null, "tags": [], "type": null}
    When the request is sent
    Then the response status is 400 - JSON format is wrong
  ...
  Scenario: Create an API test returns "- JSON format is wrong" response
    ...
    And body {"config": {"assertions": [], "configVariables": [{"example": null, "name": "VARIABLE_NAME", "pattern": null, "type": null}], "request": {"basicAuth": {"password": "", "username": ""}, "body": null, "certificate": {"cert": {"content": null, "filename": null, "updatedAt": null}, "key": {"content": null, "filename": null, "updatedAt": null}}, "dnsServer": null, "headers": null, "host": null, "method": null, "noSavingResponseBody": null, "port": null, "query": null, "timeout": null, "url": null}, "steps": [{"assertions": [], "extractedValues": [{"field": "content-type", "name": null, "parser": {"type": "regex", "value": ".*"}, "type": null}], "name": null, "request": {"basicAuth": {"password": "", "username": ""}, "body": null, "certificate": {"cert": {"content": null, "filename": null, "updatedAt": null}, "key": {"content": null, "filename": null, "updatedAt": null}}, "dnsServer": null, "headers": null, "host": null, "method": null, "noSavingResponseBody": null, "port": null, "query": null, "timeout": null, "url": null}, "subtype": null}]}, "locations": [], "message": null, "monitor_id": null, "name": null, "options": {"accept_self_signed": null, "allow_insecure": null, "device_ids": [], "disableCors": null, "follow_redirects": null, "min_failure_duration": null, "min_location_failed": null, "monitor_options": {"renotify_interval": null}, "noScreenshot": null, "retry": {"count": null, "interval": null}, "tick_every": null}, "public_id": null, "status": null, "subtype": null, "tags": [], "type": "api"}
    When the request is sent
    Then the response status is 400 - JSON format is wrong
