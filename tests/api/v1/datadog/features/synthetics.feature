...
Feature: Synthetics
  ...
  Scenario: Create a browser test returns "- JSON format is wrong" response
    ...
    And body {"config": {"assertions": [], "request": {"basicAuth": {"password": "", "username": ""}, "body": null, "certificate": {"cert": {"content": null, "filename": null, "updatedAt": null}, "key": {"content": null, "filename": null, "updatedAt": null}}, "dnsServer": null, "dnsServerPort": null, "headers": null, "host": null, "method": "GET", "noSavingResponseBody": null, "port": null, "query": null, "timeout": null, "url": null}, "setCookie": null, "variables": [{"example": null, "id": null, "name": "VARIABLE_NAME", "pattern": null, "type": "element"}]}, "locations": [null], "message": "", "monitor_id": null, "name": null, "options": {"accept_self_signed": null, "allow_insecure": null, "device_ids": ["laptop_large"], "disableCors": null, "follow_redirects": null, "min_failure_duration": null, "min_location_failed": null, "monitor_options": {"renotify_interval": null}, "noScreenshot": null, "retry": {"count": null, "interval": null}, "tick_every": 60}, "public_id": null, "status": "live", "steps": [{"allowFailure": null, "name": null, "params": null, "timeout": null, "type": "assertCurrentUrl"}], "tags": [null], "type": "browser"}
