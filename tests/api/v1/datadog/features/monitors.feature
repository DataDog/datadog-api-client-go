...
Feature: Monitors
  ...
  Scenario: Create a monitor returns "Bad Request" response
    ...
    And body {"created": null, "creator": {}, "deleted": null, "id": null, "message": null, "modified": null, "multi": null, "name": null, "options": {"aggregation": {}, "device_ids": [], "enable_logs_sample": null, "escalation_message": "none", "evaluation_delay": null, "groupby_simple_monitor": null, "include_tags": true, "locked": null, "min_failure_duration": 0, "min_location_failed": 1, "new_host_delay": 300, "no_data_timeframe": null, "notify_audit": false, "notify_no_data": false, "renotify_interval": "none", "require_full_window": null, "silenced": null, "synthetics_check_id": null, "threshold_windows": {"recovery_window": null, "trigger_window": null}, "thresholds": {"critical": null, "critical_recovery": null, "ok": null, "unknown": null, "warning": null, "warning_recovery": null}, "timeout_h": "none"}, "overall_state": null, "priority": null, "query": null, "restricted_roles": [], "state": {}, "tags": [], "type": null}
    When the request is sent
    Then the response status is 400 Bad Request
