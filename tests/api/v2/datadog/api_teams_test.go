...
func createTestTeam(ctx context.Context, t *testing.T, client *datadog.APIClient, name string) datadog.Team {
...
func deleteTestTeam(ctx context.Context, t *testing.T, client *datadog.APIClient, id string) {
