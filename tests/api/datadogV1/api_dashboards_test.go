...
func TestDashboardLifecycle(t *testing.T) {
	...
	monitorSummaryWidgetDefiniton := datadogV1.NewMonitorSummaryWidgetDefinitionWithDefaults()
	monitorSummaryWidgetDefiniton.SetQuery("Errors are increasing")
	monitorSummaryWidgetDefiniton.SetSummaryType(datadogV1.WIDGETSUMMARYTYPE_COMBINED)
	monitorSummaryWidgetDefiniton.SetSort(datadogV1.WIDGETMONITORSUMMARYSORT_NAME_ASCENDING)
	monitorSummaryWidgetDefiniton.SetDisplayFormat(datadogV1.WIDGETMONITORSUMMARYDISPLAYFORMAT_COUNTS)
	monitorSummaryWidgetDefiniton.SetColorPreference(datadogV1.WIDGETCOLORPREFERENCE_BACKGROUND)
	...
	monitorSummaryWidgetDefiniton.SetTitleAlign(datadogV1.WIDGETTEXTALIGN_CENTER)
	monitorSummaryWidgetDefiniton.SetStart(0)
	monitorSummaryWidgetDefiniton.SetCount(5)

	monitorSummaryWidget := datadogV1.NewWidget(datadogV1.MonitorSummaryWidgetDefinitionAsWidgetDefinition(monitorSummaryWidgetDefiniton))
