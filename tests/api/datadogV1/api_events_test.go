...
type createEventResponse struct {
	Event datadogV1.Event `json:"event"`
}
...
func TestEventLifecycle(t *testing.T) {
	...
	var fetchedEventResponse datadogV1.EventResponse
	...
	var eventListResponse datadogV1.EventListResponse
	...
	tests.Retry(time.Duration(5*time.Second), 20, func() bool {
		...
		eventListResponse, httpresp, err = api.ListEvents(ctx, start, end, *datadogV1.NewListEventsOptionalParameters().WithPriority("normal").
