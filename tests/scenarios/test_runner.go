...
func testRunnerEnabled() bool {
	return generatedTestsEnabled() && os.Getenv("DD_TEST_RUNNER_DATA") != ""
}

func testServerEnabled() bool {
	return generatedTestsEnabled() && os.Getenv("DD_TEST_SERVER_URL") != ""
}

func generatedTestsEnabled() bool {
	return strings.EqualFold(os.Getenv("DD_USE_GENERATED_TESTS"), "true")
}
...
func stopTestServerSession(ctx gobdd.Context) error {
	...
	return testServerRequest(fmt.Sprintf("/sessions/%s/stop", value.(string)), nil, nil)
}
