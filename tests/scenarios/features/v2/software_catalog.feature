...
Feature: Software Catalog
  ...
  @skip @team:DataDog/service-catalog @team:DataDog/web-frameworks-approvers
  ...
  @generated @skip @team:DataDog/service-catalog @team:DataDog/web-frameworks-approvers @with-pagination
