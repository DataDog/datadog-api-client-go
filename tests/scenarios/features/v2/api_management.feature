...
Feature: API Management
  ...
  @integration-only @skip-terraform-config @skip-validation @team:DataDog/api-clients @team:DataDog/api-management
  ...
  @generated @skip @team:DataDog/api-clients @team:DataDog/api-management
