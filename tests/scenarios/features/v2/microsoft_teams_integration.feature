...
Feature: Microsoft Teams Integration
  ...
  @generated @skip @team:DataDog/chat-integrations @team:DataDog/web-frameworks-approvers
  ...
  @integration-only @team:DataDog/chat-integrations @team:DataDog/web-frameworks-approvers
  ...
  @team:DataDog/chat-integrations @team:DataDog/web-frameworks-approvers
