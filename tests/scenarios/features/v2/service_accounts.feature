...
Feature: Service Accounts
  ...
  @generated @skip @team:DataDog/api-clients @team:DataDog/credentials-management @team:DataDog/team-aaa-identity
  ...
  @team:DataDog/api-clients @team:DataDog/credentials-management @team:DataDog/team-aaa-identity
