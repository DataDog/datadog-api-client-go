...
Feature: Logs Custom Destinations
  ...
  @team:DataDog/logs-backend @team:DataDog/logs-forwarding @team:DataDog/web-frameworks
  ...
  @skip-java @skip-python @skip-rust @skip-typescript @team:DataDog/logs-backend @team:DataDog/logs-forwarding @team:DataDog/web-frameworks
  ...
  @generated @skip @team:DataDog/logs-backend @team:DataDog/logs-forwarding @team:DataDog/web-frameworks
  ...
  @skip @team:DataDog/logs-backend @team:DataDog/logs-forwarding @team:DataDog/web-frameworks
