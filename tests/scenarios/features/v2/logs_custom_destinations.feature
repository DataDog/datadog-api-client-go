...
Feature: Logs Custom Destinations
  ...
  @team:DataDog/api-clients @team:DataDog/logs-backend
  ...
  @skip-java @skip-python @skip-rust @skip-typescript @team:DataDog/api-clients @team:DataDog/logs-backend
  ...
  @generated @skip @team:DataDog/api-clients @team:DataDog/logs-backend
  ...
  @skip @team:DataDog/api-clients @team:DataDog/logs-backend
