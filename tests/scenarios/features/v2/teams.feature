...
Feature: Teams
  ...
  @generated @skip @team:DataDog/core-app @team:DataDog/web-frameworks-approvers
  ...
  @team:DataDog/core-app @team:DataDog/web-frameworks-approvers
  ...
  @replay-only @skip-validation @team:DataDog/core-app @team:DataDog/web-frameworks-approvers @with-pagination
  ...
  @skip @team:DataDog/core-app @team:DataDog/web-frameworks-approvers
