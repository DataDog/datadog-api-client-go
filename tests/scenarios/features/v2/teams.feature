...
Feature: Teams
  ...
  Scenario: Update a team returns "API error response." response
    ...
    And request contains "team_id" parameter from "REPLACE.ME"
    And body with value {"data": {"attributes": {"avatar": "\ud83e\udd51", "banner": null, "handle": "example-team", "hidden_modules": [], "name": "Example Team", "visible_modules": []}, "relationships": {"team_links": {"data": [{"id": "f9bb8444-af7f-11ec-ac2c-da7ad0900001", "type": "team_links"}]}}, "type": "team"}}
    When the request is sent
    Then the response status is 409 API error response.
