...
Feature: Teams
  ...
  @generated @skip @team:DataDog/core-app @team:DataDog/web-frameworks
  ...
  @team:DataDog/core-app @team:DataDog/web-frameworks
  ...
  @replay-only @skip-validation @team:DataDog/core-app @team:DataDog/web-frameworks @with-pagination
  ...
  @skip @team:DataDog/core-app @team:DataDog/web-frameworks
