...
Feature: Teams
  ...
  @generated @skip @team:DataDog/api-clients @team:DataDog/core-app
  ...
  @team:DataDog/api-clients @team:DataDog/core-app
  ...
  @replay-only @skip-validation @team:DataDog/api-clients @team:DataDog/core-app @with-pagination
  ...
  @skip @team:DataDog/api-clients @team:DataDog/core-app
