...
Feature: Events
  ...
  @generated @skip @team:DataDog/api-clients @team:DataDog/event-management
  Scenario: Get a list of events returns "Bad Request" response
    Given new "ListEvents" request
    When the request is sent
    Then the response status is 400 Bad Request

  @skip-validation @team:DataDog/api-clients @team:DataDog/event-management
  Scenario: Get a list of events returns "OK" response
    Given new "ListEvents" request
    When the request is sent
    Then the response status is 200 OK

  @replay-only @skip-validation @team:DataDog/api-clients @team:DataDog/event-management @with-pagination
  ...
  @team:DataDog/api-clients @team:DataDog/event-management
