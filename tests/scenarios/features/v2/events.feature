...
Feature: Events
  ...
  @generated @skip @team:DataDog/event-management @team:DataDog/web-frameworks
  Scenario: Get a list of events returns "Bad Request" response
    Given new "ListEvents" request
    When the request is sent
    Then the response status is 400 Bad Request

  @skip-validation @team:DataDog/event-management @team:DataDog/web-frameworks
  Scenario: Get a list of events returns "OK" response
    Given new "ListEvents" request
    When the request is sent
    Then the response status is 200 OK

  @replay-only @skip-validation @team:DataDog/event-management @team:DataDog/web-frameworks @with-pagination
  ...
  @team:DataDog/event-management @team:DataDog/web-frameworks
