...
Feature: Logs
  ...
  @replay-only @skip-validation @team:DataDog/logs-app @team:DataDog/web-frameworks-approvers @with-pagination
  ...
  @generated @skip @team:DataDog/logs-app @team:DataDog/web-frameworks-approvers @with-pagination
  ...
  @integration-only @skip-terraform-config @skip-validation @team:DataDog/event-platform-intake @team:DataDog/logs-backend @team:DataDog/logs-ingestion @team:DataDog/web-frameworks-approvers
  ...
  @generated @skip @team:DataDog/event-platform-intake @team:DataDog/logs-backend @team:DataDog/logs-ingestion @team:DataDog/web-frameworks-approvers
  ...
  @team:DataDog/event-platform-intake @team:DataDog/logs-backend @team:DataDog/logs-ingestion @team:DataDog/web-frameworks-approvers
