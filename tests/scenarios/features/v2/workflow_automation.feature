...
Feature: Workflow Automation
  ...
  Scenario: Create Workflow returns "Bad request" response
    Given operation "CreateWorkflow" enabled
  ...
  @skip-python @team:DataDog/workflow-automation-dev
  Scenario: Create Workflow returns "Successfully created a workflow." response
    Given operation "CreateWorkflow" enabled
    And new "CreateWorkflow" request
    And body with value {"data": {"attributes": {"description": "A sample workflow.", "name": "Example Workflow", "published": true, "spec": {"connectionEnvs": [{"connections": [{"connectionId": "11111111-1111-1111-1111-111111111111", "label": "INTEGRATION_DATADOG"}], "env": "default"}], "handle": "my-handle", "inputSchema": {"parameters": [{"defaultValue": "default", "name": "input", "type": "STRING"}]}, "outputSchema": {"parameters": [{"name": "output", "type": "ARRAY_OBJECT", "value": "outputValue"}]}, "steps": [{"actionId": "com.datadoghq.dd.monitor.listMonitors", "connectionLabel": "INTEGRATION_DATADOG", "name": "Step1", "outboundEdges": [{"branchName": "main", "nextStepName": "Step2"}], "parameters": [{"name": "tags", "value": "service:monitoring"}]}, {"actionId": "com.datadoghq.core.noop", "name": "Step2"}], "triggers": [{"monitorTrigger": {"rateLimit": {"count": 1, "interval": "1h"}}, "startStepNames": ["Step1"]}, {"startStepNames": [], "githubWebhookTrigger": {}}]}, "tags": ["team:infra", "service:monitoring", "foo:bar"]}, "type": "workflows"}}
    When the request is sent
  ...
  Scenario: Delete an existing Workflow returns "Not found" response
    Given operation "DeleteWorkflow" enabled
  ...
  Scenario: Delete an existing Workflow returns "Successfully deleted a workflow." response
    Given operation "DeleteWorkflow" enabled
    And there is a valid "workflow" in the system
    And new "DeleteWorkflow" request
  ...
  Scenario: Get an existing Workflow returns "Bad request" response
    Given operation "GetWorkflow" enabled
  ...
  Scenario: Update an existing Workflow returns "Bad request" response
    Given operation "UpdateWorkflow" enabled
    And there is a valid "workflow" in the system
  ...
  Scenario: Update an existing Workflow returns "Not found" response
    ...
    And new "UpdateWorkflow" request
    And request contains "workflow_id" parameter with value "aaa11111-aa11-aa11-aaaa-aaaaaa111111"
    And body with value {"data": {"attributes": {"description": "A sample workflow.", "name": "Example Workflow", "published": true, "spec": {"connectionEnvs": [{"connections": [{"connectionId": "11111111-1111-1111-1111-111111111111", "label": "INTEGRATION_DATADOG"}], "env": "default"}], "handle": "my-handle", "inputSchema": {"parameters": [{"defaultValue": "default", "name": "input", "type": "STRING"}]}, "outputSchema": {"parameters": [{"name": "output", "type": "ARRAY_OBJECT", "value": "outputValue"}]}, "steps": [{"actionId": "com.datadoghq.dd.monitor.listMonitors", "connectionLabel": "INTEGRATION_DATADOG", "name": "Step1", "outboundEdges": [{"branchName": "main", "nextStepName": "Step2"}], "parameters": [{"name": "tags", "value": "service:monitoring"}]}, {"actionId": "com.datadoghq.core.noop", "name": "Step2"}], "triggers": [{"monitorTrigger": {"rateLimit": {"count": 1, "interval": "1h"}}, "startStepNames": ["Step1"]}, {"startStepNames": [], "githubWebhookTrigger": {}}]}, "tags": ["team:infra", "service:monitoring", "foo:bar"]}, "id": "22222222-2222-2222-2222-222222222222", "type": "workflows"}}
    When the request is sent
    Then the response status is 404 Not found
