...
Feature: Roles
  ...
  Scenario: Create role returns "Bad Request" response
    ...
    And body with value {"data": {"attributes": {"name": "developers"}, "relationships": {"permissions": {"data": [{"id": "219", "type": "permissions"}]}, "users": {"data": []}}, "type": "roles"}}
    When the request is sent
    Then the response status is 400 Bad Request
  ...
  Scenario: Update a role returns "Unprocessable Entity" response
    ...
    And request contains "role_id" parameter from "REPLACE.ME"
    And body with value {"data": {"attributes": {}, "id": "00000000-0000-1111-0000-000000000000", "relationships": {"permissions": {"data": [{"id": "219", "type": "permissions"}]}, "users": {"data": []}}, "type": "roles"}}
    When the request is sent
