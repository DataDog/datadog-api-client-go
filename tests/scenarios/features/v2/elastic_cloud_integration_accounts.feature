...
Feature: Elastic Cloud Integration Accounts
  ...
  the Account Management Service (AMS). Each supported interface has its own
  concrete, strongly typed CRUD operations: monitoring (`elastic-cloud`) and
  Cloud Cost Management (`elastic-cloud-ccm`).
