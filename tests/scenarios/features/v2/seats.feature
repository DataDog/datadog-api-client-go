...
Feature: Seats
  ...
  @generated @skip @team:DataDog/billing-experience
  Scenario: Get seats users returns "Bad Request" response
  ...
  @generated @skip @team:DataDog/billing-experience
  Scenario: Get seats users returns "OK" response
    Given new "GetSeatsUsersV2" request
    And request contains "product_code" parameter from "REPLACE.ME"
    When the request is sent
  ...
  @generated @skip @team:DataDog/billing-experience
  Scenario: Get seats users returns "Unprocessable Entity" response
    Given new "GetSeatsUsersV2" request
    And request contains "product_code" parameter from "REPLACE.ME"
    When the request is sent
    Then the response status is 422 Unprocessable Entity
