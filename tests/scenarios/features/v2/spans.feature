...
Feature: Spans
  ...
  @skip @team:DataDog/api-clients @team:DataDog/apm
  ...
  @team:DataDog/api-clients @team:DataDog/apm
  ...
  @generated @skip @team:DataDog/api-clients @team:DataDog/apm
  Scenario: Get a list of spans returns "Bad Request." response
    Given new "ListSpansGet" request
    When the request is sent
    Then the response status is 400 Bad Request.

  @replay-only @team:DataDog/api-clients @team:DataDog/apm
  ...
  @replay-only @skip-validation @team:DataDog/api-clients @team:DataDog/apm @with-pagination
