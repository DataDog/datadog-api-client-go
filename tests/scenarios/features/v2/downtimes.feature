...
Feature: Downtimes
  **Note**: Downtime V2 is currently in private beta. To request access,
  ...
  @skip-validation @team:DataDog/api-clients @team:DataDog/monitor-app
  ...
  @team:DataDog/api-clients @team:DataDog/monitor-app
  ...
  @generated @skip @team:DataDog/api-clients @team:DataDog/monitor-app
  ...
  @replay-only @team:DataDog/api-clients @team:DataDog/monitor-app
  ...
  @generated @skip @team:DataDog/api-clients @team:DataDog/monitor-app @with-pagination
  ...
  @replay-only @skip-validation @team:DataDog/api-clients @team:DataDog/monitor-app @with-pagination
  ...
  @skip-java @skip-python @skip-ruby @skip-rust @skip-typescript @skip-validation @team:DataDog/api-clients @team:DataDog/monitor-app
