...
Feature: GCP Integration
  ...
  @generated @skip @team:DataDog/gcp-integrations @team:DataDog/web-frameworks
  Scenario: Create a Datadog GCP principal returns "Conflict" response
    Given new "MakeGCPSTSDelegate" request
    When the request is sent
    Then the response status is 409 Conflict

  @team:DataDog/gcp-integrations @team:DataDog/web-frameworks
  ...
  @skip-terraform-config @team:DataDog/gcp-integrations @team:DataDog/web-frameworks
