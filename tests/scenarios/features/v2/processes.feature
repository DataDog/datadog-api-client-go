...
Feature: Processes
  ...
  @generated @skip @team:DataDog/container-experiences @team:DataDog/web-frameworks-approvers
  Scenario: Get all processes returns "Bad Request" response
    When the request is sent
    Then the response status is 400 Bad Request

  @team:DataDog/container-experiences @team:DataDog/web-frameworks-approvers
  ...
  @replay-only @skip-validation @team:DataDog/container-experiences @team:DataDog/web-frameworks-approvers @with-pagination
