...
Feature: Sensitive Data Scanner
  ...
  @generated @skip @team:DataDog/api-clients @team:DataDog/logs-app @team:DataDog/sensitive-data-scanner
  ...
  @team:DataDog/api-clients @team:DataDog/logs-app @team:DataDog/sensitive-data-scanner
  ...
  @integration-only @team:DataDog/api-clients @team:DataDog/logs-app @team:DataDog/sensitive-data-scanner
  ...
  @replay-only @team:DataDog/api-clients @team:DataDog/logs-app @team:DataDog/sensitive-data-scanner
