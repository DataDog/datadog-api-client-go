...
Feature: Sensitive Data Scanner
  ...
  @generated @skip @team:DataDog/sensitive-data-scanner @team:DataDog/web-frameworks-approvers
  ...
  @team:DataDog/sensitive-data-scanner @team:DataDog/web-frameworks-approvers
  ...
  @integration-only @team:DataDog/sensitive-data-scanner @team:DataDog/web-frameworks-approvers
  ...
  @replay-only @team:DataDog/sensitive-data-scanner @team:DataDog/web-frameworks-approvers
