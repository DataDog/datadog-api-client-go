...
Feature: Sensitive Data Scanner
  ...
  @generated @skip @team:DataDog/sensitive-data-scanner @team:DataDog/web-frameworks
  ...
  @team:DataDog/sensitive-data-scanner @team:DataDog/web-frameworks
  ...
  @integration-only @team:DataDog/sensitive-data-scanner @team:DataDog/web-frameworks
  ...
  @replay-only @team:DataDog/sensitive-data-scanner @team:DataDog/web-frameworks
