...
Feature: Security Monitoring
  ...
  Scenario: Update resource filters returns "Bad Request" response
    ...
    And body with value {"data": {"attributes": {"cloud_provider": {}}, "type": "csm_resource_filter"}}
    When the request is sent
    Then the response status is 400 Bad Request
  ...
  Scenario: Update resource filters returns "OK" response
    Given new "UpdateResourceEvaluationFilters" request
    And body with value {"data": {"attributes": {"cloud_provider": {"aws": {"123456789": []}}}, "id": "csm_resource_filter", "type": "csm_resource_filter"}}
    When the request is sent
