...
Feature: Security Monitoring
  ...
  @team:DataDog/k9-findings-platform
  Scenario: Attach finding to a Case returns "OK" response
  ...
  @team:DataDog/k9-findings-platform
  Scenario: Attach finding to a Jira issue returns "OK" response
  ...
  @team:DataDog/k9-findings-platform
  Scenario: Attach findings to a Case returns "Bad Request" response
    Given new "AttachCase" request
    And request contains "case_id" parameter with value "7d16945b-baf8-411e-ab2a-20fe43af1ea3"
  ...
  @team:DataDog/k9-findings-platform
  Scenario: Attach findings to a Case returns "Not Found" response
    Given new "AttachCase" request
  ...
  @team:DataDog/k9-findings-platform
  Scenario: Attach findings to a Case returns "OK" response
    Given new "AttachCase" request
    And request contains "case_id" parameter with value "7d16945b-baf8-411e-ab2a-20fe43af1ea3"
  ...
  @team:DataDog/k9-findings-platform
  Scenario: Attach findings to a Jira issue returns "Bad Request" response
    Given new "AttachJiraIssue" request
  ...
  @team:DataDog/k9-findings-platform
  Scenario: Attach findings to a Jira issue returns "Not Found" response
    Given new "AttachJiraIssue" request
  ...
  @team:DataDog/k9-findings-platform
  Scenario: Attach findings to a Jira issue returns "OK" response
    Given new "AttachJiraIssue" request
  ...
  @team:DataDog/k9-findings-platform
  Scenario: Create Jira issue for finding returns "Created" response
  ...
  @team:DataDog/k9-findings-platform
  Scenario: Create Jira issue for findings returns "Created" response
    Given new "CreateJiraIssues" request
  ...
  @team:DataDog/k9-findings-platform
  Scenario: Create Jira issues for findings returns "Bad Request" response
    Given new "CreateJiraIssues" request
  ...
  @team:DataDog/k9-findings-platform
  Scenario: Create Jira issues for findings returns "Created" response
    Given new "CreateJiraIssues" request
  ...
  @team:DataDog/k9-findings-platform
  Scenario: Create Jira issues for findings returns "Not Found" response
    Given new "CreateJiraIssues" request
  ...
  @team:DataDog/k9-findings-platform
  Scenario: Create case for finding returns "Created" response
  ...
  @team:DataDog/k9-findings-platform
  Scenario: Create case for findings returns "Created" response
    Given new "CreateCases" request
  ...
  @team:DataDog/k9-findings-platform
  Scenario: Create cases for findings returns "Bad Request" response
    Given new "CreateCases" request
  ...
  @team:DataDog/k9-findings-platform
  Scenario: Create cases for findings returns "Created" response
    Given new "CreateCases" request
  ...
  @team:DataDog/k9-findings-platform
  Scenario: Create cases for findings returns "Not Found" response
    Given new "CreateCases" request
  ...
  @team:DataDog/k9-findings-platform
  Scenario: Detach findings from their Case returns "Bad Request" response
  ...
  @team:DataDog/k9-findings-platform
  Scenario: Detach findings from their Case returns "No Content" response
    Given new "DetachCase" request
  ...
  @team:DataDog/k9-findings-platform
  Scenario: Detach findings from their Case returns "Not Found" response
    Given new "DetachCase" request
