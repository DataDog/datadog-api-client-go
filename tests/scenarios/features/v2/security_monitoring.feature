...
Feature: Security Monitoring
  ...
  @team:DataDog/k9-cloud-security-platform @team:DataDog/web-frameworks-approvers
  ...
  @generated @skip @team:DataDog/k9-cloud-security-platform @team:DataDog/web-frameworks-approvers
  ...
  @replay-only @team:DataDog/k9-cloud-security-platform @team:DataDog/web-frameworks-approvers
  ...
  @skip @team:DataDog/k9-cloud-security-platform @team:DataDog/web-frameworks-approvers
  ...
  @skip-validation @team:DataDog/k9-cloud-security-platform @team:DataDog/web-frameworks-approvers
  ...
  @generated @skip @team:DataDog/cloud-security-posture-management @team:DataDog/web-frameworks-approvers
  ...
  @team:DataDog/cloud-security-posture-management @team:DataDog/web-frameworks-approvers
  ...
  @generated @skip @team:DataDog/asm-vm @team:DataDog/web-frameworks-approvers
  ...
  @team:DataDog/asm-vm @team:DataDog/web-frameworks-approvers
  ...
  @replay-only @skip-validation @team:DataDog/k9-cloud-security-platform @team:DataDog/web-frameworks-approvers @with-pagination
  ...
  @skip-go @skip-java @skip-ruby @skip-typescript @team:DataDog/k9-cloud-security-platform @team:DataDog/web-frameworks-approvers
  ...
  @skip-go @skip-java @skip-python @skip-ruby @skip-rust @skip-typescript @skip-validation @team:DataDog/k9-cloud-security-platform @team:DataDog/web-frameworks-approvers
