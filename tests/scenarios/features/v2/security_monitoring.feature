...
Feature: Security Monitoring
  ...
  Scenario: Create a new mute rule returns "Bad Request" response
    ...
    And body with value {"data": {"attributes": {"action": {"enabled_until": 1893452400000, "reason": "duplicate", "reason_description": "Muting for a while"}, "enabled": true, "name": "Rule 1", "rule": {"issue_type": "vulnerability", "query": "key:val", "rule_ids": ["rule-id-1"], "rule_types": ["application_code_vulnerability"], "severities": ["critical"]}}}}
    When the request is sent
    Then the response status is 400 Bad Request
  ...
  Scenario: Create a new mute rule returns "Successfully created the mute rule" response
    Given new "CreateMuteRule" request
    And body with value {"data": {"attributes": {"action": {"enabled_until": 1893452400000, "reason": "duplicate", "reason_description": "Muting for a while"}, "enabled": true, "name": "Rule 1", "rule": {"issue_type": "vulnerability", "query": "key:val", "rule_ids": ["rule-id-1"], "rule_types": ["application_code_vulnerability"], "severities": ["critical"]}}, "type": "mute_rules"}}
    When the request is sent
  ...
  Scenario: Get details of a mute rule returns "Bad Request" response
    ...
    And request contains "mute_rule_id" parameter with value "invalid-uuid"
    When the request is sent
    Then the response status is 400 Bad Request
  ...
  Scenario: Get details of an inbox rule returns "Bad Request" response
    ...
    And request contains "inbox_rule_id" parameter with value "invalid-uuid"
    When the request is sent
    Then the response status is 400 Bad Request
  ...
  Scenario: Patch a mute rule returns "Bad Request" response
    ...
    And there is a valid "valid_mute_rule" in the system
    And request contains "mute_rule_id" parameter from "valid_mute_rule.data.id"
    And body with value {"invalid": {"attributes": {"action": {"enabled_until": 1893452400000, "reason": "duplicate", "reason_description": "Muting for a while"}, "enabled": true, "name": "Rule 1", "rule": {"issue_type": "vulnerability", "query": "key:val", "rule_ids": ["rule-id-1"], "rule_types": ["application_code_vulnerability"], "severities": ["critical"]}}, "id": "{{ valid_mute_rule.data.id }}", "type": "mute_rules"}}
    When the request is sent
    Then the response status is 400 Bad Request
  ...
  Scenario: Patch a mute rule returns "Mute rule successfully patched" response
    ...
    And there is a valid "valid_mute_rule" in the system
    And request contains "mute_rule_id" parameter from "valid_mute_rule.data.id"
    And body with value {"data": {"attributes": {"action": {"enabled_until": 1893452400000, "reason": "duplicate", "reason_description": "Muting for a while"}, "enabled": true, "name": "Rule 1", "rule": {"issue_type": "vulnerability", "query": "key:val", "rule_ids": ["rule-id-1"], "rule_types": ["application_code_vulnerability"], "severities": ["critical"]}}, "id": "{{ valid_mute_rule.data.id }}", "type": "mute_rules"}}
    When the request is sent
  ...
  Scenario: Patch a mute rule returns "Not Found" response
    Given new "PatchMuteRule" request
    And request contains "mute_rule_id" parameter with value "00000000-0000-0000-0000-426655000000"
    And body with value {"data": {"attributes": {"action": {"enabled_until": 1893452400000, "reason": "duplicate", "reason_description": "Muting for a while"}, "enabled": true, "name": "Rule 1", "rule": {"issue_type": "vulnerability", "query": "key:val", "rule_ids": ["rule-id-1"], "rule_types": ["application_code_vulnerability"], "severities": ["critical"]}}, "id": "00000000-0000-0000-0000-426655000000", "type": "mute_rules"}}
    When the request is sent
    Then the response status is 404 Not Found
