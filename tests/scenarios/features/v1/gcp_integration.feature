...
Feature: GCP Integration
  ...
  @generated @skip @team:DataDog/gcp-integrations @team:DataDog/web-frameworks-approvers
  ...
  @team:DataDog/gcp-integrations @team:DataDog/web-frameworks-approvers
  ...
  @skip-terraform-config @team:DataDog/gcp-integrations @team:DataDog/web-frameworks-approvers
