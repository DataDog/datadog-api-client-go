...
Feature: Hosts
  ...
  @generated @skip @team:DataDog/core-index @team:DataDog/web-frameworks
  ...
  @integration-only @team:DataDog/core-index @team:DataDog/web-frameworks
  ...
  @replay-only @team:DataDog/core-index @team:DataDog/web-frameworks
  ...
  @skip-validation @team:DataDog/core-index @team:DataDog/web-frameworks
