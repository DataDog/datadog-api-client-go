...
Feature: Hosts
  ...
  @generated @skip @team:DataDog/api-clients @team:DataDog/core-index
  ...
  @integration-only @team:DataDog/api-clients @team:DataDog/core-index
  ...
  @replay-only @team:DataDog/api-clients @team:DataDog/core-index
  ...
  @skip-validation @team:DataDog/api-clients @team:DataDog/core-index
