...
Feature: Hosts
  ...
  @generated @skip @team:DataDog/core-index @team:DataDog/web-frameworks-approvers
  ...
  @integration-only @team:DataDog/core-index @team:DataDog/web-frameworks-approvers
  ...
  @replay-only @team:DataDog/core-index @team:DataDog/web-frameworks-approvers
  ...
  @skip-validation @team:DataDog/core-index @team:DataDog/web-frameworks-approvers
