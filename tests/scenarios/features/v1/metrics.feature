...
Feature: Metrics
  ...
  **Note**: A graph can only contain a set number of points and as the
  ...
  @integration-only @skip-terraform-config @skip-validation @team:DataDog/api-clients @team:DataDog/metrics-aggregation
  ...
  @generated @skip @team:DataDog/api-clients @team:DataDog/metrics-aggregation
  ...
  @skip @team:DataDog/api-clients @team:DataDog/metrics-intake @team:DataDog/metrics-query
  ...
  @skip-validation @team:DataDog/api-clients @team:DataDog/metrics-intake @team:DataDog/metrics-query
