...
Feature: Synthetics
  ...
  @replay-only @skip-validation @team:DataDog/synthetics-ct @team:DataDog/web-frameworks-approvers
  ...
  @team:DataDog/synthetics-ct @team:DataDog/web-frameworks-approvers
  ...
  @generated @skip @team:DataDog/synthetics-ct @team:DataDog/web-frameworks-approvers
  ...
  @replay-only @team:DataDog/synthetics-ct @team:DataDog/web-frameworks-approvers
  ...
  @skip @team:DataDog/synthetics-ct @team:DataDog/web-frameworks-approvers
  ...
  @replay-only @skip-validation @team:DataDog/synthetics-ct @team:DataDog/web-frameworks-approvers @with-pagination
