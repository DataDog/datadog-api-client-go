...
Feature: Synthetics
  ...
  @replay-only @skip-validation @team:DataDog/synthetics-ct @team:DataDog/web-frameworks
  ...
  @team:DataDog/synthetics-ct @team:DataDog/web-frameworks
  ...
  @generated @skip @team:DataDog/synthetics-ct @team:DataDog/web-frameworks
  ...
  @replay-only @team:DataDog/synthetics-ct @team:DataDog/web-frameworks
  ...
  @skip @team:DataDog/synthetics-ct @team:DataDog/web-frameworks
  ...
  @replay-only @skip-validation @team:DataDog/synthetics-ct @team:DataDog/web-frameworks @with-pagination
