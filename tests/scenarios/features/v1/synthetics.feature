...
Feature: Synthetics
  ...
  @replay-only @skip-validation @team:DataDog/api-clients @team:DataDog/synthetics-app
  ...
  @generated @skip @team:DataDog/api-clients @team:DataDog/synthetics-app
  ...
  @team:DataDog/api-clients @team:DataDog/synthetics-app
  ...
  @skip @team:DataDog/api-clients @team:DataDog/synthetics-app
  ...
  @replay-only @team:DataDog/api-clients @team:DataDog/synthetics-app
  ...
  @replay-only @skip-validation @team:DataDog/api-clients @team:DataDog/synthetics-app @with-pagination
