...
Feature: Logs
  ...
  @integration-only @skip-terraform-config @skip-validation @team:DataDog/api-clients @team:DataDog/event-platform-intake
  ...
  @team:DataDog/api-clients @team:DataDog/event-platform-intake
  ...
  @generated @skip @team:DataDog/api-clients @team:DataDog/event-platform-intake
