...
Feature: Logs
  ...
  @integration-only @skip-terraform-config @skip-validation @team:DataDog/event-platform-intake @team:DataDog/web-frameworks
  ...
  @team:DataDog/event-platform-intake @team:DataDog/web-frameworks
  ...
  @generated @skip @team:DataDog/event-platform-intake @team:DataDog/web-frameworks
