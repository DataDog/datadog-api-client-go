...
Feature: Key Management
  ...
  Scenario: Create an API key returns "Bad Request" response
    ...
    And body with value {"created": "2019-08-02 15:31:07", "created_by": "john@example.com", "key": "1234512345123456abcabc912349abcd", "name": "example user"}
  ...
  Scenario: Create an application key returns "Bad Request" response
    ...
    And body with value {"hash": "1234512345123459cda4eb9ced49a3d84fd0138c", "name": "example user", "owner": "example.com"}
    When the request is sent
    Then the response status is 400 Bad Request
