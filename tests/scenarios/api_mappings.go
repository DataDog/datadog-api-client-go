...
var apiMappings = map[string]map[string]reflect.Value{
	...
	"v2": {
	    ...
	    "AnnotationsApi": reflect.ValueOf(datadogV2.NewAnnotationsApi),
	    ...
	    "ChangeManagementApi": reflect.ValueOf(datadogV2.NewChangeManagementApi),
	    "CIVisibilityGitHubAccountsApi": reflect.ValueOf(datadogV2.NewCIVisibilityGitHubAccountsApi),
	    ...
	    "CodeCoverageApi": reflect.ValueOf(datadogV2.NewCodeCoverageApi),
	    "ComplianceApi": reflect.ValueOf(datadogV2.NewComplianceApi),
	    ...
	    "CSMOwnershipApi": reflect.ValueOf(datadogV2.NewCSMOwnershipApi),
	    "CSMSettingsApi": reflect.ValueOf(datadogV2.NewCSMSettingsApi),
	    "DashboardListsApi": reflect.ValueOf(datadogV2.NewDashboardListsApi),
	    "DashboardSharingApi": reflect.ValueOf(datadogV2.NewDashboardSharingApi),
	    "DashboardSecureEmbedApi": reflect.ValueOf(datadogV2.NewDashboardSecureEmbedApi),
	    ...
	    "DDSQLApi": reflect.ValueOf(datadogV2.NewDDSQLApi),
	    "DataDeletionApi": reflect.ValueOf(datadogV2.NewDataDeletionApi),
	    "DEMApi": reflect.ValueOf(datadogV2.NewDEMApi),
	    ...
	    "DatabricksIntegrationApi": reflect.ValueOf(datadogV2.NewDatabricksIntegrationApi),
	    "ElasticCloudIntegrationApi": reflect.ValueOf(datadogV2.NewElasticCloudIntegrationApi),
	    "SnowflakeIntegrationApi": reflect.ValueOf(datadogV2.NewSnowflakeIntegrationApi),
	    "TwilioIntegrationApi": reflect.ValueOf(datadogV2.NewTwilioIntegrationApi),
	    ...
	    "GoogleChatIntegrationApi": reflect.ValueOf(datadogV2.NewGoogleChatIntegrationApi),
	    ...
	    "ModelLabAPIApi": reflect.ValueOf(datadogV2.NewModelLabAPIApi),
	    ...
	    "NetworkHealthInsightsApi": reflect.ValueOf(datadogV2.NewNetworkHealthInsightsApi),
	    "CloudNetworkMonitoringApi": reflect.ValueOf(datadogV2.NewCloudNetworkMonitoringApi),
	    "OAuth2ClientPublicApi": reflect.ValueOf(datadogV2.NewOAuth2ClientPublicApi),
	    ...
	    "CustomerOrgApi": reflect.ValueOf(datadogV2.NewCustomerOrgApi),
	    "OrgAuthorizedClientsApi": reflect.ValueOf(datadogV2.NewOrgAuthorizedClientsApi),
	    "OrgConnectionsApi": reflect.ValueOf(datadogV2.NewOrgConnectionsApi),
	    "OrgGroupsApi": reflect.ValueOf(datadogV2.NewOrgGroupsApi),
	    ...
	    "ProductCatalogApi": reflect.ValueOf(datadogV2.NewProductCatalogApi),
	    "APMTraceApi": reflect.ValueOf(datadogV2.NewAPMTraceApi),
	    ...
	    "RUMRetentionQuotasApi": reflect.ValueOf(datadogV2.NewRUMRetentionQuotasApi),
	    "RumTeamsOwnershipApi": reflect.ValueOf(datadogV2.NewRumTeamsOwnershipApi),
	    ...
	    "ThreatIntelligenceApi": reflect.ValueOf(datadogV2.NewThreatIntelligenceApi),
	    ...
	    "ReportingAndSharingApi": reflect.ValueOf(datadogV2.NewReportingAndSharingApi),
	    ...
	    "StegadographyApi": reflect.ValueOf(datadogV2.NewStegadographyApi),
	    "SyntheticsApi": reflect.ValueOf(datadogV2.NewSyntheticsApi),
	    "TeamsApi": reflect.ValueOf(datadogV2.NewTeamsApi),
	    "TimeseriesAnomalyInvestigationsApi": reflect.ValueOf(datadogV2.NewTimeseriesAnomalyInvestigationsApi),
	    "UserAuthorizedClientsApi": reflect.ValueOf(datadogV2.NewUserAuthorizedClientsApi),
