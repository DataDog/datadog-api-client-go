...
var apiMappings = map[string]map[string]reflect.Value{
	...
	"v2": {
	    ...
	    "GovernanceControlsApi": reflect.ValueOf(datadogV2.NewGovernanceControlsApi),
	    "GovernanceInsightsApi": reflect.ValueOf(datadogV2.NewGovernanceInsightsApi),
	    ...
	    "ElasticCloudCloudCostManagementApi": reflect.ValueOf(datadogV2.NewElasticCloudCloudCostManagementApi),
	    "ElasticCloudMonitoringApi": reflect.ValueOf(datadogV2.NewElasticCloudMonitoringApi),
