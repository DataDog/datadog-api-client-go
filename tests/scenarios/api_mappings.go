...
var apiMappings = map[string]map[string]reflect.Value{
	...
	"v2": {
	    ...
	    "CloudInventorySyncConfigsApi": reflect.ValueOf(datadogV2.NewCloudInventorySyncConfigsApi),
	    ...
	    "EmailTransportApi": reflect.ValueOf(datadogV2.NewEmailTransportApi),
	    ...
	    "RumReplayAnalysisApi": reflect.ValueOf(datadogV2.NewRumReplayAnalysisApi),
	    "RumReplayHeatmapsApi": reflect.ValueOf(datadogV2.NewRumReplayHeatmapsApi),
	    "RumReplayApi": reflect.ValueOf(datadogV2.NewRumReplayApi),
