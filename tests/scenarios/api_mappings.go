...
var apiMappings = map[string]map[string]reflect.Value{
	...
	"v2": {
	    ...
	    "CohortApi": reflect.ValueOf(datadogV2.NewCohortApi),
	    "RumMetricsApi": reflect.ValueOf(datadogV2.NewRumMetricsApi),
	    "FunnelApi": reflect.ValueOf(datadogV2.NewFunnelApi),
	    "UserFlowApi": reflect.ValueOf(datadogV2.NewUserFlowApi),
	    "SegmentsApi": reflect.ValueOf(datadogV2.NewSegmentsApi),
