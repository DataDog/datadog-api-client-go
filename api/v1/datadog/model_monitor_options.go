...
type MonitorOptions struct {
	...
	EvaluationDelay common.NullableInt64 `json:"evaluation_delay,omitempty"`
	...
	MinFailureDuration common.NullableInt64 `json:"min_failure_duration,omitempty"`
	...
	MinLocationFailed common.NullableInt64 `json:"min_location_failed,omitempty"`
	// Time (in seconds) to skip evaluations for new groups.
	//
	// For example, this option can be used to skip evaluations for new hosts while they initialize.
	//
	// Must be a non negative integer.
	NewGroupDelay common.NullableInt64 `json:"new_group_delay,omitempty"`
	...
	// Deprecated
	NewHostDelay common.NullableInt64 `json:"new_host_delay,omitempty"`
	...
	NoDataTimeframe common.NullableInt64 `json:"no_data_timeframe,omitempty"`
	...
	RenotifyInterval common.NullableInt64 `json:"renotify_interval,omitempty"`
	// The number of times re-notification messages should be sent on the current status at the provided re-notification interval.
	RenotifyOccurrences common.NullableInt64 `json:"renotify_occurrences,omitempty"`
	...
	// Deprecated
	SyntheticsCheckId common.NullableString `json:"synthetics_check_id,omitempty"`
	...
	TimeoutH common.NullableInt64 `json:"timeout_h,omitempty"`
...
func NewMonitorOptions() *MonitorOptions {
	...
	this.MinFailureDuration = *common.NewNullableInt64(&minFailureDuration)
	var minLocationFailed int64 = 1
	this.MinLocationFailed = *common.NewNullableInt64(&minLocationFailed)
	var newHostDelay int64 = 300
	this.NewHostDelay = *common.NewNullableInt64(&newHostDelay)
	var notifyAudit bool = false
	this.NotifyAudit = &notifyAudit
	var notifyNoData bool = false
	this.NotifyNoData = &notifyNoData
	this.RenotifyInterval = *common.NewNullableInt64(nil)
	this.TimeoutH = *common.NewNullableInt64(nil)
	return &this
}
...
// SetEvaluationDelay gets a reference to the given common.NullableInt64 and assigns it to the EvaluationDelay field.
...
// SetMinFailureDuration gets a reference to the given common.NullableInt64 and assigns it to the MinFailureDuration field.
...
// SetMinLocationFailed gets a reference to the given common.NullableInt64 and assigns it to the MinLocationFailed field.
...
// SetNewGroupDelay gets a reference to the given common.NullableInt64 and assigns it to the NewGroupDelay field.
...
// SetNewHostDelay gets a reference to the given common.NullableInt64 and assigns it to the NewHostDelay field.
// Deprecated
...
// SetNoDataTimeframe gets a reference to the given common.NullableInt64 and assigns it to the NoDataTimeframe field.
...
// SetRenotifyInterval gets a reference to the given common.NullableInt64 and assigns it to the RenotifyInterval field.
...
// SetRenotifyOccurrences gets a reference to the given common.NullableInt64 and assigns it to the RenotifyOccurrences field.
...
// SetSyntheticsCheckId gets a reference to the given common.NullableString and assigns it to the SyntheticsCheckId field.
// Deprecated
...
// SetTimeoutH gets a reference to the given common.NullableInt64 and assigns it to the TimeoutH field.
