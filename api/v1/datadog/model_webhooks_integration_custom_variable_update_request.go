...
type NullableWebhooksIntegrationCustomVariableUpdateRequest struct {
	value *WebhooksIntegrationCustomVariableUpdateRequest
	isSet bool
}

func (v NullableWebhooksIntegrationCustomVariableUpdateRequest) Get() *WebhooksIntegrationCustomVariableUpdateRequest {
	return v.value
}

func (v *NullableWebhooksIntegrationCustomVariableUpdateRequest) Set(val *WebhooksIntegrationCustomVariableUpdateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhooksIntegrationCustomVariableUpdateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhooksIntegrationCustomVariableUpdateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhooksIntegrationCustomVariableUpdateRequest(val *WebhooksIntegrationCustomVariableUpdateRequest) *NullableWebhooksIntegrationCustomVariableUpdateRequest {
	return &NullableWebhooksIntegrationCustomVariableUpdateRequest{value: val, isSet: true}
}

func (v NullableWebhooksIntegrationCustomVariableUpdateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhooksIntegrationCustomVariableUpdateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
