...
*/
func (a *MonitorsApiService) CanDeleteMonitor(ctx _context.Context, monitorIds []int64) (CanDeleteMonitorResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerUrlWithContext(ctx, "MonitorsApiService.CanDeleteMonitor")
	if err != nil {
