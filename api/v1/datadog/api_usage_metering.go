...
func NewGetUsageComplianceMonitoringOptionalParameters() *GetUsageComplianceMonitoringOptionalParameters {
	this := GetUsageComplianceMonitoringOptionalParameters{}
	return &this
}
func (r *GetUsageComplianceMonitoringOptionalParameters) WithEndHr(endHr time.Time) *GetUsageComplianceMonitoringOptionalParameters {
	r.EndHr = &endHr
	return r
}
 ...
 */
func (a *UsageMeteringApiService) GetUsageComplianceMonitoring(ctx _context.Context, startHr time.Time, o ...GetUsageComplianceMonitoringOptionalParameters) (UsageComplianceResponse, *_nethttp.Response, error) {
	...
	if len(o) > 1 {
		var localVarReturnValue UsageComplianceResponse
		return localVarReturnValue, nil, reportError("only one argument of type GetUsageComplianceMonitoringOptionalParameters is allowed")
	}
