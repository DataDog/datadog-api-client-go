...
type apiGetChargebackSummaryRequest struct {
...
type GetChargebackSummaryOptionalParameters struct {
	EndMonth *time.Time
}

func NewGetChargebackSummaryOptionalParameters() *GetChargebackSummaryOptionalParameters {
	this := GetChargebackSummaryOptionalParameters{}
	return &this
}
func (r *GetChargebackSummaryOptionalParameters) WithEndMonth(endMonth time.Time) *GetChargebackSummaryOptionalParameters {
	r.EndMonth = &endMonth
	return r
}

/*
 * GetChargebackSummary Get cost by sub-org
 * Get usage cost per product for each sub-org across your multi-org account.
 */
func (a *UsageMeteringApiService) GetChargebackSummary(ctx _context.Context, startMonth time.Time, o ...GetChargebackSummaryOptionalParameters) (ChargebackSummaryResponse, *_nethttp.Response, error) {
	req := apiGetChargebackSummaryRequest{
		ApiService: a,
		ctx:        ctx,
	...
	if len(o) > 1 {
		var localVarReturnValue ChargebackSummaryResponse
		return localVarReturnValue, nil, reportError("only one argument of type GetChargebackSummaryOptionalParameters is allowed")
	}
	...
	return req.ApiService.getChargebackSummaryExecute(req)
}
 ...
 */
func (a *UsageMeteringApiService) getChargebackSummaryExecute(r apiGetChargebackSummaryRequest) (ChargebackSummaryResponse, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  ChargebackSummaryResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsageMeteringApiService.GetChargebackSummary")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/usage/chargeback-summary"
	...
	localVarHeaderParams["DD-OPERATION-ID"] = "GetChargebackSummary"
