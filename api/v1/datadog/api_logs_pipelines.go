...
type apiGetAllLogsPipelinesRequest struct {
	ctx        _context.Context
	apiService *LogsPipelinesApiService
}
...
*/
func (a *LogsPipelinesApiService) GetAllLogsPipelines(ctx _context.Context) apiGetAllLogsPipelinesRequest {
	return apiGetAllLogsPipelinesRequest{
		apiService: a,
		ctx:        ctx,
	}
...
Execute executes the request
 @return []LogsPipeline
*/
func (r apiGetAllLogsPipelinesRequest) Execute() ([]LogsPipeline, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "LogsPipelinesApiService.GetAllLogsPipelines")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
