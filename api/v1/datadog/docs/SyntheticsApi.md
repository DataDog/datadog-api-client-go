...
func main() {
    ...
    body := datadog.SyntheticsGlobalVariable{CreatedAt: "TODO", CreatedBy: 123, Description: "Description_example", Id: "Id_example", ModifiedAt: "TODO", Name: "Name_example", Tags: []string{"Tags_example"), Value: datadog.SyntheticsGlobalVariable_value{Secure: false, Value: "Value_example"}} // SyntheticsGlobalVariable | Details of the global variable to create.
...
func main() {
    ...
    variableId := "variableId_example" // string | The ID of the global variable.
    body := datadog.SyntheticsGlobalVariable{CreatedAt: "TODO", CreatedBy: 123, Description: "Description_example", Id: "Id_example", ModifiedAt: "TODO", Name: "Name_example", Tags: []string{"Tags_example"), Value: datadog.SyntheticsGlobalVariable_value{Secure: false, Value: "Value_example"}} // SyntheticsGlobalVariable | Details of the global variable to update.
