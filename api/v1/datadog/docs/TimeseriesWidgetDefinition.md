...
`func (o *TimeseriesWidgetDefinition) HasRequests() bool`
...
SetRequests gets a reference to the given []TimeseriesWidgetRequest and assigns it to the Requests field.
...
`func (o *TimeseriesWidgetDefinition) HasType() bool`
