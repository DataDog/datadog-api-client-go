...
**DowntimeType** | Pointer to **int32** | 0 for a downtime applied on &#x60;*&#x60; or all; 1 when the downtime is only scoped to hosts; 2 when the downtime is scoped to anything but hosts. | [optional] [readonly] 
