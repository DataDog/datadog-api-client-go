...
| **Variables**            | Pointer to [**[]MonitorFormulaAndFunctionQueryDefinition**](MonitorFormulaAndFunctionQueryDefinition.md) | List of requests that can be used in the monitor query. **This feature is currently in beta.**                                                                                                                                                                                                                                                                        | [optional]                     |
