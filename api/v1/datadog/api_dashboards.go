...
*/
func (a *DashboardsApiService) GetAllDashboards(ctx _context.Context) apiGetAllDashboardsRequest {
	return apiGetAllDashboardsRequest{
		apiService: a,
		ctx:        ctx,
	}
...
*/
func (r apiGetAllDashboardsRequest) Execute() (DashboardSummary, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "DashboardsApiService.GetAllDashboards")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
