...
type DowntimeRecurrence struct {
	...
	UntilDate client.NullableInt64 `json:"until_date,omitempty"`
	// How many times the downtime is rescheduled.
	// `until_occurences` and `until_date` are mutually exclusive.
	UntilOccurrences client.NullableInt32 `json:"until_occurrences,omitempty"`
...
// SetUntilDate gets a reference to the given client.NullableInt64 and assigns it to the UntilDate field.
...
// SetUntilOccurrences gets a reference to the given client.NullableInt32 and assigns it to the UntilOccurrences field.
