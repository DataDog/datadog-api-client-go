...
type LogsURLParser struct {
	...
	NormalizeEndingSlashes client.NullableBool `json:"normalize_ending_slashes,omitempty"`
...
func NewLogsURLParser(sources []string, target string, type_ LogsURLParserType) *LogsURLParser {
	...
	this.NormalizeEndingSlashes = *client.NewNullableBool(&normalizeEndingSlashes)
...
// SetNormalizeEndingSlashes gets a reference to the given client.NullableBool and assigns it to the NormalizeEndingSlashes field.
