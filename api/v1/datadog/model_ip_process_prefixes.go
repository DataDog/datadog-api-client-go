...
// IPProcessPrefixes Available prefix information for the Process endpoints.
type IPProcessPrefixes struct {
...
func (o IPProcessPrefixes) MarshalJSON() ([]byte, error) {
...
type NullableIPProcessPrefixes struct {
	value *IPProcessPrefixes
	isSet bool
}

func (v NullableIPProcessPrefixes) Get() *IPProcessPrefixes {
	return v.value
}

func (v *NullableIPProcessPrefixes) Set(val *IPProcessPrefixes) {
	v.value = val
	v.isSet = true
}

func (v NullableIPProcessPrefixes) IsSet() bool {
	return v.isSet
}

func (v *NullableIPProcessPrefixes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIPProcessPrefixes(val *IPProcessPrefixes) *NullableIPProcessPrefixes {
	return &NullableIPProcessPrefixes{value: val, isSet: true}
}

func (v NullableIPProcessPrefixes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIPProcessPrefixes) UnmarshalJSON(src []byte) error {
	v.isSet = true
