...
type apiEditMetricMetadataRequest struct {
...
func (r apiEditMetricMetadataRequest) Body(body MetricMetadata) apiEditMetricMetadataRequest {
	r.body = &body
	return r
}
...
*/
func (r apiEditMetricMetadataRequest) Execute() (MetricMetadata, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "MetricsApiService.EditMetricMetadata")
	if err != nil {
...
type apiGetAllActiveMetricsRequest struct {
	ctx        _context.Context
	apiService *MetricsApiService
	from       *int64
	host       *string
...
func (r apiGetAllActiveMetricsRequest) From(from int64) apiGetAllActiveMetricsRequest {
	r.from = &from
	return r
}

func (r apiGetAllActiveMetricsRequest) Host(host string) apiGetAllActiveMetricsRequest {
	r.host = &host
	return r
}

/*
GetAllActiveMetrics Get active metrics list
Get the list of actively reporting metrics from a given time until now.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return apiGetAllActiveMetricsRequest
*/
func (a *MetricsApiService) GetAllActiveMetrics(ctx _context.Context) apiGetAllActiveMetricsRequest {
	return apiGetAllActiveMetricsRequest{
		apiService: a,
		ctx:        ctx,
	}
...
*/
func (r apiGetAllActiveMetricsRequest) Execute() (MetricsListResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "MetricsApiService.GetAllActiveMetrics")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiSearchMetricsRequest) Q(q string) apiSearchMetricsRequest {
	r.q = &q
	return r
}
...
*/
func (a *MetricsApiService) SearchMetrics(ctx _context.Context) apiSearchMetricsRequest {
	return apiSearchMetricsRequest{
		apiService: a,
		ctx:        ctx,
	}
...
*/
func (r apiSearchMetricsRequest) Execute() (MetricSearchResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "MetricsApiService.SearchMetrics")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
