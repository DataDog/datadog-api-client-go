...
type UsageCIVisibilityHour struct {
	...
	CiVisibilityComboCommitters *int32 `json:"ci_visibility_combo_committers,omitempty"`
...
// GetCiVisibilityComboCommitters returns the CiVisibilityComboCommitters field value if set, zero value otherwise.
func (o *UsageCIVisibilityHour) GetCiVisibilityComboCommitters() int32 {
	if o == nil || o.CiVisibilityComboCommitters == nil {
		var ret int32
		return ret
	}
	return *o.CiVisibilityComboCommitters
}

// GetCiVisibilityComboCommittersOk returns a tuple with the CiVisibilityComboCommitters field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UsageCIVisibilityHour) GetCiVisibilityComboCommittersOk() (*int32, bool) {
	if o == nil || o.CiVisibilityComboCommitters == nil {
		return nil, false
	}
	return o.CiVisibilityComboCommitters, true
}
...
// SetCiVisibilityComboCommitters gets a reference to the given int32 and assigns it to the CiVisibilityComboCommitters field.
func (o *UsageCIVisibilityHour) SetCiVisibilityComboCommitters(v int32) {
	o.CiVisibilityComboCommitters = &v
}
...
func (o UsageCIVisibilityHour) MarshalJSON() ([]byte, error) {
	...
	if o.CiVisibilityComboCommitters != nil {
		toSerialize["ci_visibility_combo_committers"] = o.CiVisibilityComboCommitters
	}
...
func (o *UsageCIVisibilityHour) UnmarshalJSON(bytes []byte) (err error) {
	...
	o.CiVisibilityComboCommitters = all.CiVisibilityComboCommitters
