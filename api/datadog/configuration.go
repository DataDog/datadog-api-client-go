...
func NewConfiguration() *Configuration {
	cfg := &Configuration{
		...
		unstableOperations: map[string]bool{
			...
			"v2.CreateCustomAgentConversation":           false,
			"v2.CreateDataTransformation":                false,
			"v2.CreateDataTransformationDescription":     false,
			"v2.CreatePickAction":                        false,
			"v2.CreatePickRemediationFromInvestigation":  false,
			"v2.CreateWorkflowDescription":               false,
			"v2.CreateWorkflowScaffoldAgenticStream":     false,
