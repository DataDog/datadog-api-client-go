...
func NewConfiguration() *Configuration {
	cfg := &Configuration{
		...
		unstableOperations: map[string]bool{
			...
			"v2.CancelWorkflowExecution":                        false,
			"v2.CancelWorkflowExecutions":                       false,
			"v2.CreateAIWorkflow":                               false,
			"v2.CreateWorkflowExecution":                        false,
			"v2.DeleteAIWorkflow":                               false,
			"v2.DeleteWorkflowExecutions":                       false,
			"v2.GetAIWorkflow":                                  false,
			"v2.ListAIWorkflowInstances":                        false,
			"v2.ListAIWorkflows":                                false,
			"v2.ListExecutionSteps":                             false,
			"v2.ListPROutputs":                                  false,
			"v2.RerunWorkflowExecution":                         false,
			"v2.UpdateAIWorkflow":                               false,
