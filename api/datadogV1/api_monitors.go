...
//   - [optional] supports `#`, with `#` an integer or decimal number used to set the threshold
//   - for `anomaly`:
//   - supports `direction=both`, `direction=above`, `direction=below`
//   - [optional] supports `threshold=#`, with `#` an integer or decimal number used to set the threshold
//
// - `operator`
