...
// SyntheticsMobileStepParamsElementUserLocatorValuesItemsType The definition of `SyntheticsMobileStepParamsElementUserLocatorValuesItemsType` object.
...
const (
	SYNTHETICSMOBILESTEPPARAMSELEMENTUSERLOCATORVALUESITEMSTYPE_ACCESSIBILITYNOT_ID        SyntheticsMobileStepParamsElementUserLocatorValuesItemsType = "accessibility-id"
	...
	SYNTHETICSMOBILESTEPPARAMSELEMENTUSERLOCATORVALUESITEMSTYPE_IOSNOT_PREDICATENOT_STRING SyntheticsMobileStepParamsElementUserLocatorValuesItemsType = "ios-predicate-string"
	SYNTHETICSMOBILESTEPPARAMSELEMENTUSERLOCATORVALUESITEMSTYPE_IOSNOT_CLASSNOT_CHAIN      SyntheticsMobileStepParamsElementUserLocatorValuesItemsType = "ios-class-chain"
...
var allowedSyntheticsMobileStepParamsElementUserLocatorValuesItemsTypeEnumValues = []SyntheticsMobileStepParamsElementUserLocatorValuesItemsType{
	SYNTHETICSMOBILESTEPPARAMSELEMENTUSERLOCATORVALUESITEMSTYPE_ACCESSIBILITYNOT_ID,
	SYNTHETICSMOBILESTEPPARAMSELEMENTUSERLOCATORVALUESITEMSTYPE_ID,
	SYNTHETICSMOBILESTEPPARAMSELEMENTUSERLOCATORVALUESITEMSTYPE_IOSNOT_PREDICATENOT_STRING,
	SYNTHETICSMOBILESTEPPARAMSELEMENTUSERLOCATORVALUESITEMSTYPE_IOSNOT_CLASSNOT_CHAIN,
