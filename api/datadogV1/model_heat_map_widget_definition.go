...
type HeatMapWidgetDefinition struct {
	...
	Yaxis *HeatMapWidgetYAxis `json:"yaxis,omitempty"`
...
func (o *HeatMapWidgetDefinition) GetYaxis() HeatMapWidgetYAxis {
	if o == nil || o.Yaxis == nil {
		var ret HeatMapWidgetYAxis
		return ret
	}
	return *o.Yaxis
}
...
// and a boolean to check if the value has been set.
func (o *HeatMapWidgetDefinition) GetYaxisOk() (*HeatMapWidgetYAxis, bool) {
	if o == nil || o.Yaxis == nil {
		return nil, false
	}
	return o.Yaxis, true
...
// SetYaxis gets a reference to the given HeatMapWidgetYAxis and assigns it to the Yaxis field.
func (o *HeatMapWidgetDefinition) SetYaxis(v HeatMapWidgetYAxis) {
	o.Yaxis = &v
}
