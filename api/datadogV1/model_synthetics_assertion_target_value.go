...
type SyntheticsAssertionTargetValue struct {
	SyntheticsAssertionTargetValueNumber *int64
...
// SyntheticsAssertionTargetValueNumberAsSyntheticsAssertionTargetValue is a convenience function that returns int64 wrapped in SyntheticsAssertionTargetValue.
func SyntheticsAssertionTargetValueNumberAsSyntheticsAssertionTargetValue(v *int64) SyntheticsAssertionTargetValue {
