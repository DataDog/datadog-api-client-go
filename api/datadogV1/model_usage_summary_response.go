...
type UsageSummaryResponse struct {
	...
	DataObservabilityQualityMonitoringAvgSum *int64 `json:"data_observability_quality_monitoring_avg_sum,omitempty"`
...
// GetDataObservabilityQualityMonitoringAvgSum returns the DataObservabilityQualityMonitoringAvgSum field value if set, zero value otherwise.
func (o *UsageSummaryResponse) GetDataObservabilityQualityMonitoringAvgSum() int64 {
	if o == nil || o.DataObservabilityQualityMonitoringAvgSum == nil {
		var ret int64
		return ret
	}
	return *o.DataObservabilityQualityMonitoringAvgSum
}

// GetDataObservabilityQualityMonitoringAvgSumOk returns a tuple with the DataObservabilityQualityMonitoringAvgSum field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UsageSummaryResponse) GetDataObservabilityQualityMonitoringAvgSumOk() (*int64, bool) {
	if o == nil || o.DataObservabilityQualityMonitoringAvgSum == nil {
		return nil, false
	}
	return o.DataObservabilityQualityMonitoringAvgSum, true
}

// HasDataObservabilityQualityMonitoringAvgSum returns a boolean if a field has been set.
func (o *UsageSummaryResponse) HasDataObservabilityQualityMonitoringAvgSum() bool {
	return o != nil && o.DataObservabilityQualityMonitoringAvgSum != nil
}

// SetDataObservabilityQualityMonitoringAvgSum gets a reference to the given int64 and assigns it to the DataObservabilityQualityMonitoringAvgSum field.
func (o *UsageSummaryResponse) SetDataObservabilityQualityMonitoringAvgSum(v int64) {
	o.DataObservabilityQualityMonitoringAvgSum = &v
}
...
func (o UsageSummaryResponse) MarshalJSON() ([]byte, error) {
	...
	if o.DataObservabilityQualityMonitoringAvgSum != nil {
		toSerialize["data_observability_quality_monitoring_avg_sum"] = o.DataObservabilityQualityMonitoringAvgSum
	}
...
func (o *UsageSummaryResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	o.DataObservabilityQualityMonitoringAvgSum = all.DataObservabilityQualityMonitoringAvgSum
