...
type UsageSummaryResponse struct {
	...
	DoJobsMonitoringServerlessJobHoursAggSum *int64 `json:"do_jobs_monitoring_serverless_job_hours_agg_sum,omitempty"`
...
// GetDoJobsMonitoringServerlessJobHoursAggSum returns the DoJobsMonitoringServerlessJobHoursAggSum field value if set, zero value otherwise.
func (o *UsageSummaryResponse) GetDoJobsMonitoringServerlessJobHoursAggSum() int64 {
	if o == nil || o.DoJobsMonitoringServerlessJobHoursAggSum == nil {
		var ret int64
		return ret
	}
	return *o.DoJobsMonitoringServerlessJobHoursAggSum
}

// GetDoJobsMonitoringServerlessJobHoursAggSumOk returns a tuple with the DoJobsMonitoringServerlessJobHoursAggSum field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UsageSummaryResponse) GetDoJobsMonitoringServerlessJobHoursAggSumOk() (*int64, bool) {
	if o == nil || o.DoJobsMonitoringServerlessJobHoursAggSum == nil {
		return nil, false
	}
	return o.DoJobsMonitoringServerlessJobHoursAggSum, true
}

// HasDoJobsMonitoringServerlessJobHoursAggSum returns a boolean if a field has been set.
func (o *UsageSummaryResponse) HasDoJobsMonitoringServerlessJobHoursAggSum() bool {
	return o != nil && o.DoJobsMonitoringServerlessJobHoursAggSum != nil
}

// SetDoJobsMonitoringServerlessJobHoursAggSum gets a reference to the given int64 and assigns it to the DoJobsMonitoringServerlessJobHoursAggSum field.
func (o *UsageSummaryResponse) SetDoJobsMonitoringServerlessJobHoursAggSum(v int64) {
	o.DoJobsMonitoringServerlessJobHoursAggSum = &v
}
...
func (o UsageSummaryResponse) MarshalJSON() ([]byte, error) {
	...
	if o.DoJobsMonitoringServerlessJobHoursAggSum != nil {
		toSerialize["do_jobs_monitoring_serverless_job_hours_agg_sum"] = o.DoJobsMonitoringServerlessJobHoursAggSum
	}
	if o.EndDate != nil {
...
func (o *UsageSummaryResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	o.DoJobsMonitoringServerlessJobHoursAggSum = all.DoJobsMonitoringServerlessJobHoursAggSum
