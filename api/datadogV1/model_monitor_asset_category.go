...
const (
	MONITORASSETCATEGORY_DASHBOARD MonitorAssetCategory = "dashboard"
	MONITORASSETCATEGORY_WORKFLOW  MonitorAssetCategory = "workflow"
	MONITORASSETCATEGORY_RUNBOOK   MonitorAssetCategory = "runbook"
)

var allowedMonitorAssetCategoryEnumValues = []MonitorAssetCategory{
	MONITORASSETCATEGORY_DASHBOARD,
	MONITORASSETCATEGORY_WORKFLOW,
