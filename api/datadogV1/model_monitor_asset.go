...
// MonitorAsset Represents key links tied to a monitor to help users take action on alerts (runbooks, dashboards, Workflows).
...
func (o *MonitorAsset) GetOptions() interface{} {
...
// and a boolean to check if the value has been set.
func (o *MonitorAsset) GetOptionsOk() (*interface{}, bool) {
	if o == nil || o.Options == nil {
		return nil, false
	}
...
func (o *MonitorAsset) GetTemplateVariables() interface{} {
...
// and a boolean to check if the value has been set.
func (o *MonitorAsset) GetTemplateVariablesOk() (*interface{}, bool) {
	if o == nil || o.TemplateVariables == nil {
		return nil, false
	}
...
func (o *MonitorAsset) HasTemplateVariables() bool {
	return o != nil && o.TemplateVariables != nil
}

// SetTemplateVariables gets a reference to the given interface{} and assigns it to the TemplateVariables field.
func (o *MonitorAsset) SetTemplateVariables(v interface{}) {
...
func (o *MonitorAsset) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = datadog.Unmarshal(bytes, &additionalProperties); err == nil {
		datadog.DeleteKeys(additionalProperties, &[]string{"category", "name", "options", "resource_key", "resource_type", "template_variables", "url"})
	} else {
		return err
	}
