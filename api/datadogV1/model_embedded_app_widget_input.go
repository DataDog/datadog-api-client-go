...
func NewEmbeddedAppWidgetInput(name string, value interface{}) *EmbeddedAppWidgetInput {
...
func (o *EmbeddedAppWidgetInput) GetValue() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *EmbeddedAppWidgetInput) GetValueOk() (*interface{}, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Value, true
...
func (o *EmbeddedAppWidgetInput) SetValue(v interface{}) {
	o.Value = v
}
