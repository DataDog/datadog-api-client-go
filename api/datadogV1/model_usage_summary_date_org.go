...
type UsageSummaryDateOrg struct {
	...
	DataObservabilityQualityMonitoringAvg *int64 `json:"data_observability_quality_monitoring_avg,omitempty"`
...
// GetDataObservabilityQualityMonitoringAvg returns the DataObservabilityQualityMonitoringAvg field value if set, zero value otherwise.
func (o *UsageSummaryDateOrg) GetDataObservabilityQualityMonitoringAvg() int64 {
	if o == nil || o.DataObservabilityQualityMonitoringAvg == nil {
		var ret int64
		return ret
	}
	return *o.DataObservabilityQualityMonitoringAvg
}

// GetDataObservabilityQualityMonitoringAvgOk returns a tuple with the DataObservabilityQualityMonitoringAvg field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UsageSummaryDateOrg) GetDataObservabilityQualityMonitoringAvgOk() (*int64, bool) {
	if o == nil || o.DataObservabilityQualityMonitoringAvg == nil {
		return nil, false
	}
	return o.DataObservabilityQualityMonitoringAvg, true
}

// HasDataObservabilityQualityMonitoringAvg returns a boolean if a field has been set.
func (o *UsageSummaryDateOrg) HasDataObservabilityQualityMonitoringAvg() bool {
	return o != nil && o.DataObservabilityQualityMonitoringAvg != nil
}

// SetDataObservabilityQualityMonitoringAvg gets a reference to the given int64 and assigns it to the DataObservabilityQualityMonitoringAvg field.
func (o *UsageSummaryDateOrg) SetDataObservabilityQualityMonitoringAvg(v int64) {
	o.DataObservabilityQualityMonitoringAvg = &v
}
...
func (o UsageSummaryDateOrg) MarshalJSON() ([]byte, error) {
	...
	if o.DataObservabilityQualityMonitoringAvg != nil {
		toSerialize["data_observability_quality_monitoring_avg"] = o.DataObservabilityQualityMonitoringAvg
	}
...
func (o *UsageSummaryDateOrg) UnmarshalJSON(bytes []byte) (err error) {
	...
	o.DataObservabilityQualityMonitoringAvg = all.DataObservabilityQualityMonitoringAvg
