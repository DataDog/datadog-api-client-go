...
type UsageSummaryDateOrg struct {
	...
	DoJobsMonitoringServerlessJobHoursSum *int64 `json:"do_jobs_monitoring_serverless_job_hours_sum,omitempty"`
...
// GetDoJobsMonitoringServerlessJobHoursSum returns the DoJobsMonitoringServerlessJobHoursSum field value if set, zero value otherwise.
func (o *UsageSummaryDateOrg) GetDoJobsMonitoringServerlessJobHoursSum() int64 {
	if o == nil || o.DoJobsMonitoringServerlessJobHoursSum == nil {
		var ret int64
		return ret
	}
	return *o.DoJobsMonitoringServerlessJobHoursSum
}

// GetDoJobsMonitoringServerlessJobHoursSumOk returns a tuple with the DoJobsMonitoringServerlessJobHoursSum field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UsageSummaryDateOrg) GetDoJobsMonitoringServerlessJobHoursSumOk() (*int64, bool) {
	if o == nil || o.DoJobsMonitoringServerlessJobHoursSum == nil {
		return nil, false
	}
	return o.DoJobsMonitoringServerlessJobHoursSum, true
}

// HasDoJobsMonitoringServerlessJobHoursSum returns a boolean if a field has been set.
func (o *UsageSummaryDateOrg) HasDoJobsMonitoringServerlessJobHoursSum() bool {
	return o != nil && o.DoJobsMonitoringServerlessJobHoursSum != nil
}

// SetDoJobsMonitoringServerlessJobHoursSum gets a reference to the given int64 and assigns it to the DoJobsMonitoringServerlessJobHoursSum field.
func (o *UsageSummaryDateOrg) SetDoJobsMonitoringServerlessJobHoursSum(v int64) {
	o.DoJobsMonitoringServerlessJobHoursSum = &v
}
...
func (o UsageSummaryDateOrg) MarshalJSON() ([]byte, error) {
	...
	if o.DoJobsMonitoringServerlessJobHoursSum != nil {
		toSerialize["do_jobs_monitoring_serverless_job_hours_sum"] = o.DoJobsMonitoringServerlessJobHoursSum
	}
...
func (o *UsageSummaryDateOrg) UnmarshalJSON(bytes []byte) (err error) {
	...
	o.DoJobsMonitoringServerlessJobHoursSum = all.DoJobsMonitoringServerlessJobHoursSum
