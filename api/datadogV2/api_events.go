...
func (a *EventsApi) CreateEvent(ctx _context.Context, body ChangeEventCreateRequestPayload) (ChangeEventCreateResponsePayload, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue ChangeEventCreateResponsePayload
	)

	operationId := "v2.CreateEvent"
