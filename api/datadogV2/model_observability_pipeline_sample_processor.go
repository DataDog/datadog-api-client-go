...
func NewObservabilityPipelineSampleProcessor(id string, include string, inputs []string, rate int64, typeVar ObservabilityPipelineSampleProcessorType) *ObservabilityPipelineSampleProcessor {
...
func (o *ObservabilityPipelineSampleProcessor) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = datadog.Unmarshal(bytes, &additionalProperties); err == nil {
		datadog.DeleteKeys(additionalProperties, &[]string{"id", "include", "inputs", "rate", "type"})
	} else {
		return err
	}
