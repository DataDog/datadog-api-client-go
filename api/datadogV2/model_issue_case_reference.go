...
func NewIssueCaseReference(id string, typeVar CaseResourceType) *IssueCaseReference {
...
func (o *IssueCaseReference) GetType() CaseResourceType {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *IssueCaseReference) GetTypeOk() (*CaseResourceType, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *IssueCaseReference) SetType(v CaseResourceType) {
	o.Type = v
}
