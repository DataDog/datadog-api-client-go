...
func (a *ObservabilityPipelinesApi) CreatePipeline(ctx _context.Context, body Pipeline) (Pipeline, *_nethttp.Response, error) {
	var (
...
// DeletePipeline Delete a specific pipeline.
...
func (a *ObservabilityPipelinesApi) GetPipeline(ctx _context.Context, pipelineId string) (Pipeline, *_nethttp.Response, error) {
	var (
...
func (a *ObservabilityPipelinesApi) ListPipelines(ctx _context.Context) ([]Pipeline, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue []Pipeline
...
// UpdatePipeline Update a specific pipeline.
// Updates a specific observability pipeline.
func (a *ObservabilityPipelinesApi) UpdatePipeline(ctx _context.Context, pipelineId string, body Pipeline) (Pipeline, *_nethttp.Response, error) {
	var (
