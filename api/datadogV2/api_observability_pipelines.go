...
func (a *ObservabilityPipelinesApi) ValidatePipeline(ctx _context.Context, body ObservabilityPipelineCreateRequest) (ValidationErrorResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue ValidationErrorResponse
	)
