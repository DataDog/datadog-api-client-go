...
func NewDegradationDataRelationshipsStatusPageData(id string, typeVar StatusPageDataType) *DegradationDataRelationshipsStatusPageData {
...
func (o *DegradationDataRelationshipsStatusPageData) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *DegradationDataRelationshipsStatusPageData) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *DegradationDataRelationshipsStatusPageData) SetId(v string) {
	o.Id = v
}
