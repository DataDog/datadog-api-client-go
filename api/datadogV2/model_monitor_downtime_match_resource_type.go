...
// NullableMonitorDowntimeMatchResourceType handles when a null is used for MonitorDowntimeMatchResourceType.
type NullableMonitorDowntimeMatchResourceType struct {
	value *MonitorDowntimeMatchResourceType
	isSet bool
}

// Get returns the associated value.
func (v NullableMonitorDowntimeMatchResourceType) Get() *MonitorDowntimeMatchResourceType {
	return v.value
}

// Set changes the value and indicates it's been called.
func (v *NullableMonitorDowntimeMatchResourceType) Set(val *MonitorDowntimeMatchResourceType) {
	v.value = val
	v.isSet = true
}

// IsSet returns whether Set has been called.
func (v NullableMonitorDowntimeMatchResourceType) IsSet() bool {
	return v.isSet
}

// Unset sets the value to nil and resets the set flag.
func (v *NullableMonitorDowntimeMatchResourceType) Unset() {
	v.value = nil
	v.isSet = false
}

// NewNullableMonitorDowntimeMatchResourceType initializes the struct as if Set has been called.
func NewNullableMonitorDowntimeMatchResourceType(val *MonitorDowntimeMatchResourceType) *NullableMonitorDowntimeMatchResourceType {
	return &NullableMonitorDowntimeMatchResourceType{value: val, isSet: true}
}

// MarshalJSON serializes the associated value.
func (v NullableMonitorDowntimeMatchResourceType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

// UnmarshalJSON deserializes the payload and sets the flag as if Set has been called.
func (v *NullableMonitorDowntimeMatchResourceType) UnmarshalJSON(src []byte) error {
	v.isSet = true
