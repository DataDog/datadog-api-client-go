...
type ObservabilityPipelineEnrichmentTableReferenceTable struct {
	...
	Columns datadog.NullableList[string] `json:"columns,omitempty"`
...
func NewObservabilityPipelineEnrichmentTableReferenceTable(keyField string, tableId string) *ObservabilityPipelineEnrichmentTableReferenceTable {
	...
	var appKeyKey string = "PROCESSOR_ENRICHMENT_TABLES_APP_KEY"
...
// SetColumns gets a reference to the given datadog.NullableList[string] and assigns it to the Columns field.
func (o *ObservabilityPipelineEnrichmentTableReferenceTable) SetColumns(v []string) {
	o.Columns.Set(&v)
}

// SetColumnsNil sets the value for Columns to be an explicit nil.
func (o *ObservabilityPipelineEnrichmentTableReferenceTable) SetColumnsNil() {
	o.Columns.Set(nil)
}

// UnsetColumns ensures that no value is present for Columns, not even an explicit nil.
func (o *ObservabilityPipelineEnrichmentTableReferenceTable) UnsetColumns() {
	o.Columns.Unset()
}
