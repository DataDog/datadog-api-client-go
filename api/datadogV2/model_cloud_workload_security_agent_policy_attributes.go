...
// CloudWorkloadSecurityAgentPolicyAttributes A Cloud Workload Security Agent rule returned by the API
...
func (o *CloudWorkloadSecurityAgentPolicyAttributes) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = datadog.Unmarshal(bytes, &additionalProperties); err == nil {
		datadog.DeleteKeys(additionalProperties, &[]string{"blockingRulesCount", "datadogManaged", "description", "disabledRulesCount", "enabled", "hostTags", "monitoringRulesCount", "name", "policyVersion", "priority", "ruleCount", "updateDate", "updatedAt", "updater"})
	} else {
		return err
	}
