...
func (o *CloudWorkloadSecurityAgentPolicyAttributes) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = datadog.Unmarshal(bytes, &additionalProperties); err == nil {
		datadog.DeleteKeys(additionalProperties, &[]string{"blockingRulesCount", "description", "disabledRulesCount", "enabled", "hostTags", "monitoringRulesCount", "name", "priority", "ruleCount", "updatedAt", "updater"})
	} else {
		return err
	}
