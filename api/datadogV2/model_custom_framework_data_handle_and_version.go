...
func (o *CustomFrameworkDataHandleAndVersion) GetId() string {
	if o == nil || o.Id == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CustomFrameworkDataHandleAndVersion) GetIdOk() (*string, bool) {
	if o == nil || o.Id == nil {
		return nil, false
	}
	return o.Id, true
...
func (o *CustomFrameworkDataHandleAndVersion) HasId() bool {
	return o != nil && o.Id != nil
}

// SetId gets a reference to the given string and assigns it to the Id field.
func (o *CustomFrameworkDataHandleAndVersion) SetId(v string) {
	o.Id = &v
}
...
func (o *CustomFrameworkDataHandleAndVersion) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = datadog.Unmarshal(bytes, &additionalProperties); err == nil {
		datadog.DeleteKeys(additionalProperties, &[]string{"handle", "id", "version"})
	} else {
		return err
	}
	o.Handle = all.Handle
