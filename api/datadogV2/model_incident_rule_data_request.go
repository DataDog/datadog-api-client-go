...
// IncidentRuleDataRequest Incident rule data in a create request.
type IncidentRuleDataRequest struct {
	// Attributes for creating an incident rule.
	Attributes IncidentRuleDataAttributesRequest `json:"attributes"`
...
func NewIncidentRuleDataRequest(attributes IncidentRuleDataAttributesRequest, typeVar IncidentRuleType) *IncidentRuleDataRequest {
...
func (o *IncidentRuleDataRequest) GetAttributes() IncidentRuleDataAttributesRequest {
	if o == nil {
		var ret IncidentRuleDataAttributesRequest
		return ret
	}
	return o.Attributes
}
...
func (o *IncidentRuleDataRequest) GetAttributesOk() (*IncidentRuleDataAttributesRequest, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *IncidentRuleDataRequest) SetAttributes(v IncidentRuleDataAttributesRequest) {
	o.Attributes = v
}
