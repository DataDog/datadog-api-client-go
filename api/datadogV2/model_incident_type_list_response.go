...
type IncidentTypeListResponse struct {
	...
	Data []IncidentTypeResponse `json:"data"`
...
func NewIncidentTypeListResponse(data []IncidentTypeResponse) *IncidentTypeListResponse {
...
func (o *IncidentTypeListResponse) GetData() []IncidentTypeResponse {
	if o == nil {
		var ret []IncidentTypeResponse
		return ret
	}
	return o.Data
}
...
func (o *IncidentTypeListResponse) GetDataOk() (*[]IncidentTypeResponse, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *IncidentTypeListResponse) SetData(v []IncidentTypeResponse) {
	o.Data = v
}
