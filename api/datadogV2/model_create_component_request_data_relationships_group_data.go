...
func NewCreateComponentRequestDataRelationshipsGroupData(id string, typeVar StatusPagesComponentGroupType) *CreateComponentRequestDataRelationshipsGroupData {
...
func (o *CreateComponentRequestDataRelationshipsGroupData) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *CreateComponentRequestDataRelationshipsGroupData) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *CreateComponentRequestDataRelationshipsGroupData) SetId(v string) {
	o.Id = v
}
