...
const (
	RUMMETRICUNIQUENESSWHEN_MATCH RumMetricUniquenessWhen = "match"
	RUMMETRICUNIQUENESSWHEN_END   RumMetricUniquenessWhen = "end"
)

var allowedRumMetricUniquenessWhenEnumValues = []RumMetricUniquenessWhen{
	RUMMETRICUNIQUENESSWHEN_MATCH,
	RUMMETRICUNIQUENESSWHEN_END,
}
