...
func NewObservabilityPipelineDedupeProcessor(fields []string, id string, include string, mode ObservabilityPipelineDedupeProcessorMode, typeVar ObservabilityPipelineDedupeProcessorType) *ObservabilityPipelineDedupeProcessor {
...
func (o *ObservabilityPipelineDedupeProcessor) HasEnabled() bool {
...
func (o *ObservabilityPipelineDedupeProcessor) HasInputs() bool {
...
func (o *ObservabilityPipelineDedupeProcessor) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = datadog.Unmarshal(bytes, &additionalProperties); err == nil {
		datadog.DeleteKeys(additionalProperties, &[]string{"enabled", "fields", "id", "include", "inputs", "mode", "type"})
	} else {
		return err
	}
