...
func NewDegradationDataAttributesUpdatesItemsComponentsAffectedItems(id string, status StatusPagesComponentDataAttributesStatus) *DegradationDataAttributesUpdatesItemsComponentsAffectedItems {
...
func (o *DegradationDataAttributesUpdatesItemsComponentsAffectedItems) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *DegradationDataAttributesUpdatesItemsComponentsAffectedItems) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *DegradationDataAttributesUpdatesItemsComponentsAffectedItems) SetId(v string) {
	o.Id = v
}
