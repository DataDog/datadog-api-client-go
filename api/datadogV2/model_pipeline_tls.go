...
// PipelineTls Configuration for enabling TLS encryption.
type PipelineTls struct {
...
// NewPipelineTls instantiates a new PipelineTls object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewPipelineTls(crtFile string) *PipelineTls {
	this := PipelineTls{}
	this.CrtFile = crtFile
	return &this
}

// NewPipelineTlsWithDefaults instantiates a new PipelineTls object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewPipelineTlsWithDefaults() *PipelineTls {
	this := PipelineTls{}
	return &this
}

// GetCaFile returns the CaFile field value if set, zero value otherwise.
func (o *PipelineTls) GetCaFile() string {
...
func (o *PipelineTls) GetCaFileOk() (*string, bool) {
	if o == nil || o.CaFile == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *PipelineTls) GetCrtFileOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PipelineTls) SetCrtFile(v string) {
	o.CrtFile = v
}

// GetKeyFile returns the KeyFile field value if set, zero value otherwise.
func (o *PipelineTls) GetKeyFile() string {
...
// and a boolean to check if the value has been set.
func (o *PipelineTls) GetKeyFileOk() (*string, bool) {
	if o == nil || o.KeyFile == nil {
		return nil, false
	}
...
func (o *PipelineTls) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		CaFile  *string `json:"ca_file,omitempty"`
		CrtFile *string `json:"crt_file"`
		KeyFile *string `json:"key_file,omitempty"`
