...
// IncidentGoogleMeetConfigurationRelationships Relationships for a Google Meet configuration.
type IncidentGoogleMeetConfigurationRelationships struct {
...
// NewIncidentGoogleMeetConfigurationRelationships instantiates a new IncidentGoogleMeetConfigurationRelationships object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewIncidentGoogleMeetConfigurationRelationships() *IncidentGoogleMeetConfigurationRelationships {
	this := IncidentGoogleMeetConfigurationRelationships{}
	return &this
}

// NewIncidentGoogleMeetConfigurationRelationshipsWithDefaults instantiates a new IncidentGoogleMeetConfigurationRelationships object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewIncidentGoogleMeetConfigurationRelationshipsWithDefaults() *IncidentGoogleMeetConfigurationRelationships {
	this := IncidentGoogleMeetConfigurationRelationships{}
	return &this
}

// GetCreatedByUser returns the CreatedByUser field value if set, zero value otherwise.
func (o *IncidentGoogleMeetConfigurationRelationships) GetCreatedByUser() RelationshipToUser {
...
func (o *IncidentGoogleMeetConfigurationRelationships) GetCreatedByUserOk() (*RelationshipToUser, bool) {
	if o == nil || o.CreatedByUser == nil {
		return nil, false
	}
...
func (o *IncidentGoogleMeetConfigurationRelationships) HasCreatedByUser() bool {
...
func (o *IncidentGoogleMeetConfigurationRelationships) SetCreatedByUser(v RelationshipToUser) {
	o.CreatedByUser = &v
}

// GetIncidentType returns the IncidentType field value if set, zero value otherwise.
func (o *IncidentGoogleMeetConfigurationRelationships) GetIncidentType() RelationshipToIncidentType {
...
// and a boolean to check if the value has been set.
func (o *IncidentGoogleMeetConfigurationRelationships) GetIncidentTypeOk() (*RelationshipToIncidentType, bool) {
	if o == nil || o.IncidentType == nil {
		return nil, false
	}
...
func (o *IncidentGoogleMeetConfigurationRelationships) HasIncidentType() bool {
...
func (o *IncidentGoogleMeetConfigurationRelationships) SetIncidentType(v RelationshipToIncidentType) {
	o.IncidentType = &v
}

// GetLastModifiedByUser returns the LastModifiedByUser field value if set, zero value otherwise.
func (o *IncidentGoogleMeetConfigurationRelationships) GetLastModifiedByUser() RelationshipToUser {
...
// and a boolean to check if the value has been set.
func (o *IncidentGoogleMeetConfigurationRelationships) GetLastModifiedByUserOk() (*RelationshipToUser, bool) {
	if o == nil || o.LastModifiedByUser == nil {
		return nil, false
	}
...
func (o *IncidentGoogleMeetConfigurationRelationships) HasLastModifiedByUser() bool {
...
func (o *IncidentGoogleMeetConfigurationRelationships) SetLastModifiedByUser(v RelationshipToUser) {
	o.LastModifiedByUser = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o IncidentGoogleMeetConfigurationRelationships) MarshalJSON() ([]byte, error) {
...
func (o *IncidentGoogleMeetConfigurationRelationships) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		CreatedByUser      *RelationshipToUser         `json:"created_by_user,omitempty"`
		IncidentType       *RelationshipToIncidentType `json:"incident_type,omitempty"`
		LastModifiedByUser *RelationshipToUser         `json:"last_modified_by_user,omitempty"`
