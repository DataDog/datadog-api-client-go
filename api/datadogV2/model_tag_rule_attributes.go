...
type TagRuleAttributes struct {
	...
	PolicyType TagRuleType `json:"policy_type"`
...
func NewTagRuleAttributes(createdAt time.Time, createdBy string, enabled bool, modifiedAt time.Time, modifiedBy string, negated bool, policyName string, policyType TagRuleType, required bool, scope string, source TagRuleSource, tagKey string, tagValuePatterns []string, version int64) *TagRuleAttributes {
...
func (o *TagRuleAttributes) GetPolicyName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TagRuleAttributes) GetPolicyNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TagRuleAttributes) SetPolicyName(v string) {
	o.PolicyName = v
}

// GetPolicyType returns the PolicyType field value.
func (o *TagRuleAttributes) GetPolicyType() TagRuleType {
	if o == nil {
		var ret TagRuleType
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TagRuleAttributes) GetPolicyTypeOk() (*TagRuleType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TagRuleAttributes) SetPolicyType(v TagRuleType) {
	o.PolicyType = v
}
