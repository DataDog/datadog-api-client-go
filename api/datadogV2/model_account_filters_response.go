...
// AccountFiltersResponse Response containing the account filters for a cloud account.
type AccountFiltersResponse struct {
	// The account filters for a cloud account.
	Data *AccountFilters `json:"data,omitempty"`
...
func (o *AccountFiltersResponse) GetData() AccountFilters {
	if o == nil || o.Data == nil {
...
func (o *AccountFiltersResponse) GetDataOk() (*AccountFilters, bool) {
	if o == nil || o.Data == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *AccountFiltersResponse) HasData() bool {
	return o != nil && o.Data != nil
}

// SetData gets a reference to the given AccountFilters and assigns it to the Data field.
func (o *AccountFiltersResponse) SetData(v AccountFilters) {
	o.Data = &v
}
