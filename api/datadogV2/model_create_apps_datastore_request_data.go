...
// CreateAppsDatastoreRequestData The definition of `CreateAppsDatastoreRequestData` object.
type CreateAppsDatastoreRequestData struct {
	...
	Type CreateAppsDatastoreRequestDataType `json:"type"`
...
func NewCreateAppsDatastoreRequestData(typeVar CreateAppsDatastoreRequestDataType) *CreateAppsDatastoreRequestData {
...
func NewCreateAppsDatastoreRequestDataWithDefaults() *CreateAppsDatastoreRequestData {
	this := CreateAppsDatastoreRequestData{}
	var typeVar CreateAppsDatastoreRequestDataType = CREATEAPPSDATASTOREREQUESTDATATYPE_DATASTORES
	this.Type = typeVar
	return &this
}
...
func (o *CreateAppsDatastoreRequestData) GetType() CreateAppsDatastoreRequestDataType {
	if o == nil {
		var ret CreateAppsDatastoreRequestDataType
		return ret
	}
	return o.Type
}
...
// and a boolean to check if the value has been set.
func (o *CreateAppsDatastoreRequestData) GetTypeOk() (*CreateAppsDatastoreRequestDataType, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *CreateAppsDatastoreRequestData) SetType(v CreateAppsDatastoreRequestDataType) {
	o.Type = v
}
