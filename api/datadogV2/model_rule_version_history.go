...
// RuleVersionHistory A rule version with a list of updates.
...
func (o *RuleVersionHistory) GetChanges() []RuleVersionUpdate {
...
func (o *RuleVersionHistory) GetChangesOk() (*[]RuleVersionUpdate, bool) {
	if o == nil || o.Changes == nil {
		return nil, false
	}
...
func (o *RuleVersionHistory) HasChanges() bool {
	return o != nil && o.Changes != nil
}

// SetChanges gets a reference to the given []RuleVersionUpdate and assigns it to the Changes field.
func (o *RuleVersionHistory) SetChanges(v []RuleVersionUpdate) {
	o.Changes = v
}

// GetRule returns the Rule field value if set, zero value otherwise.
func (o *RuleVersionHistory) GetRule() SecurityMonitoringRuleResponse {
	if o == nil || o.Rule == nil {
...
// and a boolean to check if the value has been set.
func (o *RuleVersionHistory) GetRuleOk() (*SecurityMonitoringRuleResponse, bool) {
	if o == nil || o.Rule == nil {
		return nil, false
	}
	return o.Rule, true
...
func (o *RuleVersionHistory) HasRule() bool {
...
func (o *RuleVersionHistory) SetRule(v SecurityMonitoringRuleResponse) {
	o.Rule = &v
}
