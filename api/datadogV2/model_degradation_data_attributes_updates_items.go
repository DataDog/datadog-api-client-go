...
func (o *DegradationDataAttributesUpdatesItems) GetId() string {
	if o == nil || o.Id == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DegradationDataAttributesUpdatesItems) GetIdOk() (*string, bool) {
	if o == nil || o.Id == nil {
		return nil, false
	}
	return o.Id, true
...
func (o *DegradationDataAttributesUpdatesItems) SetId(v string) {
	o.Id = &v
}
