...
// ApplicationSecurityExclusionFilterRulesTarget Target WAF rules based either on an identifier or tags.
type ApplicationSecurityExclusionFilterRulesTarget struct {
	...
	Tags *ApplicationSecurityExclusionFilterRulesTargetTags `json:"tags,omitempty"`
...
func (o *ApplicationSecurityExclusionFilterRulesTarget) GetTags() ApplicationSecurityExclusionFilterRulesTargetTags {
	if o == nil || o.Tags == nil {
		var ret ApplicationSecurityExclusionFilterRulesTargetTags
		return ret
	}
	return *o.Tags
}
...
// and a boolean to check if the value has been set.
func (o *ApplicationSecurityExclusionFilterRulesTarget) GetTagsOk() (*ApplicationSecurityExclusionFilterRulesTargetTags, bool) {
	if o == nil || o.Tags == nil {
		return nil, false
	}
	return o.Tags, true
...
func (o *ApplicationSecurityExclusionFilterRulesTarget) HasTags() bool {
	return o != nil && o.Tags != nil
}

// SetTags gets a reference to the given ApplicationSecurityExclusionFilterRulesTargetTags and assigns it to the Tags field.
func (o *ApplicationSecurityExclusionFilterRulesTarget) SetTags(v ApplicationSecurityExclusionFilterRulesTargetTags) {
	o.Tags = &v
}
