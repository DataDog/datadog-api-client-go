...
type ObservabilityPipelineGoogleCloudStorageDestination struct {
	...
	KeyPrefix datadog.NullableString `json:"key_prefix,omitempty"`
...
func (o *ObservabilityPipelineGoogleCloudStorageDestination) HasKeyPrefix() bool {
	return o != nil && o.KeyPrefix.IsSet()
}

// SetKeyPrefix gets a reference to the given datadog.NullableString and assigns it to the KeyPrefix field.
...
func (o *ObservabilityPipelineGoogleCloudStorageDestination) SetKeyPrefixNil() {
	o.KeyPrefix.Set(nil)
}

// UnsetKeyPrefix ensures that no value is present for KeyPrefix, not even an explicit nil.
func (o *ObservabilityPipelineGoogleCloudStorageDestination) UnsetKeyPrefix() {
	o.KeyPrefix.Unset()
}
