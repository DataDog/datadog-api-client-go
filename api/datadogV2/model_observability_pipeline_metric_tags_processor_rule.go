...
func NewObservabilityPipelineMetricTagsProcessorRule(action ObservabilityPipelineMetricTagsProcessorRuleAction, keys []string, mode ObservabilityPipelineMetricTagsProcessorRuleMode) *ObservabilityPipelineMetricTagsProcessorRule {
...
func (o *ObservabilityPipelineMetricTagsProcessorRule) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = datadog.Unmarshal(bytes, &additionalProperties); err == nil {
		datadog.DeleteKeys(additionalProperties, &[]string{"action", "keys", "mode"})
	} else {
		return err
	}
