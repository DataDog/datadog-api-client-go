...
func NewSTIXBundleRequest(id string, objects []STIXObject, typeVar STIXBundleType) *STIXBundleRequest {
...
func (o *STIXBundleRequest) GetObjects() []STIXObject {
	if o == nil {
		var ret []STIXObject
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *STIXBundleRequest) GetObjectsOk() (*[]STIXObject, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *STIXBundleRequest) SetObjects(v []STIXObject) {
	o.Objects = v
}
