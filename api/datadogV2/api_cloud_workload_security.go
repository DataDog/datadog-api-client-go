...
func (a *CloudWorkloadSecurityApi) createCloudWorkloadSecurityAgentRuleExecute(ctx _context.Context, body CloudWorkloadSecurityAgentRuleCreateRequest) (CloudWorkloadSecurityAgentRuleResponse, *_nethttp.Response, error) {
	var (
...
func (a *CloudWorkloadSecurityApi) deleteCloudWorkloadSecurityAgentRuleExecute(ctx _context.Context, agentRuleId string) (*_nethttp.Response, error) {
	var (
...
func (a *CloudWorkloadSecurityApi) downloadCloudWorkloadPolicyFileExecute(ctx _context.Context) (*os.File, *_nethttp.Response, error) {
	var (
...
func (a *CloudWorkloadSecurityApi) getCloudWorkloadSecurityAgentRuleExecute(ctx _context.Context, agentRuleId string) (CloudWorkloadSecurityAgentRuleResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue CloudWorkloadSecurityAgentRuleResponse
...
func (a *CloudWorkloadSecurityApi) listCloudWorkloadSecurityAgentRulesExecute(ctx _context.Context) (CloudWorkloadSecurityAgentRulesListResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
...
func (a *CloudWorkloadSecurityApi) updateCloudWorkloadSecurityAgentRuleExecute(ctx _context.Context, agentRuleId string, body CloudWorkloadSecurityAgentRuleUpdateRequest) (CloudWorkloadSecurityAgentRuleResponse, *_nethttp.Response, error) {
	var (
