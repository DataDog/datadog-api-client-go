...
// DDSQLApi service type
type DDSQLApi datadog.Service

// ExecuteDdsqlTabularQuery Execute a tabular DDSQL query.
...
func (a *DDSQLApi) ExecuteDdsqlTabularQuery(ctx _context.Context, body DdsqlTabularQueryRequest) (DdsqlTabularQueryResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/ddsql/query/tabular"
...
// FetchDdsqlTabularQuery Fetch the result of a DDSQL query.
...
func (a *DDSQLApi) FetchDdsqlTabularQuery(ctx _context.Context, body DdsqlTabularQueryFetchRequest) (DdsqlTabularQueryResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/ddsql/query/tabular/fetch"
...
// NewDDSQLApi Returns NewDDSQLApi.
func NewDDSQLApi(client *datadog.APIClient) *DDSQLApi {
	return &DDSQLApi{
		Client: client,
	}
}
