...
// TagPolicyCreateRequest Request for creating a tag policy.
type TagPolicyCreateRequest struct {
	// Data envelope for tag policy create request.
	Data TagPolicyDataRequest `json:"data"`
...
func NewTagPolicyCreateRequest(data TagPolicyDataRequest) *TagPolicyCreateRequest {
...
func (o *TagPolicyCreateRequest) GetData() TagPolicyDataRequest {
	if o == nil {
		var ret TagPolicyDataRequest
		return ret
	}
	return o.Data
}
...
func (o *TagPolicyCreateRequest) GetDataOk() (*TagPolicyDataRequest, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *TagPolicyCreateRequest) SetData(v TagPolicyDataRequest) {
	o.Data = v
}
