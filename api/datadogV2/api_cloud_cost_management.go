...
// CreateUnitCost Create a unit cost.
// Create an ROI metric (unit cost) using the given numerator and denominator queries.
func (a *CloudCostManagementApi) CreateUnitCost(ctx _context.Context, body UnitCostCreateRequest) (UnitCostResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue UnitCostResponse
	)

	operationId := "v2.CreateUnitCost"
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CloudCostManagementApi.CreateUnitCost")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/cost/unit_costs"
...
// DeleteUnitCost Delete a unit cost.
// Delete an ROI metric (unit cost).
func (a *CloudCostManagementApi) DeleteUnitCost(ctx _context.Context, unitCostId uuid.UUID) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)

	operationId := "v2.DeleteUnitCost"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CloudCostManagementApi.DeleteUnitCost")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/cost/unit_costs/{unit_cost_id}"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{unit_cost_id}", _neturl.PathEscape(datadog.ParameterToString(unitCostId, "")))
...
// GetCostAccountFilters Get account filters.
// Get the account filters for a cloud account (AWS CUR 1.0/2.0, OCI, and other clouds).
func (a *CloudCostManagementApi) GetCostAccountFilters(ctx _context.Context, cloudAccountId int64) (AccountFiltersResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue AccountFiltersResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CloudCostManagementApi.GetCostAccountFilters")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/cost/account_filters/{cloud_account_id}"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{cloud_account_id}", _neturl.PathEscape(datadog.ParameterToString(cloudAccountId, "")))
...
// GetCustomForecast Get a budget's custom forecast.
// Get the custom forecast for a budget.
func (a *CloudCostManagementApi) GetCustomForecast(ctx _context.Context, budgetId string) (CustomForecastResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
...
// GetUnitCost Get a unit cost.
// Retrieve an ROI metric (unit cost) by UUID.
func (a *CloudCostManagementApi) GetUnitCost(ctx _context.Context, unitCostId uuid.UUID) (UnitCostResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue UnitCostResponse
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CloudCostManagementApi.GetUnitCost")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// ListUnitCosts List unit costs.
// List the ROI metrics (unit costs) for the authenticated organization.
func (a *CloudCostManagementApi) ListUnitCosts(ctx _context.Context) (UnitCostsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue UnitCostsResponse
	)

	operationId := "v2.ListUnitCosts"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CloudCostManagementApi.ListUnitCosts")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// UpdateCostAccountFilters Update account filters.
// Update the account filters for a cloud account (AWS CUR 1.0/2.0, OCI, and other clouds).
func (a *CloudCostManagementApi) UpdateCostAccountFilters(ctx _context.Context, cloudAccountId int64, body AccountFiltersPatchRequest) (AccountFiltersResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPatch
		localVarPostBody    interface{}
		localVarReturnValue AccountFiltersResponse
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CloudCostManagementApi.UpdateCostAccountFilters")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// UpdateUnitCost Update a unit cost.
// Replace an ROI metric (unit cost) with a new set of attributes.
func (a *CloudCostManagementApi) UpdateUnitCost(ctx _context.Context, unitCostId uuid.UUID, body UnitCostUpdateRequest) (UnitCostResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CloudCostManagementApi.UpdateUnitCost")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
