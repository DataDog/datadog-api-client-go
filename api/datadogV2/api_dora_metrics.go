...
func (a *DORAMetricsApi) PatchDORADeployment(ctx _context.Context, deploymentId string, body DORADeploymentPatchRequest) (DORADeploymentFetchResponse, *_nethttp.Response, error) {
	var (
