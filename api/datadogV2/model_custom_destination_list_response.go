...
func NewCustomDestinationListResponse(data []CustomDestination) *CustomDestinationListResponse {
...
func (o *CustomDestinationListResponse) GetData() []CustomDestination {
	if o == nil {
...
func (o *CustomDestinationListResponse) GetDataOk() (*[]CustomDestination, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *CustomDestinationListResponse) SetData(v []CustomDestination) {
	o.Data = v
}
