...
// NullableDowntimeScheduleUpdateRequest handles when a null is used for DowntimeScheduleUpdateRequest.
type NullableDowntimeScheduleUpdateRequest struct {
	value *DowntimeScheduleUpdateRequest
	isSet bool
}

// Get returns the associated value.
func (v NullableDowntimeScheduleUpdateRequest) Get() *DowntimeScheduleUpdateRequest {
	return v.value
}

// Set changes the value and indicates it's been called.
func (v *NullableDowntimeScheduleUpdateRequest) Set(val *DowntimeScheduleUpdateRequest) {
	v.value = val
	v.isSet = true
}

// IsSet returns whether Set has been called.
func (v NullableDowntimeScheduleUpdateRequest) IsSet() bool {
	return v.isSet
}

// Unset sets the value to nil and resets the set flag/
func (v *NullableDowntimeScheduleUpdateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

// NewNullableDowntimeScheduleUpdateRequest initializes the struct as if Set has been called.
func NewNullableDowntimeScheduleUpdateRequest(val *DowntimeScheduleUpdateRequest) *NullableDowntimeScheduleUpdateRequest {
	return &NullableDowntimeScheduleUpdateRequest{value: val, isSet: true}
}

// MarshalJSON serializes the associated value.
func (v NullableDowntimeScheduleUpdateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

// UnmarshalJSON deserializes the payload and sets the flag as if Set has been called.
func (v *NullableDowntimeScheduleUpdateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
