...
type MonitorDowntimeMatchResponse struct {
	...
	Data []MonitorDowntimeMatchListItemResponse `json:"data,omitempty"`
...
func (o *MonitorDowntimeMatchResponse) GetData() []MonitorDowntimeMatchListItemResponse {
	if o == nil || o.Data == nil {
		var ret []MonitorDowntimeMatchListItemResponse
		return ret
	}
	return o.Data
}
...
func (o *MonitorDowntimeMatchResponse) GetDataOk() (*[]MonitorDowntimeMatchListItemResponse, bool) {
	if o == nil || o.Data == nil {
		return nil, false
	}
	return &o.Data, true
...
// SetData gets a reference to the given []MonitorDowntimeMatchListItemResponse and assigns it to the Data field.
func (o *MonitorDowntimeMatchResponse) SetData(v []MonitorDowntimeMatchListItemResponse) {
	o.Data = v
}
