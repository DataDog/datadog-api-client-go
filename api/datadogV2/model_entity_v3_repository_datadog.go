...
// EntityV3RepositoryDatadog Datadog product integrations for the repository entity.
type EntityV3RepositoryDatadog struct {
...
// NewEntityV3RepositoryDatadog instantiates a new EntityV3RepositoryDatadog object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewEntityV3RepositoryDatadog() *EntityV3RepositoryDatadog {
	this := EntityV3RepositoryDatadog{}
	return &this
}

// NewEntityV3RepositoryDatadogWithDefaults instantiates a new EntityV3RepositoryDatadog object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewEntityV3RepositoryDatadogWithDefaults() *EntityV3RepositoryDatadog {
	this := EntityV3RepositoryDatadog{}
	return &this
}

// GetCodeLocations returns the CodeLocations field value if set, zero value otherwise.
func (o *EntityV3RepositoryDatadog) GetCodeLocations() []EntityV3DatadogCodeLocationItem {
...
func (o *EntityV3RepositoryDatadog) GetCodeLocationsOk() (*[]EntityV3DatadogCodeLocationItem, bool) {
	if o == nil || o.CodeLocations == nil {
		return nil, false
	}
...
func (o *EntityV3RepositoryDatadog) HasCodeLocations() bool {
...
func (o *EntityV3RepositoryDatadog) SetCodeLocations(v []EntityV3DatadogCodeLocationItem) {
	o.CodeLocations = v
}

// GetEvents returns the Events field value if set, zero value otherwise.
func (o *EntityV3RepositoryDatadog) GetEvents() []EntityV3DatadogEventItem {
...
// and a boolean to check if the value has been set.
func (o *EntityV3RepositoryDatadog) GetEventsOk() (*[]EntityV3DatadogEventItem, bool) {
	if o == nil || o.Events == nil {
		return nil, false
	}
...
func (o *EntityV3RepositoryDatadog) HasEvents() bool {
...
func (o *EntityV3RepositoryDatadog) SetEvents(v []EntityV3DatadogEventItem) {
	o.Events = v
}

// GetLogs returns the Logs field value if set, zero value otherwise.
func (o *EntityV3RepositoryDatadog) GetLogs() []EntityV3DatadogLogItem {
	if o == nil || o.Logs == nil {
...
// and a boolean to check if the value has been set.
func (o *EntityV3RepositoryDatadog) GetLogsOk() (*[]EntityV3DatadogLogItem, bool) {
	if o == nil || o.Logs == nil {
		return nil, false
	}
	return &o.Logs, true
...
// and a boolean to check if the value has been set.
func (o *EntityV3RepositoryDatadog) GetPerformanceDataOk() (*EntityV3DatadogPerformance, bool) {
	if o == nil || o.PerformanceData == nil {
		return nil, false
	}
...
func (o *EntityV3RepositoryDatadog) HasPerformanceData() bool {
...
func (o *EntityV3RepositoryDatadog) SetPerformanceData(v EntityV3DatadogPerformance) {
	o.PerformanceData = &v
}

// GetPipelines returns the Pipelines field value if set, zero value otherwise.
func (o *EntityV3RepositoryDatadog) GetPipelines() EntityV3DatadogPipelines {
...
// and a boolean to check if the value has been set.
func (o *EntityV3RepositoryDatadog) GetPipelinesOk() (*EntityV3DatadogPipelines, bool) {
	if o == nil || o.Pipelines == nil {
		return nil, false
	}
...
func (o *EntityV3RepositoryDatadog) HasPipelines() bool {
...
func (o *EntityV3RepositoryDatadog) SetPipelines(v EntityV3DatadogPipelines) {
	o.Pipelines = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o EntityV3RepositoryDatadog) MarshalJSON() ([]byte, error) {
...
func (o *EntityV3RepositoryDatadog) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		CodeLocations   []EntityV3DatadogCodeLocationItem `json:"codeLocations,omitempty"`
		Events          []EntityV3DatadogEventItem        `json:"events,omitempty"`
		Logs            []EntityV3DatadogLogItem          `json:"logs,omitempty"`
