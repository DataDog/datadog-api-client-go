...
// NullableDowntimeIncludedMonitorType handles when a null is used for DowntimeIncludedMonitorType.
type NullableDowntimeIncludedMonitorType struct {
	value *DowntimeIncludedMonitorType
	isSet bool
}

// Get returns the associated value.
func (v NullableDowntimeIncludedMonitorType) Get() *DowntimeIncludedMonitorType {
	return v.value
}

// Set changes the value and indicates it's been called.
func (v *NullableDowntimeIncludedMonitorType) Set(val *DowntimeIncludedMonitorType) {
	v.value = val
	v.isSet = true
}

// IsSet returns whether Set has been called.
func (v NullableDowntimeIncludedMonitorType) IsSet() bool {
	return v.isSet
}

// Unset sets the value to nil and resets the set flag.
func (v *NullableDowntimeIncludedMonitorType) Unset() {
	v.value = nil
	v.isSet = false
}

// NewNullableDowntimeIncludedMonitorType initializes the struct as if Set has been called.
func NewNullableDowntimeIncludedMonitorType(val *DowntimeIncludedMonitorType) *NullableDowntimeIncludedMonitorType {
	return &NullableDowntimeIncludedMonitorType{value: val, isSet: true}
}

// MarshalJSON serializes the associated value.
func (v NullableDowntimeIncludedMonitorType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

// UnmarshalJSON deserializes the payload and sets the flag as if Set has been called.
func (v *NullableDowntimeIncludedMonitorType) UnmarshalJSON(src []byte) error {
	v.isSet = true
