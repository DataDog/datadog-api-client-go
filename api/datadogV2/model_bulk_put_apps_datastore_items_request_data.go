...
type BulkPutAppsDatastoreItemsRequestData struct {
	...
	// Items resource type.
	Type BulkPutAppsDatastoreItemsRequestDataType `json:"type"`
...
func NewBulkPutAppsDatastoreItemsRequestData(typeVar BulkPutAppsDatastoreItemsRequestDataType) *BulkPutAppsDatastoreItemsRequestData {
...
func NewBulkPutAppsDatastoreItemsRequestDataWithDefaults() *BulkPutAppsDatastoreItemsRequestData {
	this := BulkPutAppsDatastoreItemsRequestData{}
	var typeVar BulkPutAppsDatastoreItemsRequestDataType = BULKPUTAPPSDATASTOREITEMSREQUESTDATATYPE_ITEMS
	this.Type = typeVar
	return &this
}
...
func (o *BulkPutAppsDatastoreItemsRequestData) GetId() string {
	if o == nil || o.Id == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BulkPutAppsDatastoreItemsRequestData) GetIdOk() (*string, bool) {
	if o == nil || o.Id == nil {
		return nil, false
	}
	return o.Id, true
...
func (o *BulkPutAppsDatastoreItemsRequestData) SetId(v string) {
	o.Id = &v
}

// GetType returns the Type field value.
func (o *BulkPutAppsDatastoreItemsRequestData) GetType() BulkPutAppsDatastoreItemsRequestDataType {
	if o == nil {
		var ret BulkPutAppsDatastoreItemsRequestDataType
		return ret
	}
	return o.Type
}
...
// and a boolean to check if the value has been set.
func (o *BulkPutAppsDatastoreItemsRequestData) GetTypeOk() (*BulkPutAppsDatastoreItemsRequestDataType, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *BulkPutAppsDatastoreItemsRequestData) SetType(v BulkPutAppsDatastoreItemsRequestDataType) {
	o.Type = v
}
