...
func NewCVSS(score float64, severity Severity, vector string) *CVSS {
	this := CVSS{}
	this.Score = score
...
func (o *CVSS) GetSeverity() Severity {
	if o == nil {
		var ret Severity
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CVSS) GetSeverityOk() (*Severity, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CVSS) SetSeverity(v Severity) {
	o.Severity = v
}
