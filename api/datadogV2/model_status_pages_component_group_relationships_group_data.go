...
func NewStatusPagesComponentGroupRelationshipsGroupData(id string, typeVar StatusPagesComponentGroupType) *StatusPagesComponentGroupRelationshipsGroupData {
...
func (o *StatusPagesComponentGroupRelationshipsGroupData) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *StatusPagesComponentGroupRelationshipsGroupData) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *StatusPagesComponentGroupRelationshipsGroupData) SetId(v string) {
	o.Id = v
}
