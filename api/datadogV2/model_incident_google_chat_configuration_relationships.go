...
// IncidentGoogleChatConfigurationRelationships Relationships for a Google Chat configuration.
type IncidentGoogleChatConfigurationRelationships struct {
...
// NewIncidentGoogleChatConfigurationRelationships instantiates a new IncidentGoogleChatConfigurationRelationships object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewIncidentGoogleChatConfigurationRelationships() *IncidentGoogleChatConfigurationRelationships {
	this := IncidentGoogleChatConfigurationRelationships{}
	return &this
}

// NewIncidentGoogleChatConfigurationRelationshipsWithDefaults instantiates a new IncidentGoogleChatConfigurationRelationships object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewIncidentGoogleChatConfigurationRelationshipsWithDefaults() *IncidentGoogleChatConfigurationRelationships {
	this := IncidentGoogleChatConfigurationRelationships{}
	return &this
}

// GetCreatedByUser returns the CreatedByUser field value if set, zero value otherwise.
func (o *IncidentGoogleChatConfigurationRelationships) GetCreatedByUser() RelationshipToUser {
...
func (o *IncidentGoogleChatConfigurationRelationships) GetCreatedByUserOk() (*RelationshipToUser, bool) {
	if o == nil || o.CreatedByUser == nil {
		return nil, false
	}
...
func (o *IncidentGoogleChatConfigurationRelationships) HasCreatedByUser() bool {
...
func (o *IncidentGoogleChatConfigurationRelationships) SetCreatedByUser(v RelationshipToUser) {
	o.CreatedByUser = &v
}

// GetIncidentType returns the IncidentType field value if set, zero value otherwise.
func (o *IncidentGoogleChatConfigurationRelationships) GetIncidentType() RelationshipToIncidentType {
...
// and a boolean to check if the value has been set.
func (o *IncidentGoogleChatConfigurationRelationships) GetIncidentTypeOk() (*RelationshipToIncidentType, bool) {
	if o == nil || o.IncidentType == nil {
		return nil, false
	}
...
func (o *IncidentGoogleChatConfigurationRelationships) HasIncidentType() bool {
...
func (o *IncidentGoogleChatConfigurationRelationships) SetIncidentType(v RelationshipToIncidentType) {
	o.IncidentType = &v
}

// GetLastModifiedByUser returns the LastModifiedByUser field value if set, zero value otherwise.
func (o *IncidentGoogleChatConfigurationRelationships) GetLastModifiedByUser() RelationshipToUser {
...
// and a boolean to check if the value has been set.
func (o *IncidentGoogleChatConfigurationRelationships) GetLastModifiedByUserOk() (*RelationshipToUser, bool) {
	if o == nil || o.LastModifiedByUser == nil {
		return nil, false
	}
...
func (o *IncidentGoogleChatConfigurationRelationships) HasLastModifiedByUser() bool {
...
func (o *IncidentGoogleChatConfigurationRelationships) SetLastModifiedByUser(v RelationshipToUser) {
	o.LastModifiedByUser = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o IncidentGoogleChatConfigurationRelationships) MarshalJSON() ([]byte, error) {
...
func (o *IncidentGoogleChatConfigurationRelationships) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		CreatedByUser      *RelationshipToUser         `json:"created_by_user,omitempty"`
		IncidentType       *RelationshipToIncidentType `json:"incident_type,omitempty"`
		LastModifiedByUser *RelationshipToUser         `json:"last_modified_by_user,omitempty"`
