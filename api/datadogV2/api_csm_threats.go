...
// BatchUpdateCSMThreatsAgentPolicy Batch update CSM Threats Agent policies.
// Update Cloud Security Management Threats Agent policies.
// Returns the Agent policies objects when the request is successful.
func (a *CSMThreatsApi) BatchUpdateCSMThreatsAgentPolicy(ctx _context.Context, body CloudWorkloadSecurityAgentPolicyBatchUpdateRequest) (CloudWorkloadSecurityAgentPoliciesListResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CSMThreatsApi.BatchUpdateCSMThreatsAgentPolicy")
	if err != nil {
...
// CreateCSMThreatsAgentPolicy Create a CSM Threats Agent policy.
...
// DeleteCSMThreatsAgentPolicy Delete a CSM Threats Agent policy.
...
// GetCSMThreatsAgentPolicy Get a CSM Threats Agent policy.
...
// ListCSMThreatsAgentPolicies Get all CSM Threats Agent policies.
...
// UpdateCSMThreatsAgentPolicy Update a CSM Threats Agent policy.
