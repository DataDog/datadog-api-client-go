...
func (o *CloudWorkloadSecurityAgentRuleActionSet) GetPrivate() bool {
...
// and a boolean to check if the value has been set.
func (o *CloudWorkloadSecurityAgentRuleActionSet) GetPrivateOk() (*bool, bool) {
	if o == nil || o.Private == nil {
		return nil, false
	}
...
func (o *CloudWorkloadSecurityAgentRuleActionSet) HasPrivate() bool {
	return o != nil && o.Private != nil
}

// SetPrivate gets a reference to the given bool and assigns it to the Private field.
func (o *CloudWorkloadSecurityAgentRuleActionSet) SetPrivate(v bool) {
	o.Private = &v
}
...
func (o *CloudWorkloadSecurityAgentRuleActionSet) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = datadog.UnmarshalUseNumber(bytes, &additionalProperties); err == nil {
		datadog.DeleteKeys(additionalProperties, &[]string{"append", "default_value", "expression", "field", "inherited", "name", "private", "scope", "scope_field", "size", "ttl", "value"})
	} else {
		return err
	}
	o.Append = all.Append
