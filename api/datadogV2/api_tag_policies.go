...
func (a *TagPoliciesApi) DeleteTagPolicy(ctx _context.Context, policyId string) (*_nethttp.Response, error) {
	var (
...
func (a *TagPoliciesApi) GetTagPolicy(ctx _context.Context, policyId string) (TagPolicyResponse, *_nethttp.Response, error) {
	var (
...
// GetTagPolicyScore Get tag policy score.
// Retrieve the compliance score for a specific tag policy.
func (a *TagPoliciesApi) GetTagPolicyScore(ctx _context.Context, policyId string) (TagPolicyScoreResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
...
func (r *ListTagPoliciesOptionalParameters) WithFilterSource(filterSource string) *ListTagPoliciesOptionalParameters {
...
func (a *TagPoliciesApi) ListTagPolicies(ctx _context.Context, o ...ListTagPoliciesOptionalParameters) (TagPoliciesResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue TagPoliciesResponse
