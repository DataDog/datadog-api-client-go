...
// ObservabilityPipelineAmazonS3SourceType The source type. Always `aws_s3`.
type ObservabilityPipelineAmazonS3SourceType string

// List of ObservabilityPipelineAmazonS3SourceType.
const (
	OBSERVABILITYPIPELINEAMAZONS3SOURCETYPE_AWS_S3 ObservabilityPipelineAmazonS3SourceType = "aws_s3"
)

var allowedObservabilityPipelineAmazonS3SourceTypeEnumValues = []ObservabilityPipelineAmazonS3SourceType{
	OBSERVABILITYPIPELINEAMAZONS3SOURCETYPE_AWS_S3,
}
