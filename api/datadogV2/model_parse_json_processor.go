...
// ParseJSONProcessor The `parse_json` processor extracts JSON from a specified field and flattens it into the event. This is useful when logs contain embedded JSON as a string.
type ParseJSONProcessor struct {
	...
	Type PipelineParseJSONProcessorType `json:"type"`
...
func NewParseJSONProcessor(field string, id string, include string, inputs []string, typeVar PipelineParseJSONProcessorType) *ParseJSONProcessor {
...
func (o *ParseJSONProcessor) GetType() PipelineParseJSONProcessorType {
	if o == nil {
		var ret PipelineParseJSONProcessorType
		return ret
	}
	return o.Type
}
...
// and a boolean to check if the value has been set.
func (o *ParseJSONProcessor) GetTypeOk() (*PipelineParseJSONProcessorType, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *ParseJSONProcessor) SetType(v PipelineParseJSONProcessorType) {
	o.Type = v
}
