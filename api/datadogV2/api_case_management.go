...
// ListCaseWatchers Get case watchers.
// Get all users watching a case
func (a *CaseManagementApi) ListCaseWatchers(ctx _context.Context, caseId string) (WatchersResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue WatchersResponse
	)
...
// UnwatchCase Remove user as watcher.
// Remove a user from the watchers list for a case
func (a *CaseManagementApi) UnwatchCase(ctx _context.Context, caseId string, userId string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)
	...
	localVarPath := localBasePath + "/api/v2/cases/{case_id}/watchers/{user_id}"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{case_id}", _neturl.PathEscape(datadog.ParameterToString(caseId, "")))
...
// WatchCase Add user as watcher.
// Add a user as a watcher for a case
func (a *CaseManagementApi) WatchCase(ctx _context.Context, caseId string, userId string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodPost
		localVarPostBody   interface{}
	)
