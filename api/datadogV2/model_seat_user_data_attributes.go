...
func (o *SeatUserDataAttributes) GetAssignedAt() string {
...
func (o *SeatUserDataAttributes) GetAssignedAtOk() (*string, bool) {
	if o == nil || o.AssignedAt == nil {
		return nil, false
	}
...
func (o *SeatUserDataAttributes) SetAssignedAt(v string) {
	o.AssignedAt = &v
}
