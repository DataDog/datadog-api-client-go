...
func (o *IssueAttributes) GetImpactedSessions() int64 {
...
// and a boolean to check if the value has been set.
func (o *IssueAttributes) GetImpactedSessionsOk() (*int64, bool) {
	if o == nil || o.ImpactedSessions == nil {
		return nil, false
	}
...
func (o *IssueAttributes) HasImpactedSessions() bool {
...
// and a boolean to check if the value has been set.
func (o *IssueAttributes) GetImpactedUsersOk() (*int64, bool) {
	if o == nil || o.ImpactedUsers == nil {
		return nil, false
	}
...
func (o *IssueAttributes) HasImpactedUsers() bool {
...
func (o *IssueAttributes) SetImpactedUsers(v int64) {
	o.ImpactedUsers = &v
}
...
func (o *IssueAttributes) GetTotalCount() int64 {
...
// and a boolean to check if the value has been set.
func (o *IssueAttributes) GetTotalCountOk() (*int64, bool) {
	if o == nil || o.TotalCount == nil {
		return nil, false
	}
...
func (o *IssueAttributes) HasTotalCount() bool {
	return o != nil && o.TotalCount != nil
}

// SetTotalCount gets a reference to the given int64 and assigns it to the TotalCount field.
func (o *IssueAttributes) SetTotalCount(v int64) {
	o.TotalCount = &v
}
...
func (o *IssueAttributes) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = datadog.Unmarshal(bytes, &additionalProperties); err == nil {
		datadog.DeleteKeys(additionalProperties, &[]string{"error_message", "error_type", "file_path", "first_seen", "first_seen_version", "function_name", "impacted_sessions", "impacted_users", "is_crash", "languages", "last_seen", "last_seen_version", "platform", "service", "state", "total_count"})
	} else {
		return err
	}
