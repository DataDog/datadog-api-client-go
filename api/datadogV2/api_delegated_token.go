...
// DelegatedTokenApi service type
type DelegatedTokenApi datadog.Service

// GetDelegatedToken Get a delegated token.
...
func (a *DelegatedTokenApi) GetDelegatedToken(ctx _context.Context) (DelegatedTokenResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.DelegatedTokenApi.GetDelegatedToken")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/delegated-token"
...
// NewDelegatedTokenApi Returns NewDelegatedTokenApi.
func NewDelegatedTokenApi(client *datadog.APIClient) *DelegatedTokenApi {
	return &DelegatedTokenApi{
		Client: client,
	}
}
