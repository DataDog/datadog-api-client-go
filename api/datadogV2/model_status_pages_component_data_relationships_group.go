...
type StatusPagesComponentDataRelationshipsGroup struct {
	//
	Data StatusPagesComponentDataRelationshipsGroupData `json:"data"`
...
func NewStatusPagesComponentDataRelationshipsGroup(data StatusPagesComponentDataRelationshipsGroupData) *StatusPagesComponentDataRelationshipsGroup {
