...
type AwsScanOptionsCreateData struct {
	...
	Attributes AwsScanOptionsAttributes `json:"attributes"`
...
func NewAwsScanOptionsCreateData(attributes AwsScanOptionsAttributes, id string, typeVar AwsScanOptionsType) *AwsScanOptionsCreateData {
...
func (o *AwsScanOptionsCreateData) GetAttributes() AwsScanOptionsAttributes {
	if o == nil {
...
func (o *AwsScanOptionsCreateData) GetAttributesOk() (*AwsScanOptionsAttributes, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AwsScanOptionsCreateData) SetAttributes(v AwsScanOptionsAttributes) {
	o.Attributes = v
}
