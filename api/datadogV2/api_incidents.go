...
func (a *IncidentsApi) CreatePageFromIncident(ctx _context.Context, incidentId string, body IncidentCreatePageFromIncidentRequest) (IncidentCreatePageResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue IncidentCreatePageResponse
	)
