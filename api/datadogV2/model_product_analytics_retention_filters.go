...
// ProductAnalyticsRetentionFilters Filters narrowing the events considered by a retention query.
type ProductAnalyticsRetentionFilters struct {
...
// NewProductAnalyticsRetentionFilters instantiates a new ProductAnalyticsRetentionFilters object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewProductAnalyticsRetentionFilters() *ProductAnalyticsRetentionFilters {
	this := ProductAnalyticsRetentionFilters{}
	return &this
}

// NewProductAnalyticsRetentionFiltersWithDefaults instantiates a new ProductAnalyticsRetentionFilters object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewProductAnalyticsRetentionFiltersWithDefaults() *ProductAnalyticsRetentionFilters {
	this := ProductAnalyticsRetentionFilters{}
	return &this
}

// GetAudienceFilters returns the AudienceFilters field value if set, zero value otherwise.
func (o *ProductAnalyticsRetentionFilters) GetAudienceFilters() ProductAnalyticsAudienceFilters {
...
func (o *ProductAnalyticsRetentionFilters) GetAudienceFiltersOk() (*ProductAnalyticsAudienceFilters, bool) {
	if o == nil || o.AudienceFilters == nil {
		return nil, false
	}
...
func (o *ProductAnalyticsRetentionFilters) HasAudienceFilters() bool {
...
func (o *ProductAnalyticsRetentionFilters) SetAudienceFilters(v ProductAnalyticsAudienceFilters) {
	o.AudienceFilters = &v
}

// GetStringFilter returns the StringFilter field value if set, zero value otherwise.
func (o *ProductAnalyticsRetentionFilters) GetStringFilter() string {
...
// and a boolean to check if the value has been set.
func (o *ProductAnalyticsRetentionFilters) GetStringFilterOk() (*string, bool) {
	if o == nil || o.StringFilter == nil {
		return nil, false
	}
...
func (o *ProductAnalyticsRetentionFilters) HasStringFilter() bool {
...
func (o *ProductAnalyticsRetentionFilters) SetStringFilter(v string) {
	o.StringFilter = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o ProductAnalyticsRetentionFilters) MarshalJSON() ([]byte, error) {
...
func (o *ProductAnalyticsRetentionFilters) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		AudienceFilters *ProductAnalyticsAudienceFilters `json:"audience_filters,omitempty"`
		StringFilter    *string                          `json:"string_filter,omitempty"`
	}{}
	...
	if err = datadog.UnmarshalUseNumber(bytes, &additionalProperties); err == nil {
		datadog.DeleteKeys(additionalProperties, &[]string{"audience_filters", "string_filter"})
	} else {
		return err
	}
