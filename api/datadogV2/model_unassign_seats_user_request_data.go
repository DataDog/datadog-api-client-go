...
type UnassignSeatsUserRequestData struct {
	//
	Attributes *UnassignSeatsUserRequestDataAttributes `json:"attributes,omitempty"`
	//
...
func NewUnassignSeatsUserRequestData(typeVar SeatAssignmentsDataType) *UnassignSeatsUserRequestData {
...
func (o *UnassignSeatsUserRequestData) HasAttributes() bool {
	return o != nil && o.Attributes != nil
}

// SetAttributes gets a reference to the given UnassignSeatsUserRequestDataAttributes and assigns it to the Attributes field.
