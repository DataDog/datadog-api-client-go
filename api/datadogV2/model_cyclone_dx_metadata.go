...
// CycloneDXMetadata Metadata for the CycloneDX BOM.
type CycloneDXMetadata struct {
	// The asset component represents the system or host being scanned.
	Component CycloneDXAssetComponent `json:"component"`
...
func NewCycloneDXMetadata(component CycloneDXAssetComponent, tools CycloneDXTools) *CycloneDXMetadata {
...
func (o *CycloneDXMetadata) GetComponent() CycloneDXAssetComponent {
	if o == nil {
		var ret CycloneDXAssetComponent
		return ret
	}
	return o.Component
}
...
func (o *CycloneDXMetadata) GetComponentOk() (*CycloneDXAssetComponent, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CycloneDXMetadata) SetComponent(v CycloneDXAssetComponent) {
	o.Component = v
}

// GetTools returns the Tools field value.
func (o *CycloneDXMetadata) GetTools() CycloneDXTools {
	if o == nil {
		var ret CycloneDXTools
		return ret
	}
	return o.Tools
}
...
// and a boolean to check if the value has been set.
func (o *CycloneDXMetadata) GetToolsOk() (*CycloneDXTools, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Tools, true
...
func (o *CycloneDXMetadata) SetTools(v CycloneDXTools) {
	o.Tools = v
}
