...
func (o *CIAppTestsAggregateRequest) GetPage() CIAppQueryPageOptions {
	if o == nil || o.Page == nil {
...
// and a boolean to check if the value has been set.
func (o *CIAppTestsAggregateRequest) GetPageOk() (*CIAppQueryPageOptions, bool) {
	if o == nil || o.Page == nil {
		return nil, false
	}
	return o.Page, true
...
func (o *CIAppTestsAggregateRequest) HasPage() bool {
	return o != nil && o.Page != nil
}

// SetPage gets a reference to the given CIAppQueryPageOptions and assigns it to the Page field.
func (o *CIAppTestsAggregateRequest) SetPage(v CIAppQueryPageOptions) {
	o.Page = &v
}
