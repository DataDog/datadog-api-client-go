...
func NewObservabilityPipelineConfigProcessorGroup(id string, include string, inputs []string, processors []ObservabilityPipelineConfigProcessorItem) *ObservabilityPipelineConfigProcessorGroup {
...
func (o *ObservabilityPipelineConfigProcessorGroup) HasEnabled() bool {
