...
func (a *TwilioIntegrationAccountsApi) CreateTwilioIntegrationAccount(ctx _context.Context, interfaceId TwilioInterfaceType, body TwilioIntegrationAccountRequest) (TwilioIntegrationAccountResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue TwilioIntegrationAccountResponse
	)

	operationId := "v2.CreateTwilioIntegrationAccount"
	...
	localVarPath := localBasePath + "/api/v2/integrations/twilio/interfaces/{interface_id}/accounts"
...
func (a *TwilioIntegrationAccountsApi) DeleteTwilioIntegrationAccount(ctx _context.Context, interfaceId TwilioInterfaceType, accountId string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)

	operationId := "v2.DeleteTwilioIntegrationAccount"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
	...
	localVarPath := localBasePath + "/api/v2/integrations/twilio/interfaces/{interface_id}/accounts/{account_id}"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{interface_id}", _neturl.PathEscape(datadog.ParameterToString(interfaceId, "")))
...
func (a *TwilioIntegrationAccountsApi) GetTwilioIntegrationAccount(ctx _context.Context, interfaceId TwilioInterfaceType, accountId string) (TwilioIntegrationAccountResponse, *_nethttp.Response, error) {
	var (
	...
	operationId := "v2.GetTwilioIntegrationAccount"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
...
func (a *TwilioIntegrationAccountsApi) ListTwilioIntegrationAccounts(ctx _context.Context, interfaceId TwilioInterfaceType) (TwilioIntegrationAccountsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue TwilioIntegrationAccountsResponse
	)

	operationId := "v2.ListTwilioIntegrationAccounts"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
...
func (a *TwilioIntegrationAccountsApi) UpdateTwilioIntegrationAccount(ctx _context.Context, interfaceId TwilioInterfaceType, accountId string, body TwilioIntegrationAccountUpdateRequest) (TwilioIntegrationAccountResponse, *_nethttp.Response, error) {
	var (
	...
	operationId := "v2.UpdateTwilioIntegrationAccount"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
