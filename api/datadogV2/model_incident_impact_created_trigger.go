...
// IncidentImpactCreatedTrigger Trigger a workflow when an impact is created for an incident.
type IncidentImpactCreatedTrigger struct {
...
// NewIncidentImpactCreatedTrigger instantiates a new IncidentImpactCreatedTrigger object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewIncidentImpactCreatedTrigger() *IncidentImpactCreatedTrigger {
	this := IncidentImpactCreatedTrigger{}
	return &this
}

// NewIncidentImpactCreatedTriggerWithDefaults instantiates a new IncidentImpactCreatedTrigger object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewIncidentImpactCreatedTriggerWithDefaults() *IncidentImpactCreatedTrigger {
	this := IncidentImpactCreatedTrigger{}
	return &this
}

// GetExecutionLimit returns the ExecutionLimit field value if set, zero value otherwise.
func (o *IncidentImpactCreatedTrigger) GetExecutionLimit() ExecutionLimit {
...
func (o *IncidentImpactCreatedTrigger) GetExecutionLimitOk() (*ExecutionLimit, bool) {
	if o == nil || o.ExecutionLimit == nil {
		return nil, false
	}
...
func (o *IncidentImpactCreatedTrigger) HasExecutionLimit() bool {
...
func (o *IncidentImpactCreatedTrigger) SetExecutionLimit(v ExecutionLimit) {
	o.ExecutionLimit = &v
}

// GetIncidentType returns the IncidentType field value if set, zero value otherwise.
func (o *IncidentImpactCreatedTrigger) GetIncidentType() string {
...
// and a boolean to check if the value has been set.
func (o *IncidentImpactCreatedTrigger) GetIncidentTypeOk() (*string, bool) {
	if o == nil || o.IncidentType == nil {
		return nil, false
	}
...
func (o *IncidentImpactCreatedTrigger) HasIncidentType() bool {
...
func (o *IncidentImpactCreatedTrigger) SetIncidentType(v string) {
	o.IncidentType = &v
}

// GetTagCondition returns the TagCondition field value if set, zero value otherwise.
func (o *IncidentImpactCreatedTrigger) GetTagCondition() IncidentCondition {
...
// and a boolean to check if the value has been set.
func (o *IncidentImpactCreatedTrigger) GetTagConditionOk() (*IncidentCondition, bool) {
	if o == nil || o.TagCondition == nil {
		return nil, false
	}
...
func (o *IncidentImpactCreatedTrigger) HasTagCondition() bool {
...
func (o *IncidentImpactCreatedTrigger) SetTagCondition(v IncidentCondition) {
	o.TagCondition = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o IncidentImpactCreatedTrigger) MarshalJSON() ([]byte, error) {
...
func (o *IncidentImpactCreatedTrigger) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		ExecutionLimit *ExecutionLimit    `json:"executionLimit,omitempty"`
		IncidentType   *string            `json:"incidentType,omitempty"`
		TagCondition   *IncidentCondition `json:"tagCondition,omitempty"`
