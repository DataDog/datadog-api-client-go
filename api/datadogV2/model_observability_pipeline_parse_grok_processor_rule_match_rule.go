...
// ObservabilityPipelineParseGrokProcessorRuleMatchRule Defines a grok match rule, which extracts structured fields from log content using named grok patterns.
