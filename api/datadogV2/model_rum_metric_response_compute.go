...
type RumMetricResponseCompute struct {
	...
	AggregationType *RumMetricResponseComputeAggregationType `json:"aggregation_type,omitempty"`
...
func (o *RumMetricResponseCompute) GetAggregationType() RumMetricResponseComputeAggregationType {
	if o == nil || o.AggregationType == nil {
		var ret RumMetricResponseComputeAggregationType
		return ret
	}
...
func (o *RumMetricResponseCompute) GetAggregationTypeOk() (*RumMetricResponseComputeAggregationType, bool) {
	if o == nil || o.AggregationType == nil {
		return nil, false
	}
...
// SetAggregationType gets a reference to the given RumMetricResponseComputeAggregationType and assigns it to the AggregationType field.
func (o *RumMetricResponseCompute) SetAggregationType(v RumMetricResponseComputeAggregationType) {
	o.AggregationType = &v
}
