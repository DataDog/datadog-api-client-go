...
func (a *MonitorsApi) GetMonitorNotificationRule(ctx _context.Context, ruleId string) (MonitorNotificationRuleResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue MonitorNotificationRuleResponse
...
func (a *MonitorsApi) GetMonitorNotificationRules(ctx _context.Context) (MonitorNotificationRuleListResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
