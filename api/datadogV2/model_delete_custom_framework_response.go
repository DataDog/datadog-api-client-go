...
// DeleteCustomFrameworkResponse Delete a custom framework.
type DeleteCustomFrameworkResponse struct {
	// Response object for an organization's custom frameworks.
	Data *CustomFrameworkMetadata `json:"data,omitempty"`
...
func NewDeleteCustomFrameworkResponse() *DeleteCustomFrameworkResponse {
...
func (o *DeleteCustomFrameworkResponse) HasData() bool {
	return o != nil && o.Data != nil
}

// SetData gets a reference to the given CustomFrameworkMetadata and assigns it to the Data field.
