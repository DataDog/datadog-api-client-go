...
func (o *ValidationErrorResponse) GetErrors() []ValidationError {
...
func (o *ValidationErrorResponse) GetErrorsOk() (*[]ValidationError, bool) {
	if o == nil || o.Errors == nil {
		return nil, false
	}
...
func (o *ValidationErrorResponse) SetErrors(v []ValidationError) {
	o.Errors = v
}
...
func (o *ValidationErrorResponse) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Errors []ValidationError `json:"errors,omitempty"`
	}{}
