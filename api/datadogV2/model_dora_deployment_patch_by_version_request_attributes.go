...
func (o *DORADeploymentPatchByVersionRequestAttributes) GetRemediation() DORADeploymentPatchRemediation {
...
// and a boolean to check if the value has been set.
func (o *DORADeploymentPatchByVersionRequestAttributes) GetRemediationOk() (*DORADeploymentPatchRemediation, bool) {
	if o == nil || o.Remediation == nil {
		return nil, false
	}
...
func (o *DORADeploymentPatchByVersionRequestAttributes) SetRemediation(v DORADeploymentPatchRemediation) {
	o.Remediation = &v
}
