...
// securely.
func (a *KeyManagementApi) CreatePersonalAccessToken(ctx _context.Context, body PersonalAccessTokenCreateRequest) (PersonalAccessTokenResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
	...
	operationId := "v2.CreatePersonalAccessToken"
...
func (a *KeyManagementApi) GetPersonalAccessToken(ctx _context.Context, patUuid uuid.UUID) (PersonalAccessTokenGetResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue PersonalAccessTokenGetResponse
	)

	operationId := "v2.GetPersonalAccessToken"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
...
func (r *ListPersonalAccessTokensOptionalParameters) WithFilterOwnerUuid(filterOwnerUuid []uuid.UUID) *ListPersonalAccessTokensOptionalParameters {
...
func (a *KeyManagementApi) ListPersonalAccessTokens(ctx _context.Context, o ...ListPersonalAccessTokensOptionalParameters) (PersonalAccessTokensListResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue PersonalAccessTokensListResponse
	...
	operationId := "v2.ListPersonalAccessTokens"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
...
func (a *KeyManagementApi) RevokePersonalAccessToken(ctx _context.Context, patUuid uuid.UUID) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)

	operationId := "v2.RevokePersonalAccessToken"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
...
func (a *KeyManagementApi) UpdatePersonalAccessToken(ctx _context.Context, patUuid uuid.UUID, body PersonalAccessTokenUpdateRequest) (PersonalAccessTokenGetResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPatch
		localVarPostBody    interface{}
		localVarReturnValue PersonalAccessTokenGetResponse
	...
	operationId := "v2.UpdatePersonalAccessToken"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
