...
type AWSNamespacesResponse struct {
	...
	Data []AWSNamespacesResponseData `json:"data,omitempty"`
...
func NewAWSNamespacesResponse() *AWSNamespacesResponse {
...
func (o *AWSNamespacesResponse) HasData() bool {
	return o != nil && o.Data != nil
}

// SetData gets a reference to the given []AWSNamespacesResponseData and assigns it to the Data field.
