...
// RetrieveAwsOnDemandTask Get AWS On Demand task by id.
// Fetch the data of a specific on demand task.
func (a *AgentlessScanningApi) RetrieveAwsOnDemandTask(ctx _context.Context, taskId string) (AwsOnDemandResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue AwsOnDemandResponse
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.AgentlessScanningApi.RetrieveAwsOnDemandTask")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
