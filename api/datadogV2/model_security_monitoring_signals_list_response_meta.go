...
func (o *SecurityMonitoringSignalsListResponseMeta) GetElapsed() int64 {
...
func (o *SecurityMonitoringSignalsListResponseMeta) GetElapsedOk() (*int64, bool) {
	if o == nil || o.Elapsed == nil {
		return nil, false
	}
...
func (o *SecurityMonitoringSignalsListResponseMeta) HasElapsed() bool {
	return o != nil && o.Elapsed != nil
}

// SetElapsed gets a reference to the given int64 and assigns it to the Elapsed field.
func (o *SecurityMonitoringSignalsListResponseMeta) SetElapsed(v int64) {
	o.Elapsed = &v
}
...
func (o *SecurityMonitoringSignalsListResponseMeta) GetRequestId() string {
...
// and a boolean to check if the value has been set.
func (o *SecurityMonitoringSignalsListResponseMeta) GetRequestIdOk() (*string, bool) {
	if o == nil || o.RequestId == nil {
		return nil, false
	}
...
func (o *SecurityMonitoringSignalsListResponseMeta) HasRequestId() bool {
	return o != nil && o.RequestId != nil
}

// SetRequestId gets a reference to the given string and assigns it to the RequestId field.
func (o *SecurityMonitoringSignalsListResponseMeta) SetRequestId(v string) {
	o.RequestId = &v
}

// GetStatus returns the Status field value if set, zero value otherwise.
func (o *SecurityMonitoringSignalsListResponseMeta) GetStatus() string {
...
// and a boolean to check if the value has been set.
func (o *SecurityMonitoringSignalsListResponseMeta) GetStatusOk() (*string, bool) {
	if o == nil || o.Status == nil {
		return nil, false
	}
...
func (o *SecurityMonitoringSignalsListResponseMeta) HasStatus() bool {
	return o != nil && o.Status != nil
}

// SetStatus gets a reference to the given string and assigns it to the Status field.
func (o *SecurityMonitoringSignalsListResponseMeta) SetStatus(v string) {
	o.Status = &v
}
