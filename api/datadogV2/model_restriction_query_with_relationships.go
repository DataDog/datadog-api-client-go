...
type RestrictionQueryWithRelationships struct {
	...
	Relationships *RestrictionQueryRelationships `json:"relationships,omitempty"`
...
func (o *RestrictionQueryWithRelationships) GetRelationships() RestrictionQueryRelationships {
	if o == nil || o.Relationships == nil {
		var ret RestrictionQueryRelationships
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *RestrictionQueryWithRelationships) GetRelationshipsOk() (*RestrictionQueryRelationships, bool) {
	if o == nil || o.Relationships == nil {
		return nil, false
	}
...
// SetRelationships gets a reference to the given RestrictionQueryRelationships and assigns it to the Relationships field.
func (o *RestrictionQueryWithRelationships) SetRelationships(v RestrictionQueryRelationships) {
	o.Relationships = &v
}
