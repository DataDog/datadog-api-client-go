...
type FindingCaseResponseDataAttributes struct {
	...
	//
	AssignedTo *SecurityUser `json:"assigned_to,omitempty"`
	//
	...
	JiraIssue *CaseJiraIssue `json:"jira_issue,omitempty"`
	// Key of the case.
...
func (o *FindingCaseResponseDataAttributes) GetAssignedTo() SecurityUser {
	if o == nil || o.AssignedTo == nil {
		var ret SecurityUser
		return ret
	}
	return *o.AssignedTo
}
...
// and a boolean to check if the value has been set.
func (o *FindingCaseResponseDataAttributes) GetAssignedToOk() (*SecurityUser, bool) {
	if o == nil || o.AssignedTo == nil {
		return nil, false
	}
...
// SetAssignedTo gets a reference to the given SecurityUser and assigns it to the AssignedTo field.
func (o *FindingCaseResponseDataAttributes) SetAssignedTo(v SecurityUser) {
	o.AssignedTo = &v
}
...
func (o *FindingCaseResponseDataAttributes) GetJiraIssue() CaseJiraIssue {
	if o == nil || o.JiraIssue == nil {
		var ret CaseJiraIssue
		return ret
	}
	return *o.JiraIssue
}
...
// and a boolean to check if the value has been set.
func (o *FindingCaseResponseDataAttributes) GetJiraIssueOk() (*CaseJiraIssue, bool) {
	if o == nil || o.JiraIssue == nil {
		return nil, false
	}
...
// SetJiraIssue gets a reference to the given CaseJiraIssue and assigns it to the JiraIssue field.
func (o *FindingCaseResponseDataAttributes) SetJiraIssue(v CaseJiraIssue) {
	o.JiraIssue = &v
}
