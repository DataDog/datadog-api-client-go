...
// DatastoreDataAttributes The definition of `DatastoreDataAttributes` object.
type DatastoreDataAttributes struct {
	...
	PrimaryKeyGenerationStrategy *DatastoreDataAttributesPrimaryKeyGenerationStrategy `json:"primary_key_generation_strategy,omitempty"`
...
func (o *DatastoreDataAttributes) GetPrimaryKeyGenerationStrategy() DatastoreDataAttributesPrimaryKeyGenerationStrategy {
	if o == nil || o.PrimaryKeyGenerationStrategy == nil {
		var ret DatastoreDataAttributesPrimaryKeyGenerationStrategy
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DatastoreDataAttributes) GetPrimaryKeyGenerationStrategyOk() (*DatastoreDataAttributesPrimaryKeyGenerationStrategy, bool) {
	if o == nil || o.PrimaryKeyGenerationStrategy == nil {
		return nil, false
	}
...
// SetPrimaryKeyGenerationStrategy gets a reference to the given DatastoreDataAttributesPrimaryKeyGenerationStrategy and assigns it to the PrimaryKeyGenerationStrategy field.
func (o *DatastoreDataAttributes) SetPrimaryKeyGenerationStrategy(v DatastoreDataAttributesPrimaryKeyGenerationStrategy) {
