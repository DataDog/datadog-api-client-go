...
type ProductAnalyticsSankeyResponseData struct {
	//
	Attributes *ProductAnalyticsSankeyResponseAttributes `json:"attributes,omitempty"`
	//
	Id *string `json:"id,omitempty"`
	//
	Type *ProductAnalyticsSankeyResponseType `json:"type,omitempty"`
...
func NewProductAnalyticsSankeyResponseData() *ProductAnalyticsSankeyResponseData {
...
func (o *ProductAnalyticsSankeyResponseData) HasAttributes() bool {
	return o != nil && o.Attributes != nil
}

// SetAttributes gets a reference to the given ProductAnalyticsSankeyResponseAttributes and assigns it to the Attributes field.
...
func (o *ProductAnalyticsSankeyResponseData) HasId() bool {
...
func (o *ProductAnalyticsSankeyResponseData) HasType() bool {
	return o != nil && o.Type != nil
}

// SetType gets a reference to the given ProductAnalyticsSankeyResponseType and assigns it to the Type field.
