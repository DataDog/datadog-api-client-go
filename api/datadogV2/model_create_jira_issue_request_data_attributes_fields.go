...
// CreateJiraIssueRequestDataAttributesFields Custom fields of the Jira issue to create. You can refer to the [Jira documentation](https://developer.atlassian.com/cloud/jira/platform/rest/v2/api-group-issues/#api-rest-api-2-issue-createmeta-projectidorkey-issuetypes-issuetypeid-get) for the list of available fields.
