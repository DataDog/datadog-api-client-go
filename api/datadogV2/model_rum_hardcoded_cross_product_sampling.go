...
// RumHardcodedCrossProductSampling Cross-product retention settings for a hardcoded retention filter.
type RumHardcodedCrossProductSampling struct {
...
// NewRumHardcodedCrossProductSampling instantiates a new RumHardcodedCrossProductSampling object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewRumHardcodedCrossProductSampling() *RumHardcodedCrossProductSampling {
	this := RumHardcodedCrossProductSampling{}
	return &this
}

// NewRumHardcodedCrossProductSamplingWithDefaults instantiates a new RumHardcodedCrossProductSampling object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewRumHardcodedCrossProductSamplingWithDefaults() *RumHardcodedCrossProductSampling {
	this := RumHardcodedCrossProductSampling{}
	return &this
}

// GetSessionReplayEnabled returns the SessionReplayEnabled field value if set, zero value otherwise.
func (o *RumHardcodedCrossProductSampling) GetSessionReplayEnabled() bool {
...
func (o *RumHardcodedCrossProductSampling) GetSessionReplayEnabledOk() (*bool, bool) {
	if o == nil || o.SessionReplayEnabled == nil {
		return nil, false
	}
...
func (o *RumHardcodedCrossProductSampling) HasSessionReplayEnabled() bool {
...
func (o *RumHardcodedCrossProductSampling) SetSessionReplayEnabled(v bool) {
...
func (o *RumHardcodedCrossProductSampling) GetSessionReplaySampleRate() float64 {
...
// and a boolean to check if the value has been set.
func (o *RumHardcodedCrossProductSampling) GetSessionReplaySampleRateOk() (*float64, bool) {
	if o == nil || o.SessionReplaySampleRate == nil {
		return nil, false
	}
...
func (o *RumHardcodedCrossProductSampling) HasSessionReplaySampleRate() bool {
...
func (o *RumHardcodedCrossProductSampling) SetSessionReplaySampleRate(v float64) {
	o.SessionReplaySampleRate = &v
}

// GetTraceEnabled returns the TraceEnabled field value if set, zero value otherwise.
func (o *RumHardcodedCrossProductSampling) GetTraceEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *RumHardcodedCrossProductSampling) GetTraceEnabledOk() (*bool, bool) {
	if o == nil || o.TraceEnabled == nil {
		return nil, false
	}
...
func (o *RumHardcodedCrossProductSampling) HasTraceEnabled() bool {
...
func (o *RumHardcodedCrossProductSampling) SetTraceEnabled(v bool) {
	o.TraceEnabled = &v
}

// GetTraceSampleRate returns the TraceSampleRate field value if set, zero value otherwise.
func (o *RumHardcodedCrossProductSampling) GetTraceSampleRate() float64 {
...
// and a boolean to check if the value has been set.
func (o *RumHardcodedCrossProductSampling) GetTraceSampleRateOk() (*float64, bool) {
	if o == nil || o.TraceSampleRate == nil {
		return nil, false
	}
...
func (o *RumHardcodedCrossProductSampling) HasTraceSampleRate() bool {
...
func (o *RumHardcodedCrossProductSampling) SetTraceSampleRate(v float64) {
	o.TraceSampleRate = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o RumHardcodedCrossProductSampling) MarshalJSON() ([]byte, error) {
...
func (o *RumHardcodedCrossProductSampling) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		SessionReplayEnabled    *bool    `json:"session_replay_enabled,omitempty"`
		SessionReplaySampleRate *float64 `json:"session_replay_sample_rate,omitempty"`
		TraceEnabled            *bool    `json:"trace_enabled,omitempty"`
