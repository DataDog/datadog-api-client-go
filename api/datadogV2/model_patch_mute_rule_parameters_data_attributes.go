...
func (o *PatchMuteRuleParametersDataAttributes) GetRule() AutomationRule {
	if o == nil || o.Rule == nil {
...
// and a boolean to check if the value has been set.
func (o *PatchMuteRuleParametersDataAttributes) GetRuleOk() (*AutomationRule, bool) {
	if o == nil || o.Rule == nil {
		return nil, false
	}
	return o.Rule, true
...
func (o *PatchMuteRuleParametersDataAttributes) SetRule(v AutomationRule) {
	o.Rule = &v
}
