...
func NewIntegrationAccountPrivateActionRunnerAuthRequest(authType IntegrationAccountPrivateActionRunnerAuthType, connectionId uuid.UUID, userUuid uuid.UUID) *IntegrationAccountPrivateActionRunnerAuthRequest {
...
func (o *IntegrationAccountPrivateActionRunnerAuthRequest) GetConnectionId() uuid.UUID {
	if o == nil {
		var ret uuid.UUID
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *IntegrationAccountPrivateActionRunnerAuthRequest) GetConnectionIdOk() (*uuid.UUID, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *IntegrationAccountPrivateActionRunnerAuthRequest) SetConnectionId(v uuid.UUID) {
	o.ConnectionId = v
}
...
func (o *IntegrationAccountPrivateActionRunnerAuthRequest) GetUserUuid() uuid.UUID {
	if o == nil {
		var ret uuid.UUID
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *IntegrationAccountPrivateActionRunnerAuthRequest) GetUserUuidOk() (*uuid.UUID, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *IntegrationAccountPrivateActionRunnerAuthRequest) SetUserUuid(v uuid.UUID) {
	o.UserUuid = v
}
