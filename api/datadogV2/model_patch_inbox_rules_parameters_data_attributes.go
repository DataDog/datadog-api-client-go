...
func (o *PatchInboxRulesParametersDataAttributes) GetRule() AutomationRule {
	if o == nil || o.Rule == nil {
...
// and a boolean to check if the value has been set.
func (o *PatchInboxRulesParametersDataAttributes) GetRuleOk() (*AutomationRule, bool) {
	if o == nil || o.Rule == nil {
		return nil, false
	}
	return o.Rule, true
...
// SetRule gets a reference to the given AutomationRule and assigns it to the Rule field.
func (o *PatchInboxRulesParametersDataAttributes) SetRule(v AutomationRule) {
	o.Rule = &v
}
