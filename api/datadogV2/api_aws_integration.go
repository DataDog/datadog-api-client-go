...
func (a *AWSIntegrationApi) DeleteAWSAccount(ctx _context.Context, awsAccountId string) (*_nethttp.Response, error) {
	var (
...
func (a *AWSIntegrationApi) GetAWSAccount(ctx _context.Context, awsAccountId string) (AWSAccountResponse, *_nethttp.Response, error) {
	var (
...
func (a *AWSIntegrationApi) ListAWSAccounts(ctx _context.Context) (AWSAccountsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
...
func (a *AWSIntegrationApi) UpdateAWSAccount(ctx _context.Context, awsAccountId string, body AWSAccountPatchRequest) (AWSAccountResponse, *_nethttp.Response, error) {
	var (
