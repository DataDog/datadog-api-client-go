...
// CreateAWSAccount AWS Integration - Create account config.
...
// DeleteAWSAccount AWS Integration - Delete account config.
...
// GenerateNewExternalID AWS Integration - Generate new external ID.
// Generate a new external ID for AWS role-based authentication.
func (a *AWSIntegrationApi) GenerateNewExternalID(ctx _context.Context) (AWSNewExternalIDResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
	...
	operationId := "v2.GenerateNewExternalID"
	if a.Client.Cfg.IsUnstableOperationEnabled(operationId) {
		_log.Printf("WARNING: Using unstable operation '%s'", operationId)
	} else {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.AWSIntegrationApi.GenerateNewExternalID")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// GetAWSAccount AWS Integration - Get account config.
...
// ListAWSAccounts AWS Integration - Get all account configs.
...
// ListAWSLogServices AWS Integration - List log services.
// Get a list of AWS services that can send logs to Datadog.
func (a *AWSIntegrationApi) ListAWSLogServices(ctx _context.Context) (AWSLogsServicesResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
	...
	operationId := "v2.ListAWSLogServices"
	if a.Client.Cfg.IsUnstableOperationEnabled(operationId) {
		_log.Printf("WARNING: Using unstable operation '%s'", operationId)
	} else {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.AWSIntegrationApi.ListAWSLogServices")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// ListAWSNamespaces AWS Integration - List namespaces.
...
func (a *AWSIntegrationApi) ListAWSNamespaces(ctx _context.Context) (AWSNamespacesResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/integration/aws/namespaces"
...
// UpdateAWSAccount AWS Integration - Patch account config.
// Update an AWS Account Integration Config
func (a *AWSIntegrationApi) UpdateAWSAccount(ctx _context.Context, awsAccountConfigId string, body AWSAccountPatchRequest) (AWSAccountResponse, *_nethttp.Response, error) {
	var (
