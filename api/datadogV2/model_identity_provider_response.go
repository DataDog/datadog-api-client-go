...
func NewIdentityProviderResponse(data IdentityProviderData) *IdentityProviderResponse {
...
func (o *IdentityProviderResponse) GetData() IdentityProviderData {
	if o == nil {
...
func (o *IdentityProviderResponse) GetDataOk() (*IdentityProviderData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *IdentityProviderResponse) SetData(v IdentityProviderData) {
	o.Data = v
}
...
func (o *IdentityProviderResponse) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Data *IdentityProviderData `json:"data"`
	}{}
