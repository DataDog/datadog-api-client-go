...
type ListAppsResponseDataItems struct {
	...
	Relationships ListAppsResponseDataItemsRelationships `json:"relationships"`
...
func NewListAppsResponseDataItems(attributes ListAppsResponseDataItemsAttributes, id string, relationships ListAppsResponseDataItemsRelationships, typeVar ListAppsResponseDataItemsType) *ListAppsResponseDataItems {
