...
// ExecutionPolicyResponse Response object that includes a single execution policy.
...
func NewExecutionPolicyResponse(data ExecutionPolicyResponseData) *ExecutionPolicyResponse {
...
func (o *ExecutionPolicyResponse) GetData() ExecutionPolicyResponseData {
	if o == nil {
...
func (o *ExecutionPolicyResponse) GetDataOk() (*ExecutionPolicyResponseData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *ExecutionPolicyResponse) SetData(v ExecutionPolicyResponseData) {
	o.Data = v
}
...
func (o *ExecutionPolicyResponse) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Data *ExecutionPolicyResponseData `json:"data"`
	}{}
