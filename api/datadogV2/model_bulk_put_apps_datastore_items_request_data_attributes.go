...
// BulkPutAppsDatastoreItemsRequestDataAttributes The definition of `BulkPutAppsDatastoreItemsRequestDataAttributes` object.
...
func (o *BulkPutAppsDatastoreItemsRequestDataAttributes) GetConflictMode() string {
...
func (o *BulkPutAppsDatastoreItemsRequestDataAttributes) GetConflictModeOk() (*string, bool) {
	if o == nil || o.ConflictMode == nil {
		return nil, false
	}
...
// SetConflictMode gets a reference to the given string and assigns it to the ConflictMode field.
func (o *BulkPutAppsDatastoreItemsRequestDataAttributes) SetConflictMode(v string) {
	o.ConflictMode = &v
}
