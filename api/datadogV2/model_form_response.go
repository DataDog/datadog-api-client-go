...
// FormResponse Response containing a single form.
...
func NewFormResponse(data FormDataResponse) *FormResponse {
	this := FormResponse{}
	this.Data = data
	return &this
}
...
func (o *FormResponse) GetData() FormDataResponse {
	if o == nil {
...
func (o *FormResponse) GetDataOk() (*FormDataResponse, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *FormResponse) SetData(v FormDataResponse) {
	o.Data = v
}
