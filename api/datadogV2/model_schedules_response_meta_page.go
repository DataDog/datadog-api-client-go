...
// SchedulesResponseMetaPage Metadata related to paging information that is included in the response when listing schedules.
type SchedulesResponseMetaPage struct {
	// First page number.
...
// NewSchedulesResponseMetaPage instantiates a new SchedulesResponseMetaPage object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewSchedulesResponseMetaPage() *SchedulesResponseMetaPage {
	this := SchedulesResponseMetaPage{}
	return &this
}

// NewSchedulesResponseMetaPageWithDefaults instantiates a new SchedulesResponseMetaPage object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewSchedulesResponseMetaPageWithDefaults() *SchedulesResponseMetaPage {
	this := SchedulesResponseMetaPage{}
	return &this
}

// GetFirstNumber returns the FirstNumber field value if set, zero value otherwise.
func (o *SchedulesResponseMetaPage) GetFirstNumber() int64 {
...
func (o *SchedulesResponseMetaPage) GetFirstNumberOk() (*int64, bool) {
	if o == nil || o.FirstNumber == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *SchedulesResponseMetaPage) GetLastNumberOk() (*int64, bool) {
	if o == nil || o.LastNumber == nil {
		return nil, false
	}
...
func (o *SchedulesResponseMetaPage) GetNextNumberOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SchedulesResponseMetaPage) HasNextNumber() bool {
...
func (o *SchedulesResponseMetaPage) SetNextNumber(v int64) {
	o.NextNumber.Set(&v)
}

// SetNextNumberNil sets the value for NextNumber to be an explicit nil.
func (o *SchedulesResponseMetaPage) SetNextNumberNil() {
	o.NextNumber.Set(nil)
}

// UnsetNextNumber ensures that no value is present for NextNumber, not even an explicit nil.
func (o *SchedulesResponseMetaPage) UnsetNextNumber() {
	o.NextNumber.Unset()
}

// GetNumber returns the Number field value if set, zero value otherwise.
func (o *SchedulesResponseMetaPage) GetNumber() int64 {
...
// and a boolean to check if the value has been set.
func (o *SchedulesResponseMetaPage) GetNumberOk() (*int64, bool) {
	if o == nil || o.Number == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned.
func (o *SchedulesResponseMetaPage) GetPrevNumberOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SchedulesResponseMetaPage) HasPrevNumber() bool {
...
func (o *SchedulesResponseMetaPage) SetPrevNumber(v int64) {
	o.PrevNumber.Set(&v)
}

// SetPrevNumberNil sets the value for PrevNumber to be an explicit nil.
func (o *SchedulesResponseMetaPage) SetPrevNumberNil() {
	o.PrevNumber.Set(nil)
}

// UnsetPrevNumber ensures that no value is present for PrevNumber, not even an explicit nil.
func (o *SchedulesResponseMetaPage) UnsetPrevNumber() {
	o.PrevNumber.Unset()
}

// GetSize returns the Size field value if set, zero value otherwise.
func (o *SchedulesResponseMetaPage) GetSize() int64 {
	if o == nil || o.Size == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SchedulesResponseMetaPage) GetSizeOk() (*int64, bool) {
	if o == nil || o.Size == nil {
		return nil, false
	}
	return o.Size, true
...
func (o *SchedulesResponseMetaPage) HasSize() bool {
	return o != nil && o.Size != nil
}

// SetSize gets a reference to the given int64 and assigns it to the Size field.
func (o *SchedulesResponseMetaPage) SetSize(v int64) {
	o.Size = &v
}

// GetTotal returns the Total field value if set, zero value otherwise.
func (o *SchedulesResponseMetaPage) GetTotal() int64 {
...
// and a boolean to check if the value has been set.
func (o *SchedulesResponseMetaPage) GetTotalOk() (*int64, bool) {
	if o == nil || o.Total == nil {
		return nil, false
	}
	return o.Total, true
...
func (o *SchedulesResponseMetaPage) HasTotal() bool {
	return o != nil && o.Total != nil
}

// SetTotal gets a reference to the given int64 and assigns it to the Total field.
func (o *SchedulesResponseMetaPage) SetTotal(v int64) {
	o.Total = &v
}

// GetType returns the Type field value if set, zero value otherwise.
func (o *SchedulesResponseMetaPage) GetType() string {
	if o == nil || o.Type == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SchedulesResponseMetaPage) GetTypeOk() (*string, bool) {
	if o == nil || o.Type == nil {
		return nil, false
	}
	return o.Type, true
...
func (o *SchedulesResponseMetaPage) HasType() bool {
	return o != nil && o.Type != nil
}

// SetType gets a reference to the given string and assigns it to the Type field.
func (o *SchedulesResponseMetaPage) SetType(v string) {
	o.Type = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o SchedulesResponseMetaPage) MarshalJSON() ([]byte, error) {
...
func (o *SchedulesResponseMetaPage) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		FirstNumber *int64                `json:"first_number,omitempty"`
		LastNumber  *int64                `json:"last_number,omitempty"`
		NextNumber  datadog.NullableInt64 `json:"next_number,omitempty"`
