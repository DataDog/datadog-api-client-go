...
func (o *AWSLogsServicesResponseData) HasId() bool {
...
func (o *AWSLogsServicesResponseData) GetType() string {
	if o == nil || o.Type == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AWSLogsServicesResponseData) GetTypeOk() (*string, bool) {
	if o == nil || o.Type == nil {
		return nil, false
	}
	return o.Type, true
...
func (o *AWSLogsServicesResponseData) HasType() bool {
	return o != nil && o.Type != nil
}

// SetType gets a reference to the given string and assigns it to the Type field.
func (o *AWSLogsServicesResponseData) SetType(v string) {
	o.Type = &v
}
