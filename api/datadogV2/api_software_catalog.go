...
// AcceptRecommendedEntities Accept recommended entities in bulk.
// Accept multiple recommended entities in Software Catalog in a single request.
func (a *SoftwareCatalogApi) AcceptRecommendedEntities(ctx _context.Context, body []RecommendedEntityWithSchema) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodPost
		localVarPostBody   interface{}
	)

	operationId := "v2.AcceptRecommendedEntities"
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SoftwareCatalogApi.AcceptRecommendedEntities")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/catalog/recommended_entity/bulk_accept"
...
// ConvertCatalogEntities Convert entities between schema versions.
// Convert entities from one schema version to another in Software Catalog.
func (a *SoftwareCatalogApi) ConvertCatalogEntities(ctx _context.Context, targetVersion EntitySchemaVersion, body UpsertCatalogEntityRequest) (string, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
	...
	operationId := "v2.ConvertCatalogEntities"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SoftwareCatalogApi.ConvertCatalogEntities")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/catalog/entity/convert"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	localVarQueryParams.Add("target_version", datadog.ParameterToString(targetVersion, ""))
	localVarHeaderParams["Content-Type"] = "application/json"
...
// DeclineRecommendedEntities Decline recommended entities in bulk.
// Decline multiple recommended entities in Software Catalog in a single request.
func (a *SoftwareCatalogApi) DeclineRecommendedEntities(ctx _context.Context, body []RecommendedEntityID) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodPost
		localVarPostBody   interface{}
	)

	operationId := "v2.DeclineRecommendedEntities"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SoftwareCatalogApi.DeclineRecommendedEntities")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/catalog/recommended_entity/bulk_decline"
...
// GetIDPConfigValue Get Internal Developer Portal configuration.
// Get a configuration value for the Internal Developer Portal (IDP).
func (a *SoftwareCatalogApi) GetIDPConfigValue(ctx _context.Context, configName string) (IDPConfigResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue IDPConfigResponse
	)

	operationId := "v2.GetIDPConfigValue"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SoftwareCatalogApi.GetIDPConfigValue")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/idp/config/{config_name}"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{config_name}", _neturl.PathEscape(datadog.ParameterToString(configName, "")))
...
// TriggerRecommendedEntitiesOptionalParameters holds optional parameters for TriggerRecommendedEntities.
type TriggerRecommendedEntitiesOptionalParameters struct {
	Body *interface{}
}

// NewTriggerRecommendedEntitiesOptionalParameters creates an empty struct for parameters.
func NewTriggerRecommendedEntitiesOptionalParameters() *TriggerRecommendedEntitiesOptionalParameters {
	this := TriggerRecommendedEntitiesOptionalParameters{}
	return &this
}

// WithBody sets the corresponding parameter name and returns the struct.
func (r *TriggerRecommendedEntitiesOptionalParameters) WithBody(body interface{}) *TriggerRecommendedEntitiesOptionalParameters {
	r.Body = &body
	return r
}

// TriggerRecommendedEntities Trigger recommended entity discovery.
// Trigger the discovery of recommended entities in Software Catalog.
func (a *SoftwareCatalogApi) TriggerRecommendedEntities(ctx _context.Context, o ...TriggerRecommendedEntitiesOptionalParameters) (interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue interface{}
		optionalParams      TriggerRecommendedEntitiesOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, datadog.ReportError("only one argument of type TriggerRecommendedEntitiesOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}

	operationId := "v2.TriggerRecommendedEntities"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SoftwareCatalogApi.TriggerRecommendedEntities")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/catalog/recommended_entity/trigger"
...
// UpsertIDPConfigValue Create or update IDP configuration.
// Create or update a configuration value for the Internal Developer Portal (IDP).
func (a *SoftwareCatalogApi) UpsertIDPConfigValue(ctx _context.Context, configName string, body IDPConfigRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodPost
		localVarPostBody   interface{}
	)

	operationId := "v2.UpsertIDPConfigValue"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SoftwareCatalogApi.UpsertIDPConfigValue")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
