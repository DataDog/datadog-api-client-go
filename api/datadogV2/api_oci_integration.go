...
func (a *OCIIntegrationApi) CreateTenancyConfig(ctx _context.Context, body CreateTenancyConfig) (TenancyConfig, *_nethttp.Response, error) {
	var (
...
func (a *OCIIntegrationApi) UpdateTenancyConfig(ctx _context.Context, tenancyOcid string, body UpdateTenancyConfig) (TenancyConfig, *_nethttp.Response, error) {
	var (
