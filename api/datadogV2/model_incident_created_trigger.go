...
// IncidentCreatedTrigger Trigger a workflow when an incident is declared.
type IncidentCreatedTrigger struct {
...
// NewIncidentCreatedTrigger instantiates a new IncidentCreatedTrigger object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewIncidentCreatedTrigger() *IncidentCreatedTrigger {
	this := IncidentCreatedTrigger{}
	return &this
}

// NewIncidentCreatedTriggerWithDefaults instantiates a new IncidentCreatedTrigger object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewIncidentCreatedTriggerWithDefaults() *IncidentCreatedTrigger {
	this := IncidentCreatedTrigger{}
	return &this
}

// GetIncidentType returns the IncidentType field value if set, zero value otherwise.
func (o *IncidentCreatedTrigger) GetIncidentType() string {
...
func (o *IncidentCreatedTrigger) GetIncidentTypeOk() (*string, bool) {
	if o == nil || o.IncidentType == nil {
		return nil, false
	}
...
func (o *IncidentCreatedTrigger) HasIncidentType() bool {
...
func (o *IncidentCreatedTrigger) SetIncidentType(v string) {
	o.IncidentType = &v
}

// GetTagCondition returns the TagCondition field value if set, zero value otherwise.
func (o *IncidentCreatedTrigger) GetTagCondition() IncidentCondition {
...
// and a boolean to check if the value has been set.
func (o *IncidentCreatedTrigger) GetTagConditionOk() (*IncidentCondition, bool) {
	if o == nil || o.TagCondition == nil {
		return nil, false
	}
...
func (o *IncidentCreatedTrigger) HasTagCondition() bool {
...
func (o *IncidentCreatedTrigger) SetTagCondition(v IncidentCondition) {
	o.TagCondition = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o IncidentCreatedTrigger) MarshalJSON() ([]byte, error) {
...
func (o *IncidentCreatedTrigger) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		IncidentType *string            `json:"incidentType,omitempty"`
		TagCondition *IncidentCondition `json:"tagCondition,omitempty"`
	}{}
	...
	if err = datadog.UnmarshalUseNumber(bytes, &additionalProperties); err == nil {
		datadog.DeleteKeys(additionalProperties, &[]string{"incidentType", "tagCondition"})
	} else {
		return err
	}
