...
func NewEPSS(score float64, severity Severity) *EPSS {
	this := EPSS{}
	this.Score = score
...
func (o *EPSS) GetSeverity() Severity {
	if o == nil {
		var ret Severity
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *EPSS) GetSeverityOk() (*Severity, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *EPSS) SetSeverity(v Severity) {
	o.Severity = v
}
