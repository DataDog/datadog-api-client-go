...
type ScheduleCreateRequestData struct {
	...
	Type *ScheduleCreateRequestDataType `json:"type,omitempty"`
...
func NewScheduleCreateRequestData() *ScheduleCreateRequestData {
...
func (o *ScheduleCreateRequestData) HasType() bool {
	return o != nil && o.Type != nil
}

// SetType gets a reference to the given ScheduleCreateRequestDataType and assigns it to the Type field.
