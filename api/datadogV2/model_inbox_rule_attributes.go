...
func NewInboxRuleAttributes(action ActionInbox, createdAt int64, createdBy AutomationRuleUser, enabled bool, modifiedAt int64, modifiedBy AutomationRuleUser, name string, rule AutomationRule) *InboxRuleAttributes {
...
func (o *InboxRuleAttributes) GetCreatedBy() AutomationRuleUser {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *InboxRuleAttributes) GetCreatedByOk() (*AutomationRuleUser, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *InboxRuleAttributes) SetCreatedBy(v AutomationRuleUser) {
	o.CreatedBy = v
}
...
func (o *InboxRuleAttributes) GetModifiedBy() AutomationRuleUser {
	if o == nil {
		var ret AutomationRuleUser
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *InboxRuleAttributes) GetModifiedByOk() (*AutomationRuleUser, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *InboxRuleAttributes) SetModifiedBy(v AutomationRuleUser) {
	o.ModifiedBy = v
}
...
func (o *InboxRuleAttributes) GetRule() AutomationRule {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *InboxRuleAttributes) GetRuleOk() (*AutomationRule, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Rule, true
...
func (o *InboxRuleAttributes) SetRule(v AutomationRule) {
	o.Rule = v
}
