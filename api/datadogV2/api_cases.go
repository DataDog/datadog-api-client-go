...
type CasesApi datadog.Service

// ArchiveCase Archive case.
// Archive case
func (a *CasesApi) ArchiveCase(ctx _context.Context, caseId string, body CaseEmptyRequest) (CaseResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CasesApi.ArchiveCase")
	if err != nil {
...
func (a *CasesApi) AssignCase(ctx _context.Context, caseId string, body CaseAssignRequest) (CaseResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue CaseResponse
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CasesApi.AssignCase")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// Create a Case
func (a *CasesApi) CreateCase(ctx _context.Context, body CaseCreateRequest) (CaseResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue CaseResponse
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CasesApi.CreateCase")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *CasesApi) GetCase(ctx _context.Context, caseId string) (CaseResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CasesApi.GetCase")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// Search cases.
func (a *CasesApi) SearchCases(ctx _context.Context, o ...SearchCasesOptionalParameters) (CasesResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CasesApi.SearchCases")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *CasesApi) SearchCasesWithPagination(ctx _context.Context, o ...SearchCasesOptionalParameters) (<-chan datadog.PaginationResult[Case], func()) {
...
// Unarchive case
func (a *CasesApi) UnarchiveCase(ctx _context.Context, caseId string, body CaseEmptyRequest) (CaseResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue CaseResponse
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CasesApi.UnarchiveCase")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// Unassign case
func (a *CasesApi) UnassignCase(ctx _context.Context, caseId string, body CaseEmptyRequest) (CaseResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue CaseResponse
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CasesApi.UnassignCase")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *CasesApi) UpdatePriority(ctx _context.Context, caseId string, body CaseUpdatePriorityRequest) (CaseResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue CaseResponse
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CasesApi.UpdatePriority")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// Update case status
func (a *CasesApi) UpdateStatus(ctx _context.Context, caseId string, body CaseUpdateStatusRequest) (CaseResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue CaseResponse
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CasesApi.UpdateStatus")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// NewCasesApi Returns NewCasesApi.
func NewCasesApi(client *datadog.APIClient) *CasesApi {
	return &CasesApi{
		Client: client,
	}
}
