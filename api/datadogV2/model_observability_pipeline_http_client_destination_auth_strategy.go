...
const (
	...
	OBSERVABILITYPIPELINEHTTPCLIENTDESTINATIONAUTHSTRATEGY_CUSTOM ObservabilityPipelineHttpClientDestinationAuthStrategy = "custom"
)
...
var allowedObservabilityPipelineHttpClientDestinationAuthStrategyEnumValues = []ObservabilityPipelineHttpClientDestinationAuthStrategy{
	...
	OBSERVABILITYPIPELINEHTTPCLIENTDESTINATIONAUTHSTRATEGY_CUSTOM,
}
