...
// ProductAnalyticsSankeyResponse Response for a Sankey flow analysis.
type ProductAnalyticsSankeyResponse struct {
	//
	Data *ProductAnalyticsSankeyResponseData `json:"data,omitempty"`
...
func NewProductAnalyticsSankeyResponse() *ProductAnalyticsSankeyResponse {
...
func (o *ProductAnalyticsSankeyResponse) HasData() bool {
	return o != nil && o.Data != nil
}

// SetData gets a reference to the given ProductAnalyticsSankeyResponseData and assigns it to the Data field.
func (o *ProductAnalyticsSankeyResponse) SetData(v ProductAnalyticsSankeyResponseData) {
	o.Data = &v
}

// GetMeta returns the Meta field value if set, zero value otherwise.
func (o *ProductAnalyticsSankeyResponse) GetMeta() ProductAnalyticsResponseMeta {
	if o == nil || o.Meta == nil {
...
// and a boolean to check if the value has been set.
func (o *ProductAnalyticsSankeyResponse) GetMetaOk() (*ProductAnalyticsResponseMeta, bool) {
	if o == nil || o.Meta == nil {
		return nil, false
	}
	return o.Meta, true
...
func (o *ProductAnalyticsSankeyResponse) HasMeta() bool {
	return o != nil && o.Meta != nil
}

// SetMeta gets a reference to the given ProductAnalyticsResponseMeta and assigns it to the Meta field.
func (o *ProductAnalyticsSankeyResponse) SetMeta(v ProductAnalyticsResponseMeta) {
	o.Meta = &v
}
