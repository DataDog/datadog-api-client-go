...
type RumMetricCreateAttributes struct {
	...
	Filter RumMetricFilter `json:"filter"`
...
func NewRumMetricCreateAttributes(compute RumMetricCompute, eventType RumMetricEventType, filter RumMetricFilter) *RumMetricCreateAttributes {
