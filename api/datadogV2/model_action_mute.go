...
type ActionMute struct {
	...
	EnabledUntil *int64 `json:"enabled_until,omitempty"`
...
// GetEnabledUntil returns the EnabledUntil field value if set, zero value otherwise.
func (o *ActionMute) GetEnabledUntil() int64 {
	if o == nil || o.EnabledUntil == nil {
		var ret int64
		return ret
	}
	return *o.EnabledUntil
}

// GetEnabledUntilOk returns a tuple with the EnabledUntil field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionMute) GetEnabledUntilOk() (*int64, bool) {
	if o == nil || o.EnabledUntil == nil {
		return nil, false
	}
	return o.EnabledUntil, true
}

// HasEnabledUntil returns a boolean if a field has been set.
func (o *ActionMute) HasEnabledUntil() bool {
	return o != nil && o.EnabledUntil != nil
}

// SetEnabledUntil gets a reference to the given int64 and assigns it to the EnabledUntil field.
func (o *ActionMute) SetEnabledUntil(v int64) {
	o.EnabledUntil = &v
}
...
func (o ActionMute) MarshalJSON() ([]byte, error) {
	...
	if o.EnabledUntil != nil {
		toSerialize["enabled_until"] = o.EnabledUntil
	}
...
func (o *ActionMute) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = datadog.Unmarshal(bytes, &additionalProperties); err == nil {
		datadog.DeleteKeys(additionalProperties, &[]string{"enabled_until", "reason", "reason_description"})
	} else {
		return err
	}

	hasInvalidField := false
	o.EnabledUntil = all.EnabledUntil
