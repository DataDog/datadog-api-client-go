...
// NullableSpansSortOrder handles when a null is used for SpansSortOrder.
type NullableSpansSortOrder struct {
	value *SpansSortOrder
	isSet bool
}

// Get returns the associated value.
func (v NullableSpansSortOrder) Get() *SpansSortOrder {
	return v.value
}

// Set changes the value and indicates it's been called.
func (v *NullableSpansSortOrder) Set(val *SpansSortOrder) {
	v.value = val
	v.isSet = true
}

// IsSet returns whether Set has been called.
func (v NullableSpansSortOrder) IsSet() bool {
	return v.isSet
}

// Unset sets the value to nil and resets the set flag.
func (v *NullableSpansSortOrder) Unset() {
	v.value = nil
	v.isSet = false
}

// NewNullableSpansSortOrder initializes the struct as if Set has been called.
func NewNullableSpansSortOrder(val *SpansSortOrder) *NullableSpansSortOrder {
	return &NullableSpansSortOrder{value: val, isSet: true}
}

// MarshalJSON serializes the associated value.
func (v NullableSpansSortOrder) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

// UnmarshalJSON deserializes the payload and sets the flag as if Set has been called.
func (v *NullableSpansSortOrder) UnmarshalJSON(src []byte) error {
	v.isSet = true
