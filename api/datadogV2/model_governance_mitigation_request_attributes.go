...
func NewGovernanceMitigationRequestAttributes(detectionIds []string, detectionType string) *GovernanceMitigationRequestAttributes {
...
// GetDetectionIds returns the DetectionIds field value.
...
// GetDetectionIdsOk returns a tuple with the DetectionIds field value
...
// SetDetectionIds sets field value.
...
func (o *GovernanceMitigationRequestAttributes) UnmarshalJSON(bytes []byte) (err error) {
	...
	if all.DetectionIds == nil {
		return fmt.Errorf("required field detection_ids missing")
	}
