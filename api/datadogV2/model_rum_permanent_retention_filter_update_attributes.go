...
// RumPermanentRetentionFilterUpdateAttributes The attributes of a permanent retention filter that can be updated.
type RumPermanentRetentionFilterUpdateAttributes struct {
	...
	CrossProductSampling *RumPermanentCrossProductSamplingUpdate `json:"cross_product_sampling,omitempty"`
...
func (o *RumPermanentRetentionFilterUpdateAttributes) GetCrossProductSampling() RumPermanentCrossProductSamplingUpdate {
	if o == nil || o.CrossProductSampling == nil {
		var ret RumPermanentCrossProductSamplingUpdate
		return ret
	}
...
func (o *RumPermanentRetentionFilterUpdateAttributes) GetCrossProductSamplingOk() (*RumPermanentCrossProductSamplingUpdate, bool) {
	if o == nil || o.CrossProductSampling == nil {
		return nil, false
	}
...
// SetCrossProductSampling gets a reference to the given RumPermanentCrossProductSamplingUpdate and assigns it to the CrossProductSampling field.
func (o *RumPermanentRetentionFilterUpdateAttributes) SetCrossProductSampling(v RumPermanentCrossProductSamplingUpdate) {
