...
// NullableSpansGroupByTotal handles when a null is used for SpansGroupByTotal.
type NullableSpansGroupByTotal struct {
	value *SpansGroupByTotal
	isSet bool
}

// Get returns the associated value.
func (v NullableSpansGroupByTotal) Get() *SpansGroupByTotal {
	return v.value
}

// Set changes the value and indicates it's been called.
func (v *NullableSpansGroupByTotal) Set(val *SpansGroupByTotal) {
	v.value = val
	v.isSet = true
}

// IsSet returns whether Set has been called.
func (v NullableSpansGroupByTotal) IsSet() bool {
	return v.isSet
}

// Unset sets the value to nil and resets the set flag/
func (v *NullableSpansGroupByTotal) Unset() {
	v.value = nil
	v.isSet = false
}

// NewNullableSpansGroupByTotal initializes the struct as if Set has been called.
func NewNullableSpansGroupByTotal(val *SpansGroupByTotal) *NullableSpansGroupByTotal {
	return &NullableSpansGroupByTotal{value: val, isSet: true}
}

// MarshalJSON serializes the associated value.
func (v NullableSpansGroupByTotal) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

// UnmarshalJSON deserializes the payload and sets the flag as if Set has been called.
func (v *NullableSpansGroupByTotal) UnmarshalJSON(src []byte) error {
	v.isSet = true
