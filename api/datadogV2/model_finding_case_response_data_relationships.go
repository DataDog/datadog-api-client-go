...
type FindingCaseResponseDataRelationships struct {
	//
	CreatedBy *SecurityUser `json:"created_by,omitempty"`
	//
	ModifiedBy *SecurityUser `json:"modified_by,omitempty"`
	//
...
func (o *FindingCaseResponseDataRelationships) GetCreatedBy() SecurityUser {
...
func (o *FindingCaseResponseDataRelationships) GetCreatedByOk() (*SecurityUser, bool) {
	if o == nil || o.CreatedBy == nil {
		return nil, false
	}
...
// SetCreatedBy gets a reference to the given SecurityUser and assigns it to the CreatedBy field.
func (o *FindingCaseResponseDataRelationships) SetCreatedBy(v SecurityUser) {
	o.CreatedBy = &v
}

// GetModifiedBy returns the ModifiedBy field value if set, zero value otherwise.
func (o *FindingCaseResponseDataRelationships) GetModifiedBy() SecurityUser {
...
// and a boolean to check if the value has been set.
func (o *FindingCaseResponseDataRelationships) GetModifiedByOk() (*SecurityUser, bool) {
	if o == nil || o.ModifiedBy == nil {
		return nil, false
	}
...
// SetModifiedBy gets a reference to the given SecurityUser and assigns it to the ModifiedBy field.
func (o *FindingCaseResponseDataRelationships) SetModifiedBy(v SecurityUser) {
	o.ModifiedBy = &v
}
