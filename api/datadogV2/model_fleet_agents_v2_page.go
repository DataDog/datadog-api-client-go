...
// FleetAgentsV2Page Pagination details for the v2 list of agents.
type FleetAgentsV2Page struct {
...
// NewFleetAgentsV2Page instantiates a new FleetAgentsV2Page object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewFleetAgentsV2Page() *FleetAgentsV2Page {
	this := FleetAgentsV2Page{}
	return &this
}

// NewFleetAgentsV2PageWithDefaults instantiates a new FleetAgentsV2Page object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewFleetAgentsV2PageWithDefaults() *FleetAgentsV2Page {
	this := FleetAgentsV2Page{}
	return &this
}

// GetTotalCount returns the TotalCount field value if set, zero value otherwise.
func (o *FleetAgentsV2Page) GetTotalCount() int64 {
...
func (o *FleetAgentsV2Page) GetTotalCountOk() (*int64, bool) {
	if o == nil || o.TotalCount == nil {
		return nil, false
	}
...
func (o *FleetAgentsV2Page) HasTotalCount() bool {
	return o != nil && o.TotalCount != nil
}

// SetTotalCount gets a reference to the given int64 and assigns it to the TotalCount field.
func (o *FleetAgentsV2Page) SetTotalCount(v int64) {
	o.TotalCount = &v
}

// GetTotalFilteredCount returns the TotalFilteredCount field value if set, zero value otherwise.
func (o *FleetAgentsV2Page) GetTotalFilteredCount() int64 {
...
// and a boolean to check if the value has been set.
func (o *FleetAgentsV2Page) GetTotalFilteredCountOk() (*int64, bool) {
	if o == nil || o.TotalFilteredCount == nil {
		return nil, false
	}
...
func (o *FleetAgentsV2Page) HasTotalFilteredCount() bool {
...
func (o *FleetAgentsV2Page) SetTotalFilteredCount(v int64) {
	o.TotalFilteredCount = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o FleetAgentsV2Page) MarshalJSON() ([]byte, error) {
...
func (o *FleetAgentsV2Page) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		TotalCount         *int64 `json:"total_count,omitempty"`
		TotalFilteredCount *int64 `json:"total_filtered_count,omitempty"`
	}{}
