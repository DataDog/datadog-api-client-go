...
func NewAWSNamespacesResponseAttributes() *AWSNamespacesResponseAttributes {
...
func (o *AWSNamespacesResponseAttributes) GetNamespace() string {
...
func (o *AWSNamespacesResponseAttributes) GetNamespaceOk() (*string, bool) {
	if o == nil || o.Namespace == nil {
		return nil, false
	}
...
func (o *AWSNamespacesResponseAttributes) HasNamespace() bool {
	return o != nil && o.Namespace != nil
}

// SetNamespace gets a reference to the given string and assigns it to the Namespace field.
func (o *AWSNamespacesResponseAttributes) SetNamespace(v string) {
	o.Namespace = &v
}
...
func (o *AWSNamespacesResponseAttributes) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = datadog.Unmarshal(bytes, &additionalProperties); err == nil {
		datadog.DeleteKeys(additionalProperties, &[]string{"namespace"})
	} else {
		return err
	}
