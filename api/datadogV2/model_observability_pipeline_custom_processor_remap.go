...
func NewObservabilityPipelineCustomProcessorRemap(include string, name string, source string) *ObservabilityPipelineCustomProcessorRemap {
...
func (o *ObservabilityPipelineCustomProcessorRemap) HasDropOnError() bool {
