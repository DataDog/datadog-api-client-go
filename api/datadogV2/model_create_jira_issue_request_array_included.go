...
// CreateJiraIssueRequestArrayIncluded - Attributes and relationships of the case linked to the Jira issue. Should contain all of the following: case, project, and findings.
