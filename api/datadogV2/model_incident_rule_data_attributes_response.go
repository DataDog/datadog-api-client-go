...
type IncidentRuleDataAttributesResponse struct {
	...
	ConditionTableType *int32 `json:"condition_table_type,omitempty"`
	...
	ExecutionType *int32 `json:"execution_type,omitempty"`
...
func (o *IncidentRuleDataAttributesResponse) GetConditionTableType() int32 {
...
// and a boolean to check if the value has been set.
func (o *IncidentRuleDataAttributesResponse) GetConditionTableTypeOk() (*int32, bool) {
	if o == nil || o.ConditionTableType == nil {
		return nil, false
	}
...
// SetConditionTableType gets a reference to the given int32 and assigns it to the ConditionTableType field.
func (o *IncidentRuleDataAttributesResponse) SetConditionTableType(v int32) {
...
func (o *IncidentRuleDataAttributesResponse) GetExecutionType() int32 {
...
// and a boolean to check if the value has been set.
func (o *IncidentRuleDataAttributesResponse) GetExecutionTypeOk() (*int32, bool) {
	if o == nil || o.ExecutionType == nil {
		return nil, false
	}
...
// SetExecutionType gets a reference to the given int32 and assigns it to the ExecutionType field.
func (o *IncidentRuleDataAttributesResponse) SetExecutionType(v int32) {
	o.ExecutionType = &v
}
