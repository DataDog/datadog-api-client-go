...
// BulkPutDatastoreItems Bulk put datastore items.
// Creates or replaces multiple items in a datastore by their keys in a single operation.
func (a *ActionsDatastoresApi) BulkPutDatastoreItems(ctx _context.Context, datastoreId string, body BulkPutAppsDatastoreItemsRequest) (PutAppsDatastoreItemResponseArray, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.ActionsDatastoresApi.BulkPutDatastoreItems")
	if err != nil {
...
// CreateDatastoreFromImport Create datastore from import.
// Creates a new datastore and populates it with items from the provided data.
func (a *ActionsDatastoresApi) CreateDatastoreFromImport(ctx _context.Context, body CreateAppsDatastoreFromImportRequest) (CreateAppsDatastoreFromImportResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue CreateAppsDatastoreFromImportResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.ActionsDatastoresApi.CreateDatastoreFromImport")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/actions-datastores/import"
...
// PutDatastoreItem Put datastore item.
// Creates or replaces an item in a datastore by its key.
func (a *ActionsDatastoresApi) PutDatastoreItem(ctx _context.Context, datastoreId string, body PutAppsDatastoreItemRequest) (PutAppsDatastoreItemResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue PutAppsDatastoreItemResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.ActionsDatastoresApi.PutDatastoreItem")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
