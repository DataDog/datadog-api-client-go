...
func NewObservabilityPipelinePrometheusRemoteWriteSource(authStrategy ObservabilityPipelinePrometheusRemoteWriteSourceAuthStrategy, id string, path string, typeVar ObservabilityPipelinePrometheusRemoteWriteSourceType) *ObservabilityPipelinePrometheusRemoteWriteSource {
