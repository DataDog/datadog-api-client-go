...
// IncidentUserDefinedRoleIncludedItem - A single included resource in a user-defined role response.
type IncidentUserDefinedRoleIncludedItem struct {
...
// IncidentUserDataAsIncidentUserDefinedRoleIncludedItem is a convenience function that returns IncidentUserData wrapped in IncidentUserDefinedRoleIncludedItem.
func IncidentUserDataAsIncidentUserDefinedRoleIncludedItem(v *IncidentUserData) IncidentUserDefinedRoleIncludedItem {
	return IncidentUserDefinedRoleIncludedItem{IncidentUserData: v}
}

// IncidentTypeObjectAsIncidentUserDefinedRoleIncludedItem is a convenience function that returns IncidentTypeObject wrapped in IncidentUserDefinedRoleIncludedItem.
func IncidentTypeObjectAsIncidentUserDefinedRoleIncludedItem(v *IncidentTypeObject) IncidentUserDefinedRoleIncludedItem {
	return IncidentUserDefinedRoleIncludedItem{IncidentTypeObject: v}
}

// UnmarshalJSON turns data into one of the pointers in the struct.
func (obj *IncidentUserDefinedRoleIncludedItem) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
...
func (obj IncidentUserDefinedRoleIncludedItem) MarshalJSON() ([]byte, error) {
...
func (obj *IncidentUserDefinedRoleIncludedItem) GetActualInstance() interface{} {
	if obj.IncidentUserData != nil {
