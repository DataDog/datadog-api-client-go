...
// IncidentResponderCreatedTrigger Trigger a workflow when a responder is created for an incident.
type IncidentResponderCreatedTrigger struct {
...
// NewIncidentResponderCreatedTrigger instantiates a new IncidentResponderCreatedTrigger object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewIncidentResponderCreatedTrigger() *IncidentResponderCreatedTrigger {
	this := IncidentResponderCreatedTrigger{}
	return &this
}

// NewIncidentResponderCreatedTriggerWithDefaults instantiates a new IncidentResponderCreatedTrigger object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewIncidentResponderCreatedTriggerWithDefaults() *IncidentResponderCreatedTrigger {
	this := IncidentResponderCreatedTrigger{}
	return &this
}

// GetExecutionLimit returns the ExecutionLimit field value if set, zero value otherwise.
func (o *IncidentResponderCreatedTrigger) GetExecutionLimit() ExecutionLimit {
...
func (o *IncidentResponderCreatedTrigger) GetExecutionLimitOk() (*ExecutionLimit, bool) {
	if o == nil || o.ExecutionLimit == nil {
		return nil, false
	}
...
func (o *IncidentResponderCreatedTrigger) HasExecutionLimit() bool {
...
func (o *IncidentResponderCreatedTrigger) SetExecutionLimit(v ExecutionLimit) {
	o.ExecutionLimit = &v
}

// GetIncidentType returns the IncidentType field value if set, zero value otherwise.
func (o *IncidentResponderCreatedTrigger) GetIncidentType() string {
...
// and a boolean to check if the value has been set.
func (o *IncidentResponderCreatedTrigger) GetIncidentTypeOk() (*string, bool) {
	if o == nil || o.IncidentType == nil {
		return nil, false
	}
...
func (o *IncidentResponderCreatedTrigger) HasIncidentType() bool {
...
func (o *IncidentResponderCreatedTrigger) SetIncidentType(v string) {
	o.IncidentType = &v
}

// GetTagCondition returns the TagCondition field value if set, zero value otherwise.
func (o *IncidentResponderCreatedTrigger) GetTagCondition() IncidentCondition {
...
// and a boolean to check if the value has been set.
func (o *IncidentResponderCreatedTrigger) GetTagConditionOk() (*IncidentCondition, bool) {
	if o == nil || o.TagCondition == nil {
		return nil, false
	}
...
func (o *IncidentResponderCreatedTrigger) HasTagCondition() bool {
...
func (o *IncidentResponderCreatedTrigger) SetTagCondition(v IncidentCondition) {
	o.TagCondition = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o IncidentResponderCreatedTrigger) MarshalJSON() ([]byte, error) {
...
func (o *IncidentResponderCreatedTrigger) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		ExecutionLimit *ExecutionLimit    `json:"executionLimit,omitempty"`
		IncidentType   *string            `json:"incidentType,omitempty"`
		TagCondition   *IncidentCondition `json:"tagCondition,omitempty"`
