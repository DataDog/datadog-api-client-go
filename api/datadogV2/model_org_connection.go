...
type OrgConnection struct {
	...
	Relationships *OrgConnectionRelationships `json:"relationships,omitempty"`
	// Org connection type.
...
func NewOrgConnection(attributes OrgConnectionAttributes, id uuid.UUID, typeVar OrgConnectionType) *OrgConnection {
	this := OrgConnection{}
...
func (o *OrgConnection) HasRelationships() bool {
	return o != nil && o.Relationships != nil
}

// SetRelationships gets a reference to the given OrgConnectionRelationships and assigns it to the Relationships field.
