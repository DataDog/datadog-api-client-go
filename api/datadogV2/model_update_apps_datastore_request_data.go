...
// UpdateAppsDatastoreRequestData The definition of `UpdateAppsDatastoreRequestData` object.
type UpdateAppsDatastoreRequestData struct {
	...
	Type UpdateAppsDatastoreRequestDataType `json:"type"`
...
func NewUpdateAppsDatastoreRequestData(typeVar UpdateAppsDatastoreRequestDataType) *UpdateAppsDatastoreRequestData {
...
func NewUpdateAppsDatastoreRequestDataWithDefaults() *UpdateAppsDatastoreRequestData {
	this := UpdateAppsDatastoreRequestData{}
	var typeVar UpdateAppsDatastoreRequestDataType = UPDATEAPPSDATASTOREREQUESTDATATYPE_DATASTORES
	this.Type = typeVar
	return &this
}
...
func (o *UpdateAppsDatastoreRequestData) GetType() UpdateAppsDatastoreRequestDataType {
	if o == nil {
		var ret UpdateAppsDatastoreRequestDataType
		return ret
	}
	return o.Type
}
...
// and a boolean to check if the value has been set.
func (o *UpdateAppsDatastoreRequestData) GetTypeOk() (*UpdateAppsDatastoreRequestDataType, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *UpdateAppsDatastoreRequestData) SetType(v UpdateAppsDatastoreRequestDataType) {
	o.Type = v
}
