...
func NewCreateMuteRuleParametersDataAttributes(action ActionMute, name string, rule Rule) *CreateMuteRuleParametersDataAttributes {
...
func (o *CreateMuteRuleParametersDataAttributes) GetRule() Rule {
	if o == nil {
		var ret Rule
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreateMuteRuleParametersDataAttributes) GetRuleOk() (*Rule, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Rule, true
...
func (o *CreateMuteRuleParametersDataAttributes) SetRule(v Rule) {
	o.Rule = v
}
