...
// EmailUpdateRequest Request body for updating an On-Call email notification channel.
...
func (o *EmailUpdateRequest) GetData() EmailData {
	if o == nil || o.Data == nil {
		var ret EmailData
		return ret
	}
...
func (o *EmailUpdateRequest) GetDataOk() (*EmailData, bool) {
	if o == nil || o.Data == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *EmailUpdateRequest) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Data *EmailData `json:"data,omitempty"`
	}{}
