...
// NullableSpansAggregateSortType handles when a null is used for SpansAggregateSortType.
type NullableSpansAggregateSortType struct {
	value *SpansAggregateSortType
	isSet bool
}

// Get returns the associated value.
func (v NullableSpansAggregateSortType) Get() *SpansAggregateSortType {
	return v.value
}

// Set changes the value and indicates it's been called.
func (v *NullableSpansAggregateSortType) Set(val *SpansAggregateSortType) {
	v.value = val
	v.isSet = true
}

// IsSet returns whether Set has been called.
func (v NullableSpansAggregateSortType) IsSet() bool {
	return v.isSet
}

// Unset sets the value to nil and resets the set flag.
func (v *NullableSpansAggregateSortType) Unset() {
	v.value = nil
	v.isSet = false
}

// NewNullableSpansAggregateSortType initializes the struct as if Set has been called.
func NewNullableSpansAggregateSortType(val *SpansAggregateSortType) *NullableSpansAggregateSortType {
	return &NullableSpansAggregateSortType{value: val, isSet: true}
}

// MarshalJSON serializes the associated value.
func (v NullableSpansAggregateSortType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

// UnmarshalJSON deserializes the payload and sets the flag as if Set has been called.
func (v *NullableSpansAggregateSortType) UnmarshalJSON(src []byte) error {
	v.isSet = true
