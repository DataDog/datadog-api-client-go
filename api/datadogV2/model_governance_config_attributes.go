...
type GovernanceConfigAttributes struct {
	...
	XorgInsightsEnabled bool `json:"xorg_insights_enabled"`
...
func NewGovernanceConfigAttributes(assignmentNotificationsEnabled bool, enabled bool, usageAttributionConfigured bool, xorgInsightsEnabled bool) *GovernanceConfigAttributes {
...
// GetXorgInsightsEnabled returns the XorgInsightsEnabled field value.
func (o *GovernanceConfigAttributes) GetXorgInsightsEnabled() bool {
	if o == nil {
		var ret bool
		return ret
	}
	return o.XorgInsightsEnabled
}

// GetXorgInsightsEnabledOk returns a tuple with the XorgInsightsEnabled field value
// and a boolean to check if the value has been set.
func (o *GovernanceConfigAttributes) GetXorgInsightsEnabledOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.XorgInsightsEnabled, true
}

// SetXorgInsightsEnabled sets field value.
func (o *GovernanceConfigAttributes) SetXorgInsightsEnabled(v bool) {
	o.XorgInsightsEnabled = v
}
...
func (o GovernanceConfigAttributes) MarshalJSON() ([]byte, error) {
	...
	toSerialize["xorg_insights_enabled"] = o.XorgInsightsEnabled
...
func (o *GovernanceConfigAttributes) UnmarshalJSON(bytes []byte) (err error) {
	...
	if all.XorgInsightsEnabled == nil {
		return fmt.Errorf("required field xorg_insights_enabled missing")
	}
	additionalProperties := make(map[string]interface{})
	if err = datadog.UnmarshalUseNumber(bytes, &additionalProperties); err == nil {
		datadog.DeleteKeys(additionalProperties, &[]string{"assignment_notifications_enabled", "enabled", "usage_attribution_configured", "xorg_insights_enabled"})
	} else {
		return err
	}
	...
	o.XorgInsightsEnabled = *all.XorgInsightsEnabled
