...
// IntegrationAccountBasicAuthRequestAsTwilioIntegrationAccountAuthenticationRequest is a convenience function that returns IntegrationAccountBasicAuthRequest wrapped in TwilioIntegrationAccountAuthenticationRequest.
func IntegrationAccountBasicAuthRequestAsTwilioIntegrationAccountAuthenticationRequest(v *IntegrationAccountBasicAuthRequest) TwilioIntegrationAccountAuthenticationRequest {
	return TwilioIntegrationAccountAuthenticationRequest{IntegrationAccountBasicAuthRequest: v}
}
