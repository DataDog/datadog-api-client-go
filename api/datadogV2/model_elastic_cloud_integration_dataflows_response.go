...
func (o *ElasticCloudIntegrationDataflowsResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = datadog.UnmarshalUseNumber(bytes, &additionalProperties); err == nil {
		datadog.DeleteKeys(additionalProperties, &[]string{"elastic-cloud-detailed-index-stats", "elastic-cloud-index-stats", "elastic-cloud-metrics", "elastic-cloud-pending-task-stats", "elastic-cloud-primary-shard-graceful-timeout", "elastic-cloud-primary-shard-stats", "elastic-cloud-shard-allocation-stats", "elastic-cloud-slm-stats"})
	} else {
		return err
	}
