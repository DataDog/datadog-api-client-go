...
func (o *SingleAggregatedDnsResponseDataAttributesGroupByItems) GetValue() map[string][]string {
...
// and a boolean to check if the value has been set.
func (o *SingleAggregatedDnsResponseDataAttributesGroupByItems) GetValueOk() (*map[string][]string, bool) {
	if o == nil || o.Value == nil {
		return nil, false
	}
	return &o.Value, true
...
func (o *SingleAggregatedDnsResponseDataAttributesGroupByItems) SetValue(v map[string][]string) {
	o.Value = v
}
