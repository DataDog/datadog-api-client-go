...
func (o *CreateStatusPageRequestDataAttributesComponentsItems) GetId() string {
	if o == nil || o.Id == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreateStatusPageRequestDataAttributesComponentsItems) GetIdOk() (*string, bool) {
	if o == nil || o.Id == nil {
		return nil, false
	}
	return o.Id, true
...
func (o *CreateStatusPageRequestDataAttributesComponentsItems) SetId(v string) {
	o.Id = &v
}
