...
// LLMObsCreatePromptVersionDataAttributes Attributes for creating a new version of an Agent Observability prompt. `template` is required; all other attributes are optional. If `config` is omitted, the latest version's configuration is carried forward. An explicit empty object clears it. Configuration authoring must be enabled for your organization to supply `config`. Otherwise, supplying it, including an empty object, returns HTTP 403. Omitting `config` still carries forward the latest configuration.
...
func (o *LLMObsCreatePromptVersionDataAttributes) GetConfig() map[string]interface{} {
...
func (o *LLMObsCreatePromptVersionDataAttributes) GetConfigOk() (*map[string]interface{}, bool) {
	if o == nil || o.Config == nil {
		return nil, false
	}
...
func (o *LLMObsCreatePromptVersionDataAttributes) HasConfig() bool {
	return o != nil && o.Config != nil
}

// SetConfig gets a reference to the given map[string]interface{} and assigns it to the Config field.
func (o *LLMObsCreatePromptVersionDataAttributes) SetConfig(v map[string]interface{}) {
	o.Config = v
}
...
func (o *LLMObsCreatePromptVersionDataAttributes) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = datadog.UnmarshalUseNumber(bytes, &additionalProperties); err == nil {
		datadog.DeleteKeys(additionalProperties, &[]string{"config", "description", "env_ids", "labels", "template", "user_version"})
	} else {
		return err
	}
	o.Config = all.Config
