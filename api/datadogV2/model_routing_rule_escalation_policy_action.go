...
// RoutingRuleEscalationPolicyAction Routes the page to an escalation policy, optionally restricted to business hours.
...
func (o *RoutingRuleEscalationPolicyAction) GetSupportHours() TimeRestrictions {
...
// and a boolean to check if the value has been set.
func (o *RoutingRuleEscalationPolicyAction) GetSupportHoursOk() (*TimeRestrictions, bool) {
	if o == nil || o.SupportHours == nil {
		return nil, false
	}
...
func (o *RoutingRuleEscalationPolicyAction) SetSupportHours(v TimeRestrictions) {
	o.SupportHours = &v
}
