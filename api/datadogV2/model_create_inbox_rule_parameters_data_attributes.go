...
func NewCreateInboxRuleParametersDataAttributes(action ActionInbox, name string, rule Rule) *CreateInboxRuleParametersDataAttributes {
...
func (o *CreateInboxRuleParametersDataAttributes) GetRule() Rule {
	if o == nil {
		var ret Rule
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreateInboxRuleParametersDataAttributes) GetRuleOk() (*Rule, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Rule, true
...
func (o *CreateInboxRuleParametersDataAttributes) SetRule(v Rule) {
	o.Rule = v
}
