...
func NewMuteRuleAttributes(action ActionMute, createdAt int64, createdBy RuleUser, enabled bool, modifiedAt int64, modifiedBy RuleUser, name string, rule Rule) *MuteRuleAttributes {
...
func (o *MuteRuleAttributes) GetCreatedBy() RuleUser {
	if o == nil {
		var ret RuleUser
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *MuteRuleAttributes) GetCreatedByOk() (*RuleUser, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MuteRuleAttributes) SetCreatedBy(v RuleUser) {
	o.CreatedBy = v
}
...
func (o *MuteRuleAttributes) GetModifiedBy() RuleUser {
	if o == nil {
		var ret RuleUser
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *MuteRuleAttributes) GetModifiedByOk() (*RuleUser, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MuteRuleAttributes) SetModifiedBy(v RuleUser) {
	o.ModifiedBy = v
}
...
func (o *MuteRuleAttributes) GetRule() Rule {
	if o == nil {
		var ret Rule
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *MuteRuleAttributes) GetRuleOk() (*Rule, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Rule, true
...
func (o *MuteRuleAttributes) SetRule(v Rule) {
	o.Rule = v
}
