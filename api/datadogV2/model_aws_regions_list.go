...
// AWSRegionsList AWS Regions to collect data from
type AWSRegionsList struct {
	// Include all regions
...
// NewAWSRegionsList instantiates a new AWSRegionsList object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewAWSRegionsList() *AWSRegionsList {
	this := AWSRegionsList{}
	return &this
}

// NewAWSRegionsListWithDefaults instantiates a new AWSRegionsList object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewAWSRegionsListWithDefaults() *AWSRegionsList {
	this := AWSRegionsList{}
	return &this
}

// GetIncludeAll returns the IncludeAll field value if set, zero value otherwise.
func (o *AWSRegionsList) GetIncludeAll() bool {
...
func (o *AWSRegionsList) GetIncludeAllOk() (*bool, bool) {
	if o == nil || o.IncludeAll == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *AWSRegionsList) GetIncludeOnlyOk() (*[]string, bool) {
	if o == nil || o.IncludeOnly == nil {
		return nil, false
	}
...
func (o *AWSRegionsList) HasIncludeOnly() bool {
...
func (o *AWSRegionsList) SetIncludeOnly(v []string) {
	o.IncludeOnly = v
}

// MarshalJSON serializes the struct using spec logic.
func (o AWSRegionsList) MarshalJSON() ([]byte, error) {
...
func (o *AWSRegionsList) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		IncludeAll  *bool    `json:"include_all,omitempty"`
		IncludeOnly []string `json:"include_only,omitempty"`
	}{}
