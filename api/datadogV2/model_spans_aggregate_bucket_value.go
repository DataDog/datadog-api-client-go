...
// NullableSpansAggregateBucketValue handles when a null is used for SpansAggregateBucketValue.
type NullableSpansAggregateBucketValue struct {
	value *SpansAggregateBucketValue
	isSet bool
}

// Get returns the associated value.
func (v NullableSpansAggregateBucketValue) Get() *SpansAggregateBucketValue {
	return v.value
}

// Set changes the value and indicates it's been called.
func (v *NullableSpansAggregateBucketValue) Set(val *SpansAggregateBucketValue) {
	v.value = val
	v.isSet = true
}

// IsSet returns whether Set has been called.
func (v NullableSpansAggregateBucketValue) IsSet() bool {
	return v.isSet
}

// Unset sets the value to nil and resets the set flag/
func (v *NullableSpansAggregateBucketValue) Unset() {
	v.value = nil
	v.isSet = false
}

// NewNullableSpansAggregateBucketValue initializes the struct as if Set has been called.
func NewNullableSpansAggregateBucketValue(val *SpansAggregateBucketValue) *NullableSpansAggregateBucketValue {
	return &NullableSpansAggregateBucketValue{value: val, isSet: true}
}

// MarshalJSON serializes the associated value.
func (v NullableSpansAggregateBucketValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

// UnmarshalJSON deserializes the payload and sets the flag as if Set has been called.
func (v *NullableSpansAggregateBucketValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
