...
func NewGCPUsageCostConfigWithDefaults() *GCPUsageCostConfig {
	this := GCPUsageCostConfig{}
	var typeVar GCPUsageCostConfigType = GCPUSAGECOSTCONFIGTYPE_GCP_USAGE_COST_CONFIG
	this.Type = typeVar
	return &this
}
...
func (o *GCPUsageCostConfig) GetId() int64 {
	if o == nil || o.Id == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GCPUsageCostConfig) GetIdOk() (*int64, bool) {
	if o == nil || o.Id == nil {
		return nil, false
	}
	return o.Id, true
...
func (o *GCPUsageCostConfig) SetId(v int64) {
	o.Id = &v
}
