...
// ObservabilityPipelineAmazonS3Source The `aws_s3` source ingests logs from an Amazon S3 bucket.
...
func NewObservabilityPipelineAmazonS3SourceWithDefaults() *ObservabilityPipelineAmazonS3Source {
	this := ObservabilityPipelineAmazonS3Source{}
	var typeVar ObservabilityPipelineAmazonS3SourceType = OBSERVABILITYPIPELINEAMAZONS3SOURCETYPE_AWS_S3
	this.Type = typeVar
	return &this
}
