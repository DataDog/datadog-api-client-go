...
func NewObservabilityPipelineReduceProcessor(groupBy []string, id string, include string, mergeStrategies []ObservabilityPipelineReduceProcessorMergeStrategy, typeVar ObservabilityPipelineReduceProcessorType) *ObservabilityPipelineReduceProcessor {
...
func (o *ObservabilityPipelineReduceProcessor) HasInputs() bool {
