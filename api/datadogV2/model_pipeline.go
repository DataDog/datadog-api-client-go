...
// Pipeline Top-level schema representing a pipeline.
...
func NewPipeline(data PipelineData) *Pipeline {
	this := Pipeline{}
	this.Data = data
	return &this
}
...
func (o *Pipeline) GetData() PipelineData {
	if o == nil {
		var ret PipelineData
		return ret
	}
	return o.Data
}
...
func (o *Pipeline) GetDataOk() (*PipelineData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *Pipeline) SetData(v PipelineData) {
	o.Data = v
}
