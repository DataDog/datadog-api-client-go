...
type IncidentTypeRelationships struct {
	...
	GoogleMeetConfiguration NullableIncidentTypeRelationshipsGoogleMeetConfiguration `json:"google_meet_configuration,omitempty"`
	// Relationship to user.
	...
	MicrosoftTeamsConfiguration NullableIncidentTypeRelationshipsMicrosoftTeamsConfiguration `json:"microsoft_teams_configuration,omitempty"`
	// The definition of `IncidentTypeRelationshipsZoomConfiguration` object.
	ZoomConfiguration NullableIncidentTypeRelationshipsZoomConfiguration `json:"zoom_configuration,omitempty"`
...
func (o *IncidentTypeRelationships) GetGoogleMeetConfiguration() IncidentTypeRelationshipsGoogleMeetConfiguration {
	if o == nil || o.GoogleMeetConfiguration.Get() == nil {
		var ret IncidentTypeRelationshipsGoogleMeetConfiguration
		return ret
	}
...
func (o *IncidentTypeRelationships) GetGoogleMeetConfigurationOk() (*IncidentTypeRelationshipsGoogleMeetConfiguration, bool) {
	if o == nil {
		return nil, false
	}
...
// SetGoogleMeetConfiguration gets a reference to the given NullableIncidentTypeRelationshipsGoogleMeetConfiguration and assigns it to the GoogleMeetConfiguration field.
func (o *IncidentTypeRelationships) SetGoogleMeetConfiguration(v IncidentTypeRelationshipsGoogleMeetConfiguration) {
...
func (o *IncidentTypeRelationships) GetMicrosoftTeamsConfiguration() IncidentTypeRelationshipsMicrosoftTeamsConfiguration {
	if o == nil || o.MicrosoftTeamsConfiguration.Get() == nil {
		var ret IncidentTypeRelationshipsMicrosoftTeamsConfiguration
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned.
func (o *IncidentTypeRelationships) GetMicrosoftTeamsConfigurationOk() (*IncidentTypeRelationshipsMicrosoftTeamsConfiguration, bool) {
	if o == nil {
		return nil, false
	}
...
// SetMicrosoftTeamsConfiguration gets a reference to the given NullableIncidentTypeRelationshipsMicrosoftTeamsConfiguration and assigns it to the MicrosoftTeamsConfiguration field.
func (o *IncidentTypeRelationships) SetMicrosoftTeamsConfiguration(v IncidentTypeRelationshipsMicrosoftTeamsConfiguration) {
...
func (o *IncidentTypeRelationships) GetZoomConfiguration() IncidentTypeRelationshipsZoomConfiguration {
	if o == nil || o.ZoomConfiguration.Get() == nil {
		var ret IncidentTypeRelationshipsZoomConfiguration
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned.
func (o *IncidentTypeRelationships) GetZoomConfigurationOk() (*IncidentTypeRelationshipsZoomConfiguration, bool) {
	if o == nil {
		return nil, false
	}
...
// SetZoomConfiguration gets a reference to the given NullableIncidentTypeRelationshipsZoomConfiguration and assigns it to the ZoomConfiguration field.
func (o *IncidentTypeRelationships) SetZoomConfiguration(v IncidentTypeRelationshipsZoomConfiguration) {
