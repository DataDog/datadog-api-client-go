...
func NewRestrictionPolicy(attributes Attributes, id string, typeVar RestrictionPolicyType) *RestrictionPolicy {
...
func (o *RestrictionPolicy) GetAttributes() Attributes {
	if o == nil {
		var ret Attributes
		return ret
	}
...
func (o *RestrictionPolicy) GetAttributesOk() (*Attributes, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RestrictionPolicy) SetAttributes(v Attributes) {
	o.Attributes = v
}
