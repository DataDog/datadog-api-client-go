...
// TeamNotificationRulesResponseMeta Metadata related to paging information that is included in the response when querying the team notification rules
...
func (o *TeamNotificationRulesResponseMeta) GetFirstNumber() int64 {
...
func (o *TeamNotificationRulesResponseMeta) GetFirstNumberOk() (*int64, bool) {
	if o == nil || o.FirstNumber == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *TeamNotificationRulesResponseMeta) GetLastNumberOk() (*int64, bool) {
	if o == nil || o.LastNumber == nil {
		return nil, false
	}
...
func (o *TeamNotificationRulesResponseMeta) GetNextNumberOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TeamNotificationRulesResponseMeta) HasNextNumber() bool {
...
func (o *TeamNotificationRulesResponseMeta) SetNextNumber(v int64) {
	o.NextNumber.Set(&v)
}

// SetNextNumberNil sets the value for NextNumber to be an explicit nil.
func (o *TeamNotificationRulesResponseMeta) SetNextNumberNil() {
	o.NextNumber.Set(nil)
}

// UnsetNextNumber ensures that no value is present for NextNumber, not even an explicit nil.
func (o *TeamNotificationRulesResponseMeta) UnsetNextNumber() {
	o.NextNumber.Unset()
}

// GetNumber returns the Number field value if set, zero value otherwise.
func (o *TeamNotificationRulesResponseMeta) GetNumber() int64 {
...
// and a boolean to check if the value has been set.
func (o *TeamNotificationRulesResponseMeta) GetNumberOk() (*int64, bool) {
	if o == nil || o.Number == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned.
func (o *TeamNotificationRulesResponseMeta) GetPrevNumberOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TeamNotificationRulesResponseMeta) HasPrevNumber() bool {
...
func (o *TeamNotificationRulesResponseMeta) SetPrevNumber(v int64) {
	o.PrevNumber.Set(&v)
}

// SetPrevNumberNil sets the value for PrevNumber to be an explicit nil.
func (o *TeamNotificationRulesResponseMeta) SetPrevNumberNil() {
	o.PrevNumber.Set(nil)
}

// UnsetPrevNumber ensures that no value is present for PrevNumber, not even an explicit nil.
func (o *TeamNotificationRulesResponseMeta) UnsetPrevNumber() {
	o.PrevNumber.Unset()
}

// GetSize returns the Size field value if set, zero value otherwise.
func (o *TeamNotificationRulesResponseMeta) GetSize() int64 {
	if o == nil || o.Size == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TeamNotificationRulesResponseMeta) GetSizeOk() (*int64, bool) {
	if o == nil || o.Size == nil {
		return nil, false
	}
	return o.Size, true
...
func (o *TeamNotificationRulesResponseMeta) HasSize() bool {
	return o != nil && o.Size != nil
}

// SetSize gets a reference to the given int64 and assigns it to the Size field.
func (o *TeamNotificationRulesResponseMeta) SetSize(v int64) {
	o.Size = &v
}

// GetTotal returns the Total field value if set, zero value otherwise.
func (o *TeamNotificationRulesResponseMeta) GetTotal() int64 {
...
// and a boolean to check if the value has been set.
func (o *TeamNotificationRulesResponseMeta) GetTotalOk() (*int64, bool) {
	if o == nil || o.Total == nil {
		return nil, false
	}
	return o.Total, true
...
func (o *TeamNotificationRulesResponseMeta) HasTotal() bool {
	return o != nil && o.Total != nil
}

// SetTotal gets a reference to the given int64 and assigns it to the Total field.
func (o *TeamNotificationRulesResponseMeta) SetTotal(v int64) {
	o.Total = &v
}

// GetType returns the Type field value if set, zero value otherwise.
func (o *TeamNotificationRulesResponseMeta) GetType() string {
	if o == nil || o.Type == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TeamNotificationRulesResponseMeta) GetTypeOk() (*string, bool) {
	if o == nil || o.Type == nil {
		return nil, false
	}
	return o.Type, true
...
func (o *TeamNotificationRulesResponseMeta) HasType() bool {
	return o != nil && o.Type != nil
}

// SetType gets a reference to the given string and assigns it to the Type field.
func (o *TeamNotificationRulesResponseMeta) SetType(v string) {
	o.Type = &v
}
