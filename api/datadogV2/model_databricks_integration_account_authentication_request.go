...
type DatabricksIntegrationAccountAuthenticationRequest struct {
	...
	DatabricksIntegrationAccountBearerTokenAuthRequest         *DatabricksIntegrationAccountBearerTokenAuthRequest
...
// DatabricksIntegrationAccountBearerTokenAuthRequestAsDatabricksIntegrationAccountAuthenticationRequest is a convenience function that returns DatabricksIntegrationAccountBearerTokenAuthRequest wrapped in DatabricksIntegrationAccountAuthenticationRequest.
func DatabricksIntegrationAccountBearerTokenAuthRequestAsDatabricksIntegrationAccountAuthenticationRequest(v *DatabricksIntegrationAccountBearerTokenAuthRequest) DatabricksIntegrationAccountAuthenticationRequest {
	return DatabricksIntegrationAccountAuthenticationRequest{DatabricksIntegrationAccountBearerTokenAuthRequest: v}
}
...
func (obj *DatabricksIntegrationAccountAuthenticationRequest) UnmarshalJSON(data []byte) error {
	...
	// try to unmarshal data into DatabricksIntegrationAccountBearerTokenAuthRequest
	err = datadog.Unmarshal(data, &obj.DatabricksIntegrationAccountBearerTokenAuthRequest)
	if err == nil {
		if obj.DatabricksIntegrationAccountBearerTokenAuthRequest != nil && obj.DatabricksIntegrationAccountBearerTokenAuthRequest.UnparsedObject == nil {
			jsonDatabricksIntegrationAccountBearerTokenAuthRequest, _ := datadog.Marshal(obj.DatabricksIntegrationAccountBearerTokenAuthRequest)
			if string(jsonDatabricksIntegrationAccountBearerTokenAuthRequest) == "{}" { // empty struct
				obj.DatabricksIntegrationAccountBearerTokenAuthRequest = nil
			} else {
				match++
			}
		} else {
...
func (obj DatabricksIntegrationAccountAuthenticationRequest) MarshalJSON() ([]byte, error) {
	...
	if obj.DatabricksIntegrationAccountBearerTokenAuthRequest != nil {
		return datadog.Marshal(&obj.DatabricksIntegrationAccountBearerTokenAuthRequest)
	}
...
func (obj *DatabricksIntegrationAccountAuthenticationRequest) GetActualInstance() interface{} {
	...
	if obj.DatabricksIntegrationAccountBearerTokenAuthRequest != nil {
		return obj.DatabricksIntegrationAccountBearerTokenAuthRequest
	}
