...
type DowntimeRelationshipsCreatedByData struct {
	...
	// User resource type.
	Type *DowntimeUserType `json:"type,omitempty"`
...
func NewDowntimeRelationshipsCreatedByData() *DowntimeRelationshipsCreatedByData {
	...
	var typeVar DowntimeUserType = DOWNTIMEUSERTYPE_USERS
	this.Type = &typeVar
	return &this
}
...
func (o *DowntimeRelationshipsCreatedByData) GetType() DowntimeUserType {
	if o == nil || o.Type == nil {
		var ret DowntimeUserType
		return ret
	}
	return *o.Type
}
...
// and a boolean to check if the value has been set.
func (o *DowntimeRelationshipsCreatedByData) GetTypeOk() (*DowntimeUserType, bool) {
	if o == nil || o.Type == nil {
		return nil, false
	}
	return o.Type, true
...
// SetType gets a reference to the given DowntimeUserType and assigns it to the Type field.
func (o *DowntimeRelationshipsCreatedByData) SetType(v DowntimeUserType) {
	o.Type = &v
}
