...
// GetOwnershipSettings Get ownership settings for the org.
...
func (a *CSMOwnershipApi) GetOwnershipSettings(ctx _context.Context) (OwnershipSettingsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue OwnershipSettingsResponse
	)

	operationId := "v2.GetOwnershipSettings"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CSMOwnershipApi.GetOwnershipSettings")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/csm/ownership/settings"
...
// GetOwnershipUntaggedFindings Count untagged findings by ownership confidence.
// Count findings with no team tag, grouped by ownership confidence level.
func (a *CSMOwnershipApi) GetOwnershipUntaggedFindings(ctx _context.Context) (OwnershipUntaggedFindingsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue OwnershipUntaggedFindingsResponse
	)

	operationId := "v2.GetOwnershipUntaggedFindings"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CSMOwnershipApi.GetOwnershipUntaggedFindings")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/csm/ownership/settings/untagged"
...
// PostOwnershipSettings Update ownership settings for the org.
// Update ownership settings for the org.
func (a *CSMOwnershipApi) PostOwnershipSettings(ctx _context.Context, body OwnershipSettingsRequest) (OwnershipSettingsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue OwnershipSettingsResponse
	...
	operationId := "v2.PostOwnershipSettings"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CSMOwnershipApi.PostOwnershipSettings")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
