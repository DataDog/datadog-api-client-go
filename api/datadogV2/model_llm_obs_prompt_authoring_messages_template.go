...
type LLMObsPromptAuthoringMessagesTemplate struct {
	...
	Messages []LLMObsPromptAuthoringItem `json:"messages"`
...
func NewLLMObsPromptAuthoringMessagesTemplate(messages []LLMObsPromptAuthoringItem) *LLMObsPromptAuthoringMessagesTemplate {
...
func (o *LLMObsPromptAuthoringMessagesTemplate) GetMessages() []LLMObsPromptAuthoringItem {
	if o == nil {
		var ret []LLMObsPromptAuthoringItem
		return ret
	}
	return o.Messages
}
...
func (o *LLMObsPromptAuthoringMessagesTemplate) GetMessagesOk() (*[]LLMObsPromptAuthoringItem, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LLMObsPromptAuthoringMessagesTemplate) SetMessages(v []LLMObsPromptAuthoringItem) {
	o.Messages = v
}
