...
// CustomDestinationCreateRequest Request containing information about a single custom destination to be created.
type CustomDestinationCreateRequest struct {
	// The custom destination data object used for creation.
	Data CustomDestinationCreateData `json:"data"`
...
func NewCustomDestinationCreateRequest(data CustomDestinationCreateData) *CustomDestinationCreateRequest {
...
func (o *CustomDestinationCreateRequest) GetData() CustomDestinationCreateData {
	if o == nil {
		var ret CustomDestinationCreateData
		return ret
	}
	return o.Data
}
...
func (o *CustomDestinationCreateRequest) GetDataOk() (*CustomDestinationCreateData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *CustomDestinationCreateRequest) SetData(v CustomDestinationCreateData) {
	o.Data = v
}
