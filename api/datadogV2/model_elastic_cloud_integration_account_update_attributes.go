...
type ElasticCloudIntegrationAccountUpdateAttributes struct {
	...
	Settings *ElasticCloudIntegrationAccountSettingsUpdate `json:"settings,omitempty"`
...
func (o *ElasticCloudIntegrationAccountUpdateAttributes) GetAuthentication() ElasticCloudIntegrationAccountAuthenticationUpdate {
	if o == nil || o.Authentication == nil {
		var ret ElasticCloudIntegrationAccountAuthenticationUpdate
		return ret
	}
...
func (o *ElasticCloudIntegrationAccountUpdateAttributes) GetAuthenticationOk() (*ElasticCloudIntegrationAccountAuthenticationUpdate, bool) {
	if o == nil || o.Authentication == nil {
		return nil, false
	}
...
func (o *ElasticCloudIntegrationAccountUpdateAttributes) HasAuthentication() bool {
	return o != nil && o.Authentication != nil
}

// SetAuthentication gets a reference to the given ElasticCloudIntegrationAccountAuthenticationUpdate and assigns it to the Authentication field.
func (o *ElasticCloudIntegrationAccountUpdateAttributes) SetAuthentication(v ElasticCloudIntegrationAccountAuthenticationUpdate) {
	o.Authentication = &v
}

// GetDataflows returns the Dataflows field value if set, zero value otherwise.
func (o *ElasticCloudIntegrationAccountUpdateAttributes) GetDataflows() ElasticCloudIntegrationDataflowsRequest {
...
// and a boolean to check if the value has been set.
func (o *ElasticCloudIntegrationAccountUpdateAttributes) GetDataflowsOk() (*ElasticCloudIntegrationDataflowsRequest, bool) {
	if o == nil || o.Dataflows == nil {
		return nil, false
	}
...
func (o *ElasticCloudIntegrationAccountUpdateAttributes) HasDataflows() bool {
...
func (o *ElasticCloudIntegrationAccountUpdateAttributes) SetDataflows(v ElasticCloudIntegrationDataflowsRequest) {
	o.Dataflows = &v
}
...
func (o *ElasticCloudIntegrationAccountUpdateAttributes) GetSettings() ElasticCloudIntegrationAccountSettingsUpdate {
	if o == nil || o.Settings == nil {
		var ret ElasticCloudIntegrationAccountSettingsUpdate
		return ret
	}
	return *o.Settings
}
...
// and a boolean to check if the value has been set.
func (o *ElasticCloudIntegrationAccountUpdateAttributes) GetSettingsOk() (*ElasticCloudIntegrationAccountSettingsUpdate, bool) {
	if o == nil || o.Settings == nil {
		return nil, false
	}
...
func (o *ElasticCloudIntegrationAccountUpdateAttributes) HasSettings() bool {
	return o != nil && o.Settings != nil
}

// SetSettings gets a reference to the given ElasticCloudIntegrationAccountSettingsUpdate and assigns it to the Settings field.
func (o *ElasticCloudIntegrationAccountUpdateAttributes) SetSettings(v ElasticCloudIntegrationAccountSettingsUpdate) {
	o.Settings = &v
}
