...
type GetIssueOptionalParameters struct {
	Include *[]IssueIncludeQueryParameterItem
}
...
func (r *GetIssueOptionalParameters) WithInclude(include []IssueIncludeQueryParameterItem) *GetIssueOptionalParameters {
	r.Include = &include
	return r
}
...
// WithInclude sets the corresponding parameter name and returns the struct.
func (r *SearchIssuesOptionalParameters) WithInclude(include []IssueIncludeQueryParameterItem) *SearchIssuesOptionalParameters {
	r.Include = &include
	return r
}
...
func (a *ErrorTrackingApi) SearchIssues(ctx _context.Context, body IssuesSearchRequest, o ...SearchIssuesOptionalParameters) (IssuesResponse, *_nethttp.Response, error) {
	var (
