...
// IntakeKeyApi service type
type IntakeKeyApi datadog.Service

// GetIntakeKey Get an intake API key.
...
func (a *IntakeKeyApi) GetIntakeKey(ctx _context.Context) (IntakeAPIKeyResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue IntakeAPIKeyResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.IntakeKeyApi.GetIntakeKey")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/intake-key"
...
// NewIntakeKeyApi Returns NewIntakeKeyApi.
func NewIntakeKeyApi(client *datadog.APIClient) *IntakeKeyApi {
	return &IntakeKeyApi{
		Client: client,
	}
}
