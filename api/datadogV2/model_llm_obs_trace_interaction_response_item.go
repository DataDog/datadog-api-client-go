...
func NewLLMObsTraceInteractionResponseItem(alreadyExisted bool, contentId string, id string, typeVar LLMObsTraceInteractionType) *LLMObsTraceInteractionResponseItem {
