...
func (o *AzureScanOptionsInputUpdateDataAttributes) GetFunction() bool {
...
// and a boolean to check if the value has been set.
func (o *AzureScanOptionsInputUpdateDataAttributes) GetFunctionOk() (*bool, bool) {
	if o == nil || o.Function == nil {
		return nil, false
	}
...
func (o *AzureScanOptionsInputUpdateDataAttributes) HasFunction() bool {
	return o != nil && o.Function != nil
}

// SetFunction gets a reference to the given bool and assigns it to the Function field.
func (o *AzureScanOptionsInputUpdateDataAttributes) SetFunction(v bool) {
	o.Function = &v
}
