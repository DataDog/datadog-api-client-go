...
func (a *LogsCustomDestinationsApi) CreateLogsCustomDestination(ctx _context.Context, body CustomDestinationCreatePayload) (CustomDestinationResponse, *_nethttp.Response, error) {
	var (
	...
	operationId := "v2.CreateLogsCustomDestination"
	...
	localVarPath := localBasePath + "/api/v2/logs/config/custom_destinations"
...
func (a *LogsCustomDestinationsApi) DeleteLogsCustomDestination(ctx _context.Context, customDestinationId string) (CustomDestinationDeleteResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodDelete
		localVarPostBody    interface{}
		localVarReturnValue CustomDestinationDeleteResponse
	)

	operationId := "v2.DeleteLogsCustomDestination"
	if a.Client.Cfg.IsUnstableOperationEnabled(operationId) {
		_log.Printf("WARNING: Using unstable operation '%s'", operationId)
	} else {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	...
	localVarPath := localBasePath + "/api/v2/logs/config/custom_destinations/{custom_destination_id}"
...
func (a *LogsCustomDestinationsApi) GetLogsCustomDestination(ctx _context.Context, customDestinationId string) (CustomDestinationResponse, *_nethttp.Response, error) {
	...
	operationId := "v2.GetLogsCustomDestination"
	if a.Client.Cfg.IsUnstableOperationEnabled(operationId) {
		_log.Printf("WARNING: Using unstable operation '%s'", operationId)
	} else {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
...
// ListLogsCustomDestinations List custom destinations.
// Returns all custom destinations, including their attributes and IDs.
func (a *LogsCustomDestinationsApi) ListLogsCustomDestinations(ctx _context.Context) (CustomDestinationListResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue CustomDestinationListResponse
	)

	operationId := "v2.ListLogsCustomDestinations"
	if a.Client.Cfg.IsUnstableOperationEnabled(operationId) {
		_log.Printf("WARNING: Using unstable operation '%s'", operationId)
	} else {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
...
func (a *LogsCustomDestinationsApi) UpdateLogsCustomDestination(ctx _context.Context, customDestinationId string, body CustomDestinationUpdatePayload) (CustomDestinationResponse, *_nethttp.Response, error) {
	var (
	...
	operationId := "v2.UpdateLogsCustomDestination"
	if a.Client.Cfg.IsUnstableOperationEnabled(operationId) {
		_log.Printf("WARNING: Using unstable operation '%s'", operationId)
	} else {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
