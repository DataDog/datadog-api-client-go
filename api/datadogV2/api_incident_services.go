...
func (a *IncidentServicesApi) createIncidentServiceExecute(ctx _context.Context, body IncidentServiceCreateRequest) (IncidentServiceResponse, *_nethttp.Response, error) {
	var (
...
func (a *IncidentServicesApi) deleteIncidentServiceExecute(ctx _context.Context, serviceId string) (*_nethttp.Response, error) {
	var (
...
func (a *IncidentServicesApi) getIncidentServiceExecute(ctx _context.Context, serviceId string, o ...GetIncidentServiceOptionalParameters) (IncidentServiceResponse, *_nethttp.Response, error) {
	var (
...
func (a *IncidentServicesApi) listIncidentServicesExecute(ctx _context.Context, o ...ListIncidentServicesOptionalParameters) (IncidentServicesResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
...
func (a *IncidentServicesApi) updateIncidentServiceExecute(ctx _context.Context, serviceId string, body IncidentServiceUpdateRequest) (IncidentServiceResponse, *_nethttp.Response, error) {
	var (
