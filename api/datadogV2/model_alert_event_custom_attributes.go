...
// AlertEventCustomAttributes Object representing custom alert event attributes.
type AlertEventCustomAttributes struct {
	...
	Status *AlertEventCustomAttributesStatus `json:"status,omitempty"`
...
func NewAlertEventCustomAttributes() *AlertEventCustomAttributes {
...
func (o *AlertEventCustomAttributes) HasStatus() bool {
	return o != nil && o.Status != nil
}

// SetStatus gets a reference to the given AlertEventCustomAttributesStatus and assigns it to the Status field.
