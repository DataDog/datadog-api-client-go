...
func (o *TenancyConfigDataAttributes) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = datadog.Unmarshal(bytes, &additionalProperties); err == nil {
		datadog.DeleteKeys(additionalProperties, &[]string{"config_version", "cost_collection_enabled", "home_region", "logs_config", "metrics_config", "resource_collection_enabled", "tenancy_name", "user_ocid"})
	} else {
		return err
	}
