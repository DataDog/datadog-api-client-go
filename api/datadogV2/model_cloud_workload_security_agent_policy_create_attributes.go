...
func (o *CloudWorkloadSecurityAgentPolicyCreateAttributes) GetPriority() int64 {
...
// and a boolean to check if the value has been set.
func (o *CloudWorkloadSecurityAgentPolicyCreateAttributes) GetPriorityOk() (*int64, bool) {
	if o == nil || o.Priority == nil {
		return nil, false
	}
...
func (o *CloudWorkloadSecurityAgentPolicyCreateAttributes) HasPriority() bool {
	return o != nil && o.Priority != nil
}

// SetPriority gets a reference to the given int64 and assigns it to the Priority field.
func (o *CloudWorkloadSecurityAgentPolicyCreateAttributes) SetPriority(v int64) {
	o.Priority = &v
}
