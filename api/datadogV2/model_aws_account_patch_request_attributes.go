...
// AWSAccountPatchRequestAttributes The AWS Account Integration Config to be updated
type AWSAccountPatchRequestAttributes struct {
...
// NewAWSAccountPatchRequestAttributes instantiates a new AWSAccountPatchRequestAttributes object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewAWSAccountPatchRequestAttributes(awsAccountId string) *AWSAccountPatchRequestAttributes {
	this := AWSAccountPatchRequestAttributes{}
...
// NewAWSAccountPatchRequestAttributesWithDefaults instantiates a new AWSAccountPatchRequestAttributes object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewAWSAccountPatchRequestAttributesWithDefaults() *AWSAccountPatchRequestAttributes {
	this := AWSAccountPatchRequestAttributes{}
	var awsPartition AWSAccountPartition = AWSACCOUNTPARTITION_AWS
	this.AwsPartition = &awsPartition
	return &this
...
func (o *AWSAccountPatchRequestAttributes) GetAccountTags() []string {
...
func (o *AWSAccountPatchRequestAttributes) GetAccountTagsOk() (*[]string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AWSAccountPatchRequestAttributes) HasAccountTags() bool {
...
// and a boolean to check if the value has been set.
func (o *AWSAccountPatchRequestAttributes) GetAuthConfigOk() (*AWSAuthConfig, bool) {
	if o == nil || o.AuthConfig == nil {
		return nil, false
	}
...
func (o *AWSAccountPatchRequestAttributes) HasAuthConfig() bool {
...
func (o *AWSAccountPatchRequestAttributes) SetAuthConfig(v AWSAuthConfig) {
	o.AuthConfig = &v
}

// GetAwsAccountId returns the AwsAccountId field value.
func (o *AWSAccountPatchRequestAttributes) GetAwsAccountId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AWSAccountPatchRequestAttributes) GetAwsAccountIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AWSAccountPatchRequestAttributes) SetAwsAccountId(v string) {
	o.AwsAccountId = v
}

// GetAwsPartition returns the AwsPartition field value if set, zero value otherwise.
func (o *AWSAccountPatchRequestAttributes) GetAwsPartition() AWSAccountPartition {
...
// and a boolean to check if the value has been set.
func (o *AWSAccountPatchRequestAttributes) GetAwsPartitionOk() (*AWSAccountPartition, bool) {
	if o == nil || o.AwsPartition == nil {
		return nil, false
	}
...
func (o *AWSAccountPatchRequestAttributes) HasAwsPartition() bool {
...
func (o *AWSAccountPatchRequestAttributes) SetAwsPartition(v AWSAccountPartition) {
	o.AwsPartition = &v
}

// GetAwsRegions returns the AwsRegions field value if set, zero value otherwise.
func (o *AWSAccountPatchRequestAttributes) GetAwsRegions() AWSRegions {
...
// and a boolean to check if the value has been set.
func (o *AWSAccountPatchRequestAttributes) GetAwsRegionsOk() (*AWSRegions, bool) {
	if o == nil || o.AwsRegions == nil {
		return nil, false
	}
...
func (o *AWSAccountPatchRequestAttributes) HasAwsRegions() bool {
...
func (o *AWSAccountPatchRequestAttributes) SetAwsRegions(v AWSRegions) {
	o.AwsRegions = &v
}

// GetLogsConfig returns the LogsConfig field value if set, zero value otherwise.
func (o *AWSAccountPatchRequestAttributes) GetLogsConfig() AWSLogsConfig {
...
// and a boolean to check if the value has been set.
func (o *AWSAccountPatchRequestAttributes) GetLogsConfigOk() (*AWSLogsConfig, bool) {
	if o == nil || o.LogsConfig == nil {
		return nil, false
	}
...
func (o *AWSAccountPatchRequestAttributes) HasLogsConfig() bool {
...
func (o *AWSAccountPatchRequestAttributes) SetLogsConfig(v AWSLogsConfig) {
	o.LogsConfig = &v
}

// GetMetricsConfig returns the MetricsConfig field value if set, zero value otherwise.
func (o *AWSAccountPatchRequestAttributes) GetMetricsConfig() AWSMetricsConfig {
...
// and a boolean to check if the value has been set.
func (o *AWSAccountPatchRequestAttributes) GetMetricsConfigOk() (*AWSMetricsConfig, bool) {
	if o == nil || o.MetricsConfig == nil {
		return nil, false
	}
...
func (o *AWSAccountPatchRequestAttributes) HasMetricsConfig() bool {
...
func (o *AWSAccountPatchRequestAttributes) SetMetricsConfig(v AWSMetricsConfig) {
	o.MetricsConfig = &v
}

// GetResourcesConfig returns the ResourcesConfig field value if set, zero value otherwise.
func (o *AWSAccountPatchRequestAttributes) GetResourcesConfig() AWSResourcesConfig {
...
// and a boolean to check if the value has been set.
func (o *AWSAccountPatchRequestAttributes) GetResourcesConfigOk() (*AWSResourcesConfig, bool) {
	if o == nil || o.ResourcesConfig == nil {
		return nil, false
	}
...
func (o *AWSAccountPatchRequestAttributes) HasResourcesConfig() bool {
...
func (o *AWSAccountPatchRequestAttributes) SetResourcesConfig(v AWSResourcesConfig) {
	o.ResourcesConfig = &v
}

// GetTracesConfig returns the TracesConfig field value if set, zero value otherwise.
func (o *AWSAccountPatchRequestAttributes) GetTracesConfig() AWSTracesConfig {
...
// and a boolean to check if the value has been set.
func (o *AWSAccountPatchRequestAttributes) GetTracesConfigOk() (*AWSTracesConfig, bool) {
	if o == nil || o.TracesConfig == nil {
		return nil, false
	}
...
func (o *AWSAccountPatchRequestAttributes) HasTracesConfig() bool {
...
func (o *AWSAccountPatchRequestAttributes) SetTracesConfig(v AWSTracesConfig) {
	o.TracesConfig = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o AWSAccountPatchRequestAttributes) MarshalJSON() ([]byte, error) {
...
func (o *AWSAccountPatchRequestAttributes) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		AccountTags     datadog.NullableList[string] `json:"account_tags,omitempty"`
		AuthConfig      *AWSAuthConfig               `json:"auth_config,omitempty"`
		AwsAccountId    *string                      `json:"aws_account_id"`
