...
func NewSuiteCreateEdit(attributes SyntheticsSuite, typeVar SyntheticsSuiteType) *SuiteCreateEdit {
...
func (o *SuiteCreateEdit) GetType() SyntheticsSuiteType {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *SuiteCreateEdit) GetTypeOk() (*SyntheticsSuiteType, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *SuiteCreateEdit) SetType(v SyntheticsSuiteType) {
	o.Type = v
}
