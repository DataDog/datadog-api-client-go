...
func NewObservabilityPipelineHttpServerSource(authStrategy ObservabilityPipelineHttpServerSourceAuthStrategy, decoding ObservabilityPipelineDecoding, id string, include string, inputs []string, typeVar ObservabilityPipelineHttpServerSourceType) *ObservabilityPipelineHttpServerSource {
...
func (o *ObservabilityPipelineHttpServerSource) GetInclude() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ObservabilityPipelineHttpServerSource) GetIncludeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ObservabilityPipelineHttpServerSource) SetInclude(v string) {
	o.Include = v
}

// GetInputs returns the Inputs field value.
func (o *ObservabilityPipelineHttpServerSource) GetInputs() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ObservabilityPipelineHttpServerSource) GetInputsOk() (*[]string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ObservabilityPipelineHttpServerSource) SetInputs(v []string) {
	o.Inputs = v
}
...
func (o *ObservabilityPipelineHttpServerSource) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = datadog.Unmarshal(bytes, &additionalProperties); err == nil {
		datadog.DeleteKeys(additionalProperties, &[]string{"auth_strategy", "decoding", "id", "include", "inputs", "tls", "type"})
	} else {
		return err
	}
