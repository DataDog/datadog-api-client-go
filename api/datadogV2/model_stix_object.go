...
// STIXObject A STIX 2.1 object. Indicator objects are processed and ingested; all other STIX object types are ignored and are not included in the response counters.
...
func (o *STIXObject) GetSpecVersion() string {
...
// and a boolean to check if the value has been set.
func (o *STIXObject) GetSpecVersionOk() (*string, bool) {
	if o == nil || o.SpecVersion == nil {
		return nil, false
	}
...
func (o *STIXObject) SetSpecVersion(v string) {
	o.SpecVersion = &v
}
