...
// SecurityMonitoringNotificationRuleType The type of the resource. The value should always be `notification_profiles`.
type SecurityMonitoringNotificationRuleType string

// List of SecurityMonitoringNotificationRuleType.
const (
	SECURITYMONITORINGNOTIFICATIONRULETYPE_NOTIFICATION_PROFILES SecurityMonitoringNotificationRuleType = "notification_profiles"
)

var allowedSecurityMonitoringNotificationRuleTypeEnumValues = []SecurityMonitoringNotificationRuleType{
	SECURITYMONITORINGNOTIFICATIONRULETYPE_NOTIFICATION_PROFILES,
}
