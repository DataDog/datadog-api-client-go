...
type DowntimeResponseData struct {
	// Downtime details.
	Attributes *DowntimeAttributeResponse `json:"attributes,omitempty"`
	// The downtime ID.
...
func (o *DowntimeResponseData) GetAttributes() DowntimeAttributeResponse {
	if o == nil || o.Attributes == nil {
		var ret DowntimeAttributeResponse
		return ret
	}
	return *o.Attributes
}
...
func (o *DowntimeResponseData) GetAttributesOk() (*DowntimeAttributeResponse, bool) {
	if o == nil || o.Attributes == nil {
		return nil, false
	}
...
// SetAttributes gets a reference to the given DowntimeAttributeResponse and assigns it to the Attributes field.
func (o *DowntimeResponseData) SetAttributes(v DowntimeAttributeResponse) {
	o.Attributes = &v
}
