...
func NewCreatePageRequestDataAttributes(target CreatePageRequestDataAttributesTarget, title string, urgency string) *CreatePageRequestDataAttributes {
...
func (o *CreatePageRequestDataAttributes) GetUrgency() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreatePageRequestDataAttributes) GetUrgencyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreatePageRequestDataAttributes) SetUrgency(v string) {
	o.Urgency = v
}
