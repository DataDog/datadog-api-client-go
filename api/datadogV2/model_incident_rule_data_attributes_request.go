...
type IncidentRuleDataAttributesRequest struct {
	...
	ConditionTableType int64 `json:"condition_table_type"`
...
func NewIncidentRuleDataAttributesRequest(condition IncidentRuleQueryCondition, conditionTableType int64, enabled bool, executionType IncidentRuleExecutionType, taskId IncidentRuleTaskIDType, taskPayload string) *IncidentRuleDataAttributesRequest {
...
func (o *IncidentRuleDataAttributesRequest) GetConditionTableType() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *IncidentRuleDataAttributesRequest) GetConditionTableTypeOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *IncidentRuleDataAttributesRequest) SetConditionTableType(v int64) {
