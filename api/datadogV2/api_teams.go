...
// GetTeamHierarchyLinksOptionalParameters holds optional parameters for GetTeamHierarchyLinks.
type GetTeamHierarchyLinksOptionalParameters struct {
	PageNumber       *int64
	PageSize         *int64
...
// NewGetTeamHierarchyLinksOptionalParameters creates an empty struct for parameters.
func NewGetTeamHierarchyLinksOptionalParameters() *GetTeamHierarchyLinksOptionalParameters {
	this := GetTeamHierarchyLinksOptionalParameters{}
	return &this
}

// WithPageNumber sets the corresponding parameter name and returns the struct.
func (r *GetTeamHierarchyLinksOptionalParameters) WithPageNumber(pageNumber int64) *GetTeamHierarchyLinksOptionalParameters {
	r.PageNumber = &pageNumber
	return r
}

// WithPageSize sets the corresponding parameter name and returns the struct.
func (r *GetTeamHierarchyLinksOptionalParameters) WithPageSize(pageSize int64) *GetTeamHierarchyLinksOptionalParameters {
	r.PageSize = &pageSize
	return r
}

// WithFilterParentTeam sets the corresponding parameter name and returns the struct.
func (r *GetTeamHierarchyLinksOptionalParameters) WithFilterParentTeam(filterParentTeam string) *GetTeamHierarchyLinksOptionalParameters {
	r.FilterParentTeam = &filterParentTeam
	return r
}

// WithFilterSubTeam sets the corresponding parameter name and returns the struct.
func (r *GetTeamHierarchyLinksOptionalParameters) WithFilterSubTeam(filterSubTeam string) *GetTeamHierarchyLinksOptionalParameters {
	r.FilterSubTeam = &filterSubTeam
	return r
}

// GetTeamHierarchyLinks Get team hierarchy links.
// Get all team hierarchy links that match the provided filters.
func (a *TeamsApi) GetTeamHierarchyLinks(ctx _context.Context, o ...GetTeamHierarchyLinksOptionalParameters) (TeamHierarchyLinksResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue TeamHierarchyLinksResponse
		optionalParams      GetTeamHierarchyLinksOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, datadog.ReportError("only one argument of type GetTeamHierarchyLinksOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.TeamsApi.GetTeamHierarchyLinks")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// GetTeamHierarchyLinksWithPagination provides a paginated version of GetTeamHierarchyLinks returning a channel with all items.
func (a *TeamsApi) GetTeamHierarchyLinksWithPagination(ctx _context.Context, o ...GetTeamHierarchyLinksOptionalParameters) (<-chan datadog.PaginationResult[TeamHierarchyLink], func()) {
	ctx, cancel := _context.WithCancel(ctx)
	pageSize_ := int64(10)
	if len(o) == 0 {
		o = append(o, GetTeamHierarchyLinksOptionalParameters{})
	}
	if o[0].PageSize != nil {
	...
	go func() {
		for {
			resp, _, err := a.GetTeamHierarchyLinks(ctx, o...)
			if err != nil {
