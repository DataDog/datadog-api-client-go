...
// GetAllTeamsOptionalParameters holds optional parameters for GetAllTeams.
type GetAllTeamsOptionalParameters struct {
	PageNumber    *int64
	PageSize      *int64
	Sort          *GetAllTeamsSort
	Include       *[]GetAllTeamsInclude
	FilterKeyword *string
	FilterMe      *bool
}

// NewGetAllTeamsOptionalParameters creates an empty struct for parameters.
func NewGetAllTeamsOptionalParameters() *GetAllTeamsOptionalParameters {
	this := GetAllTeamsOptionalParameters{}
	return &this
}

// WithPageNumber sets the corresponding parameter name and returns the struct.
func (r *GetAllTeamsOptionalParameters) WithPageNumber(pageNumber int64) *GetAllTeamsOptionalParameters {
	r.PageNumber = &pageNumber
	return r
}

// WithPageSize sets the corresponding parameter name and returns the struct.
func (r *GetAllTeamsOptionalParameters) WithPageSize(pageSize int64) *GetAllTeamsOptionalParameters {
	r.PageSize = &pageSize
	return r
}

// WithSort sets the corresponding parameter name and returns the struct.
func (r *GetAllTeamsOptionalParameters) WithSort(sort GetAllTeamsSort) *GetAllTeamsOptionalParameters {
	r.Sort = &sort
	return r
}

// WithInclude sets the corresponding parameter name and returns the struct.
func (r *GetAllTeamsOptionalParameters) WithInclude(include []GetAllTeamsInclude) *GetAllTeamsOptionalParameters {
	r.Include = &include
	return r
}

// WithFilterKeyword sets the corresponding parameter name and returns the struct.
func (r *GetAllTeamsOptionalParameters) WithFilterKeyword(filterKeyword string) *GetAllTeamsOptionalParameters {
	r.FilterKeyword = &filterKeyword
	return r
}

// WithFilterMe sets the corresponding parameter name and returns the struct.
func (r *GetAllTeamsOptionalParameters) WithFilterMe(filterMe bool) *GetAllTeamsOptionalParameters {
	r.FilterMe = &filterMe
	return r
}
...
func (a *TeamsApi) GetAllTeams(ctx _context.Context, o ...GetAllTeamsOptionalParameters) (TeamsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue TeamsResponse
		optionalParams      GetAllTeamsOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, datadog.ReportError("only one argument of type GetAllTeamsOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.TeamsApi.GetAllTeams")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *TeamsApi) RemoveTeam(ctx _context.Context, teamId string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.TeamsApi.RemoveTeam")
	if err != nil {
...
// RemoveTeamLink Remove a team link.
// Remove a link from a team.
func (a *TeamsApi) RemoveTeamLink(ctx _context.Context, teamId string, linkId string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.TeamsApi.RemoveTeamLink")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// RemoveTeamMembership Remove a user from a team.
// Remove a user from a team.
func (a *TeamsApi) RemoveTeamMembership(ctx _context.Context, teamId string, userId string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.TeamsApi.RemoveTeamMembership")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
