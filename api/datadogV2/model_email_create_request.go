...
// EmailCreateRequest Request body for creating an On-Call email notification channel.
...
func NewEmailCreateRequest() *EmailCreateRequest {
...
func (o *EmailCreateRequest) GetData() EmailData {
	if o == nil || o.Data == nil {
		var ret EmailData
		return ret
	}
...
func (o *EmailCreateRequest) GetDataOk() (*EmailData, bool) {
	if o == nil || o.Data == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *EmailCreateRequest) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Data *EmailData `json:"data,omitempty"`
	}{}
