...
func (a *OnCallApi) DeleteOnCallSchedule(ctx _context.Context, scheduleUuid string) (*_nethttp.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/api/v2/on-call/schedules/{schedule_uuid}"
...
func (a *OnCallApi) GetOnCallSchedule(ctx _context.Context, scheduleUuid string, o ...GetOnCallScheduleOptionalParameters) (Schedule, *_nethttp.Response, error) {
	var (
...
func (a *OnCallApi) UpdateOnCallSchedule(ctx _context.Context, scheduleUuid string, body ScheduleUpdateRequest, o ...UpdateOnCallScheduleOptionalParameters) (Schedule, *_nethttp.Response, error) {
	var (
