...
// RUMOperationsListResponseMetaPage Pagination metadata for a list of RUM operations.
type RUMOperationsListResponseMetaPage struct {
...
// NewRUMOperationsListResponseMetaPage instantiates a new RUMOperationsListResponseMetaPage object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewRUMOperationsListResponseMetaPage() *RUMOperationsListResponseMetaPage {
	this := RUMOperationsListResponseMetaPage{}
	return &this
}

// NewRUMOperationsListResponseMetaPageWithDefaults instantiates a new RUMOperationsListResponseMetaPage object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewRUMOperationsListResponseMetaPageWithDefaults() *RUMOperationsListResponseMetaPage {
	this := RUMOperationsListResponseMetaPage{}
	return &this
}

// GetFirstOffset returns the FirstOffset field value if set, zero value otherwise.
func (o *RUMOperationsListResponseMetaPage) GetFirstOffset() int64 {
...
func (o *RUMOperationsListResponseMetaPage) GetFirstOffsetOk() (*int64, bool) {
	if o == nil || o.FirstOffset == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *RUMOperationsListResponseMetaPage) GetLastOffsetOk() (*int64, bool) {
	if o == nil || o.LastOffset == nil {
		return nil, false
	}
...
func (o *RUMOperationsListResponseMetaPage) HasLastOffset() bool {
	return o != nil && o.LastOffset != nil
}

// SetLastOffset gets a reference to the given int64 and assigns it to the LastOffset field.
func (o *RUMOperationsListResponseMetaPage) SetLastOffset(v int64) {
	o.LastOffset = &v
}

// GetLimit returns the Limit field value if set, zero value otherwise.
func (o *RUMOperationsListResponseMetaPage) GetLimit() int64 {
...
// and a boolean to check if the value has been set.
func (o *RUMOperationsListResponseMetaPage) GetLimitOk() (*int64, bool) {
	if o == nil || o.Limit == nil {
		return nil, false
	}
	return o.Limit, true
...
func (o *RUMOperationsListResponseMetaPage) HasLimit() bool {
	return o != nil && o.Limit != nil
}

// SetLimit gets a reference to the given int64 and assigns it to the Limit field.
func (o *RUMOperationsListResponseMetaPage) SetLimit(v int64) {
	o.Limit = &v
}

// GetNextOffset returns the NextOffset field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *RUMOperationsListResponseMetaPage) GetNextOffset() int64 {
...
func (o *RUMOperationsListResponseMetaPage) GetNextOffsetOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RUMOperationsListResponseMetaPage) HasNextOffset() bool {
...
func (o *RUMOperationsListResponseMetaPage) SetNextOffset(v int64) {
	o.NextOffset.Set(&v)
}

// SetNextOffsetNil sets the value for NextOffset to be an explicit nil.
func (o *RUMOperationsListResponseMetaPage) SetNextOffsetNil() {
	o.NextOffset.Set(nil)
}

// UnsetNextOffset ensures that no value is present for NextOffset, not even an explicit nil.
func (o *RUMOperationsListResponseMetaPage) UnsetNextOffset() {
	o.NextOffset.Unset()
}

// GetOffset returns the Offset field value if set, zero value otherwise.
func (o *RUMOperationsListResponseMetaPage) GetOffset() int64 {
...
// and a boolean to check if the value has been set.
func (o *RUMOperationsListResponseMetaPage) GetOffsetOk() (*int64, bool) {
	if o == nil || o.Offset == nil {
		return nil, false
	}
...
func (o *RUMOperationsListResponseMetaPage) HasOffset() bool {
	return o != nil && o.Offset != nil
}

// SetOffset gets a reference to the given int64 and assigns it to the Offset field.
func (o *RUMOperationsListResponseMetaPage) SetOffset(v int64) {
	o.Offset = &v
}

// GetPrevOffset returns the PrevOffset field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *RUMOperationsListResponseMetaPage) GetPrevOffset() int64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned.
func (o *RUMOperationsListResponseMetaPage) GetPrevOffsetOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RUMOperationsListResponseMetaPage) HasPrevOffset() bool {
...
func (o *RUMOperationsListResponseMetaPage) SetPrevOffset(v int64) {
	o.PrevOffset.Set(&v)
}

// SetPrevOffsetNil sets the value for PrevOffset to be an explicit nil.
func (o *RUMOperationsListResponseMetaPage) SetPrevOffsetNil() {
	o.PrevOffset.Set(nil)
}

// UnsetPrevOffset ensures that no value is present for PrevOffset, not even an explicit nil.
func (o *RUMOperationsListResponseMetaPage) UnsetPrevOffset() {
	o.PrevOffset.Unset()
}

// GetTotal returns the Total field value if set, zero value otherwise.
func (o *RUMOperationsListResponseMetaPage) GetTotal() int64 {
...
// and a boolean to check if the value has been set.
func (o *RUMOperationsListResponseMetaPage) GetTotalOk() (*int64, bool) {
	if o == nil || o.Total == nil {
		return nil, false
	}
	return o.Total, true
...
func (o *RUMOperationsListResponseMetaPage) HasTotal() bool {
	return o != nil && o.Total != nil
}

// SetTotal gets a reference to the given int64 and assigns it to the Total field.
func (o *RUMOperationsListResponseMetaPage) SetTotal(v int64) {
	o.Total = &v
}

// GetType returns the Type field value if set, zero value otherwise.
func (o *RUMOperationsListResponseMetaPage) GetType() string {
	if o == nil || o.Type == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *RUMOperationsListResponseMetaPage) GetTypeOk() (*string, bool) {
	if o == nil || o.Type == nil {
		return nil, false
	}
	return o.Type, true
...
func (o *RUMOperationsListResponseMetaPage) HasType() bool {
	return o != nil && o.Type != nil
}

// SetType gets a reference to the given string and assigns it to the Type field.
func (o *RUMOperationsListResponseMetaPage) SetType(v string) {
	o.Type = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o RUMOperationsListResponseMetaPage) MarshalJSON() ([]byte, error) {
...
func (o *RUMOperationsListResponseMetaPage) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		FirstOffset *int64                `json:"first_offset,omitempty"`
		LastOffset  *int64                `json:"last_offset,omitempty"`
		Limit       *int64                `json:"limit,omitempty"`
