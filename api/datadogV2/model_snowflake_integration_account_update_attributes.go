...
type SnowflakeIntegrationAccountUpdateAttributes struct {
	...
	Authentication *SnowflakeIntegrationAccountAuthenticationUpdate `json:"authentication,omitempty"`
...
func (o *SnowflakeIntegrationAccountUpdateAttributes) GetAuthentication() SnowflakeIntegrationAccountAuthenticationUpdate {
	if o == nil || o.Authentication == nil {
		var ret SnowflakeIntegrationAccountAuthenticationUpdate
		return ret
	}
...
func (o *SnowflakeIntegrationAccountUpdateAttributes) GetAuthenticationOk() (*SnowflakeIntegrationAccountAuthenticationUpdate, bool) {
	if o == nil || o.Authentication == nil {
		return nil, false
	}
...
// SetAuthentication gets a reference to the given SnowflakeIntegrationAccountAuthenticationUpdate and assigns it to the Authentication field.
func (o *SnowflakeIntegrationAccountUpdateAttributes) SetAuthentication(v SnowflakeIntegrationAccountAuthenticationUpdate) {
	o.Authentication = &v
}
