...
func (a *SecurityMonitoringApi) DeleteSecurityMonitoringDataset(ctx _context.Context, datasetId uuid.UUID) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)
...
func (a *SecurityMonitoringApi) GetSecurityMonitoringDataset(ctx _context.Context, datasetId uuid.UUID) (SecurityMonitoringDatasetResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
...
// GetSecurityMonitoringDatasetByVersion Get a dataset by version.
// Get a specific version of a dataset.
func (a *SecurityMonitoringApi) GetSecurityMonitoringDatasetByVersion(ctx _context.Context, datasetId uuid.UUID, version int32) (SecurityMonitoringDatasetResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue SecurityMonitoringDatasetResponse
...
// GetSecurityMonitoringDatasetHistory Get dataset history.
// Get all historical versions of a dataset.
func (a *SecurityMonitoringApi) GetSecurityMonitoringDatasetHistory(ctx _context.Context, datasetId uuid.UUID) (SecurityMonitoringDatasetsHistoryResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue SecurityMonitoringDatasetsHistoryResponse
	)

	operationId := "v2.GetSecurityMonitoringDatasetHistory"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SecurityMonitoringApi.GetSecurityMonitoringDatasetHistory")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/security_monitoring/datasets/{dataset_id}/history"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{dataset_id}", _neturl.PathEscape(datadog.ParameterToString(datasetId, "")))
...
// ListSecurityMonitoringDatasets List all datasets.
...
func (a *SecurityMonitoringApi) UpdateSecurityMonitoringDataset(ctx _context.Context, datasetId uuid.UUID, body SecurityMonitoringDatasetUpdateRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodPatch
		localVarPostBody   interface{}
	)
