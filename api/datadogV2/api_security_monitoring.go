...
func (a *SecurityMonitoringApi) ReorderSecurityFindingsAutomationSeverityModifierRules(ctx _context.Context, body SeverityModifierRuleReorderRequest) (SeverityModifierRuleReorderRequest, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue SeverityModifierRuleReorderRequest
	)
