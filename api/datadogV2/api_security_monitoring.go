...
// CreateSecurityMonitoringNotificationRule Create a notification rule.
// Create a notification rule.
func (a *SecurityMonitoringApi) CreateSecurityMonitoringNotificationRule(ctx _context.Context, body SecurityMonitoringNotificationRuleCreateRequest) (SecurityMonitoringNotificationRuleResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue SecurityMonitoringNotificationRuleResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SecurityMonitoringApi.CreateSecurityMonitoringNotificationRule")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/security_monitoring/configuration/notification_profiles"
...
// DeleteSecurityMonitoringNotificationRule Delete a notification rule.
// Delete a specific notification rule.
func (a *SecurityMonitoringApi) DeleteSecurityMonitoringNotificationRule(ctx _context.Context, notificationProfileId string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SecurityMonitoringApi.DeleteSecurityMonitoringNotificationRule")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/security_monitoring/configuration/notification_profiles/{notification_profile_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"notification_profile_id"+"}", _neturl.PathEscape(datadog.ParameterToString(notificationProfileId, "")), -1)
...
// EditSecurityMonitoringNotificationRule Update a notification rule.
// Update a specific notification rule.
func (a *SecurityMonitoringApi) EditSecurityMonitoringNotificationRule(ctx _context.Context, notificationProfileId string, body SecurityMonitoringNotificationRuleUpdateRequest) (SecurityMonitoringNotificationRuleResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SecurityMonitoringApi.EditSecurityMonitoringNotificationRule")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// GetSecurityMonitoringNotificationRule Get notification rule by ID.
// Get notification rule by ID.
func (a *SecurityMonitoringApi) GetSecurityMonitoringNotificationRule(ctx _context.Context, notificationProfileId string) (SecurityMonitoringNotificationRuleResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue SecurityMonitoringNotificationRuleResponse
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SecurityMonitoringApi.GetSecurityMonitoringNotificationRule")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// ListSecurityFilters List security filters.
...
// ListSecurityMonitoringNotificationRules List notification rules.
// List all notification rules.
func (a *SecurityMonitoringApi) ListSecurityMonitoringNotificationRules(ctx _context.Context) (SecurityMonitoringNotificationRuleListResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue SecurityMonitoringNotificationRuleListResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SecurityMonitoringApi.ListSecurityMonitoringNotificationRules")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
