...
func (a *SecurityMonitoringApi) CreateSecurityMonitoringNotificationRule(ctx _context.Context, body SecurityMonitoringNotificationRuleCreateRequest) (SecurityMonitoringNotificationRuleResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/security_monitoring/configuration/notification_rules"
...
func (a *SecurityMonitoringApi) DeleteSecurityMonitoringNotificationRule(ctx _context.Context, notificationRuleId string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)
	...
	localVarPath := localBasePath + "/api/v2/security_monitoring/configuration/notification_rules/{notification_rule_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"notification_rule_id"+"}", _neturl.PathEscape(datadog.ParameterToString(notificationRuleId, "")), -1)
...
func (a *SecurityMonitoringApi) EditSecurityMonitoringNotificationRule(ctx _context.Context, notificationRuleId string, body SecurityMonitoringNotificationRuleUpdateRequest) (SecurityMonitoringNotificationRuleResponse, *_nethttp.Response, error) {
	var (
...
func (a *SecurityMonitoringApi) GetSecurityMonitoringNotificationRule(ctx _context.Context, notificationRuleId string) (SecurityMonitoringNotificationRuleResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue SecurityMonitoringNotificationRuleResponse
