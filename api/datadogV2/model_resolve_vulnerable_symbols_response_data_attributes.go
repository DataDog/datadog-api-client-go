...
// ResolveVulnerableSymbolsResponseDataAttributes The definition of `ResolveVulnerableSymbolsResponseDataAttributes` object.
type ResolveVulnerableSymbolsResponseDataAttributes struct {
	// The `attributes` `results`.
	Results []ResolveVulnerableSymbolsResponseDataAttributesResultsItems `json:"results,omitempty"`
...
func (o *ResolveVulnerableSymbolsResponseDataAttributes) GetResults() []ResolveVulnerableSymbolsResponseDataAttributesResultsItems {
	if o == nil || o.Results == nil {
		var ret []ResolveVulnerableSymbolsResponseDataAttributesResultsItems
		return ret
	}
	return o.Results
}
...
func (o *ResolveVulnerableSymbolsResponseDataAttributes) GetResultsOk() (*[]ResolveVulnerableSymbolsResponseDataAttributesResultsItems, bool) {
	if o == nil || o.Results == nil {
		return nil, false
	}
...
// SetResults gets a reference to the given []ResolveVulnerableSymbolsResponseDataAttributesResultsItems and assigns it to the Results field.
func (o *ResolveVulnerableSymbolsResponseDataAttributes) SetResults(v []ResolveVulnerableSymbolsResponseDataAttributesResultsItems) {
	o.Results = v
}
