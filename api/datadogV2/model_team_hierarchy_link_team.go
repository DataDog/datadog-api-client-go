...
// TeamHierarchyLinkTeam Team information in hierarchy link context
type TeamHierarchyLinkTeam struct {
	// Team attributes in hierarchy link context
	Attributes TeamHierarchyLinkTeamAttributes `json:"attributes"`
...
func NewTeamHierarchyLinkTeam(attributes TeamHierarchyLinkTeamAttributes, id string, typeVar TeamType) *TeamHierarchyLinkTeam {
