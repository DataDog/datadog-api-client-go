...
func main() {
    ...
    authnMappingId := "authnMappingId_example" // string | The UUID of the AuthN Mapping.
    body := *datadog.NewAuthNMappingUpdateRequest(*datadog.NewAuthNMappingUpdate("3653d3c6-0c75-11ea-ad28-fb5701eabc7d", datadog.AuthNMappingsType("authn_mappings"))) // AuthNMappingUpdateRequest |
