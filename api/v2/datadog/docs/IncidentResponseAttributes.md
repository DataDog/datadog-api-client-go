...
------------ | ------------- | ------------- | -------------
**Created** | Pointer to [**time.Time**](time.Time.md) | Timestamp when the incident was created. | [optional] [readonly] 
...
**Modified** | Pointer to [**time.Time**](time.Time.md) | Timestamp when the incident was last modified. | [optional] [readonly] 
