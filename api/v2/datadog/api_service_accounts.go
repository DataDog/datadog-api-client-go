...
// ServiceAccountsApi Returns new ServiceAccountsApi service.
func ServiceAccountsApi(client *common.APIClient) *ServiceAccountsApiService {
	return &ServiceAccountsApiService{
		Client: client,
	}
}
