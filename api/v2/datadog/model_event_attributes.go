...
type EventAttributes struct {
	...
	MonitorId common.NullableInt32 `json:"monitor_id,omitempty"`
...
// SetMonitorId gets a reference to the given common.NullableInt32 and assigns it to the MonitorId field.
