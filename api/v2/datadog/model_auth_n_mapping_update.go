...
// AuthNMappingUpdate Data for updating an AuthN Mapping.
type AuthNMappingUpdate struct {
...
func (o AuthNMappingUpdate) MarshalJSON() ([]byte, error) {
...
func (o *AuthNMappingUpdate) UnmarshalJSON(bytes []byte) (err error) {
