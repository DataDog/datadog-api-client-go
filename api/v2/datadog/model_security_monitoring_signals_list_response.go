...
// SecurityMonitoringSignalsListResponse Response object with all security signals matching the request and pagination information.
type SecurityMonitoringSignalsListResponse struct {
	// Array of security signals matching the request.
