...
| -------------------------- | ----------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ | -------------------------------------------------- |
| _CloudSIEMApi_             | [**CreateSecurityFilter**](docs/CloudSIEMApi.md#createsecurityfilter)                                             | **Post** /api/v2/security_monitoring/configuration/security_filters                        | Create a security filter                           |
| _CloudSIEMApi_             | [**CreateSecurityMonitoringRule**](docs/CloudSIEMApi.md#createsecuritymonitoringrule)                             | **Post** /api/v2/security_monitoring/rules                                                 | Create a detection rule                            |
| _CloudSIEMApi_             | [**DeleteSecurityFilter**](docs/CloudSIEMApi.md#deletesecurityfilter)                                             | **Delete** /api/v2/security_monitoring/configuration/security_filters/{security_filter_id} | Delete a security filter                           |
| _CloudSIEMApi_             | [**DeleteSecurityMonitoringRule**](docs/CloudSIEMApi.md#deletesecuritymonitoringrule)                             | **Delete** /api/v2/security_monitoring/rules/{rule_id}                                     | Delete an existing rule                            |
| _CloudSIEMApi_             | [**GetSecurityFilter**](docs/CloudSIEMApi.md#getsecurityfilter)                                                   | **Get** /api/v2/security_monitoring/configuration/security_filters/{security_filter_id}    | Get a security filter                              |
| _CloudSIEMApi_             | [**GetSecurityMonitoringRule**](docs/CloudSIEMApi.md#getsecuritymonitoringrule)                                   | **Get** /api/v2/security_monitoring/rules/{rule_id}                                        | Get a rule&#39;s details                           |
| _CloudSIEMApi_             | [**ListSecurityFilters**](docs/CloudSIEMApi.md#listsecurityfilters)                                               | **Get** /api/v2/security_monitoring/configuration/security_filters                         | Get all security filters                           |
| _CloudSIEMApi_             | [**ListSecurityMonitoringRules**](docs/CloudSIEMApi.md#listsecuritymonitoringrules)                               | **Get** /api/v2/security_monitoring/rules                                                  | List rules                                         |
| _CloudSIEMApi_             | [**ListSecurityMonitoringSignals**](docs/CloudSIEMApi.md#listsecuritymonitoringsignals)                           | **Get** /api/v2/security_monitoring/signals                                                | Get a quick list of security signals               |
| _CloudSIEMApi_             | [**SearchSecurityMonitoringSignals**](docs/CloudSIEMApi.md#searchsecuritymonitoringsignals)                       | **Post** /api/v2/security_monitoring/signals/search                                        | Get a list of security signals                     |
| _CloudSIEMApi_             | [**UpdateSecurityFilter**](docs/CloudSIEMApi.md#updatesecurityfilter)                                             | **Patch** /api/v2/security_monitoring/configuration/security_filters/{security_filter_id}  | Update a security filter                           |
| _CloudSIEMApi_             | [**UpdateSecurityMonitoringRule**](docs/CloudSIEMApi.md#updatesecuritymonitoringrule)                             | **Put** /api/v2/security_monitoring/rules/{rule_id}                                        | Update an existing rule                            |
...
| _DashboardListsApi_        | [**DeleteDashboardListItems**](docs/DashboardListsApi.md#deletedashboardlistitems)                                | **Delete** /api/v2/dashboard/lists/manual/{dashboard_list_id}/dashboards                   | Delete items from a dashboard list                 |
...
| _KeyManagementApi_         | [**DeleteAPIKey**](docs/KeyManagementApi.md#deleteapikey)                                                         | **Delete** /api/v2/api_keys/{api_key_id}                                                   | Delete an API key                                  |
...
| _LogsArchivesApi_          | [**GetLogsArchiveOrder**](docs/LogsArchivesApi.md#getlogsarchiveorder)                                            | **Get** /api/v2/logs/config/archive-order                                                  | Get archive order                                  |
...
| _UsersApi_                 | [**ListUsers**](docs/UsersApi.md#listusers)                                                                       | **Get** /api/v2/users                                                                      | List all users                                     |
